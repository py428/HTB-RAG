[HTB: CrimeStoppers](/2018/06/03/htb-crimestoppers.html)
...
[![CrimeStoppers](/icons/box-crimestoppers.webp)](https://hackthebox.com/machines/crimestoppers)

[CrimeStoppers](https://hackthebox.com/machines/crimestoppers)
...
Rated Difficulty ![Rated difficulty for CrimeStoppers](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/crimestoppers-diff.webp)

Radar Graph ![Radar chart for CrimeStoppers](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/crimestoppers-radar.webp)

User

00:41:46 Root

04:22:01 Creator ## Recon - Nmap
...
![1528113182608 image](https://0xdfimages.gitlab.io/img/1528113182608.png)

## Port 80 - HTTP site

### Overview

The site itself is a Mr. Robot themed site that takes tips for the FBI based on [Mr. Robot](http://www.usanetwork.com/mrrobot): ![Index image](https://0xdfimages.gitlab.io/img/index.png)

There’s also an uploads page: ![Upload image](https://0xdfimages.gitlab.io/img/upload.png)
...
![List image](https://0xdfimages.gitlab.io/img/list.png)
...
Then, launch firebird, and hit alt+e to get to edit -> preferences -> security -> saved passwords -> show passwords: ![Dom Pass image](https://0xdfimages.gitlab.io/img/dom-pass.png) So dom’s password is `Gummer59`. And it works for her account on the box:
...
![Ida Rootme Post Read Request image](https://0xdfimages.gitlab.io/img/ida-rootme_post_read_request.png)
...
![Darkarmy image](https://0xdfimages.gitlab.io/img/darkarmy.png)
