[HTB: Download](/2023/11/11/htb-download.html)

![Download](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/download-cover.webp)
...
[![Download](/icons/box-download.webp)](https://hackthebox.com/machines/download)

[Download](https://hackthebox.com/machines/download)
...
Rated Difficulty ![Rated difficulty for Download](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/download-diff.webp)

Radar Graph ![Radar chart for Download](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/download-radar.webp)

User

04:47:50 Root

18:52:40 Creator ## Recon
...
![image-20231106162250080](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231106162250080.webp)
...
![image-20231106162524637](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231106162524637.webp)

If I give it a file, it returns a page at `/files/view/[guid]` with “Download” and “Copy Link” buttons:

![image-20231106162551496](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231106162551496.webp)
...
![image-20231106162712605](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231106162712605.webp)

The “Register Here” link (`/auth/register`) loads a page that offers the chance to track and delete uploaded file and a form:

![image-20231106162751398](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231106162751398.webp)
...
![image-20231106162948855](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231106162948855.webp)
...
![image-20231106163305547](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231106163305547.webp)

On the upload page, there’s now an option for “Mark file as private”:

![image-20231106163332052](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231106163332052.webp)

On viewing a file, I now have the option to delete it (both on the view page for the file, and on the home page):

![image-20231106163401560](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231106163401560.webp)

Private files show up marked that way:

![image-20231106163454554](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231106163454554.webp)
...
![image-20231107133911339](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107133911339.webp)
...
![image-20231107133640523](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107133640523.webp)
...
![image-20231107134010830](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107134010830.webp)
...
![image-20231107134644853](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107134644853.webp)
...
![image-20231107134904622](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107134904622.webp)

However, if I URL-encode `/` to `%2f`, then it loads the file!

![image-20231107135006342](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107135006342.webp)
...
![image-20231107135617874](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107135617874.webp)
...
![image-20231107135752076](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107135752076.webp)
...
[Prisma](https://www.prisma.io/) is an ORM for interacting with a database, `cookie-parser` is [ExpressJS middleware](https://expressjs.com/en/resources/middleware/cookie-parser.html) for getting cookies, `cookie-session` is what is adding the `.sig` cookie ([source on GitHub](https://github.com/expressjs/cookie-session)).
...
![image-20231107070552128](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107070552128.webp)
...
![image-20231107073523912](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107073523912.webp)

And is [on GitHub](https://github.com/pillarjs/cookies).
...
![image-20231107074730768](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107074730768.webp)
...
![image-20231107075010544](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107075010544.webp)
...
![image-20231107075116446](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107075116446.webp)
...
![image-20231107075308465](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107075308465.webp)
...
That base64 encodes to `eyJmbGFzaGVzIjp7ImluZm8iOltdLCJlcnJvciI6W10sInN1Y2Nlc3MiOltdfSwidXNlciI6e319` which has a signature of `RdmrvnrBpzrS3slS77uG7Cuiv-Q`. When I add this to Firefox and reload `/home`, it works:
 ...
 ![image-20231107142010370](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107142010370.webp)![expand](/icons/expand.png)
...
![image-20231107152611960](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107152611960.webp)

However, if I change it to `{"user":{"password":{}}}`, it returns all the documents:

![image-20231107152812106](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107152812106.webp)
...
![image-20231107153428075](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231107153428075.webp)
...
![](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/download-password-bruteforce.gif)
...
![image-20231108122757789](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231108122757789.webp)
