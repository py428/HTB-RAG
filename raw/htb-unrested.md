[HTB: Unrested](/2025/03/04/htb-unrested.html)

![Unrested](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/unrested-cover.webp)
...
[![Unrested](/icons/box-unrested.webp)](https://hackthebox.com/machines/unrested)

[Unrested](https://hackthebox.com/machines/unrested)
...
![image-20250228092616361](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228092616361.webp)
...
![image-20250228094137278](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228094137278.webp)
...
![image-20250228134929550](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228134929550.webp)

The 404 page is the [default Apache 404](about:/cheatsheets/404#apache--httpd):

![image-20250228093414340](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228093414340.webp)
...
I’m going to need some basic understanding of how to work with the Zabbix API, which is documented [in the Zabbix docs](https://www.zabbix.com/documentation/current/en/manual/api).
...
![image-20250228142158649](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228142158649.webp)

Most API endpoints take the token in an authorization header. For example, this endpoint returns unauthorized:

![image-20250228142441462](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228142441462.webp)

When I add in the token in an `Authorization` header, it does:

![image-20250228142536613](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228142536613.webp)
...
![image-20250228144812880](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228144812880.webp)

If I add in the `editable` field, it does return information about my user (I’ll show why shortly):

![image-20250228144838411](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228144838411.webp)

I’ll note matthew has a `userid` of 3.

I can also request groups the same way, but don’t get any:

![image-20250228151617589](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228151617589.webp)
...
![image-20250228183600574](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228183600574.webp)
...
![image-20250228184346642](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228184346642.webp)
...
![image-20250228190122507](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228190122507.webp)
...
![image-20250228190317772](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228190317772.webp)
...
![image-20250228191205566](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228191205566.webp)

I can change that into a subquery:

![image-20250228191101094](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228191101094.webp)

The sub-query must return a single value, but I can use `group_concat` to achieve that, and try to read something:

![image-20250228191015573](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228191015573.webp)
...
Based on the success of `group_concat`, it is likely a MySQL DB. To check for sure, I’ll try string concatenation as shown on the [PortSwigger CheatSheet](https://portswigger.net/web-security/sql-injection/cheat-sheet):
 ...
 ![image-20250228191651802](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228191651802.webp)![image-20250228191748913](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228191748913.webp)

That’s MySQL. `@@version` works too:

![image-20250228191822548](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228191822548.webp)

I can read the table names, but it’s long:

![image-20250228192000241](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228192000241.webp)
...
![image-20250228193150225](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228193150225.webp)

It works!

![image-20250228193402091](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228193402091.webp)

#### RCE POC

To execute a command, I need to have a `hostid`. I’ll use the `host.get` API to list the hosts (which now works as admin):

![image-20250228194431256](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228194431256.webp)
...
![image-20250228194749848](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228194749848.webp)
...
![image-20250228194923402](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228194923402.webp)
...
![image-20250228162726715](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228162726715.webp)
...
![image-20250228163212586](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228163212586.webp)

If I query `user.get` now, the result is different:

![image-20250228163306417](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228163306417.webp)
...
![image-20250228215539580](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228215539580.webp)

Under “Data collection” –> “Hosts” –> “Items” I’ll see my RCE attempts:

![image-20250228215907346](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250228215907346.webp)
