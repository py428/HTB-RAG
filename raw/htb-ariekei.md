[HTB: Ariekei](/2022/04/20/htb-ariekei.html)

![Ariekei](https://0xdfimages.gitlab.io/img/ariekei-cover.webp)
...
[![Ariekei](/icons/box-ariekei.webp)](https://hackthebox.com/machines/ariekei)

[Ariekei](https://hackthebox.com/machines/ariekei)
...
Rated Difficulty ![Rated difficulty for Ariekei](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/ariekei-diff.webp)

Radar Graph ![Radar chart for Ariekei](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/ariekei-radar.webp)

User

22:07:59 Root

23:13:49 Creator ## Recon
...
![image-20220413204906954](https://0xdfimages.gitlab.io/img/image-20220413204906954.webp)
...
![](https://www.youtube.com/watch?v=RVmnR_HccL8)
...
![image-20220418174312964](https://0xdfimages.gitlab.io/img/image-20220418174312964.webp)
...
![image-20220419172528166](https://0xdfimages.gitlab.io/img/image-20220419172528166.webp)
...
![image-20220418175844513](https://0xdfimages.gitlab.io/img/image-20220418175844513.webp)
...
![image-20220419070352297](https://0xdfimages.gitlab.io/img/image-20220419070352297.webp)
...
![image-20220419070448183](https://0xdfimages.gitlab.io/img/image-20220419070448183.webp)
...
![image-20220419070648165](https://0xdfimages.gitlab.io/img/image-20220419070648165.webp)
...
![image-20220419124756358](https://0xdfimages.gitlab.io/img/image-20220419124756358.webp)
...
I first showed Shellshock on the [Shocker](about:/2021/05/25/htb-shocker.html#shell-as-shelly) box. I’ll need an `echo` as the first command (long story on that in [Shocker Beyond Root](about:/2021/05/25/htb-shocker.html#shellshock-chained-commands)). Putting this all together, I’ll send a `User-Agent` header of `() { :;}; echo; /usr/bin/id`. It returns 403 Forbidden:

![image-20220419152800731](https://0xdfimages.gitlab.io/img/image-20220419152800731.webp)

The response actually has ASCII art of a face taunting me:

![image-20220419152851630](https://0xdfimages.gitlab.io/img/image-20220419152851630.webp)
...
```
![](https://0xdfimages.gitlab.io/img/info.webp)
