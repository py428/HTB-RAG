[HTB: Altered](/2022/03/30/htb-altered.html)

![Altered](https://0xdfimages.gitlab.io/img/altered-cover.webp)
...
[![Altered](/icons/box-altered.webp)](https://hackthebox.com/machines/altered)

[Altered](https://hackthebox.com/machines/altered)
...
![image-20220324104543740](https://0xdfimages.gitlab.io/img/image-20220324104543740.webp)

Trying admin / admin returns “Invalid Username”:

![image-20220324104558911](https://0xdfimages.gitlab.io/img/image-20220324104558911.webp)
...
![image-20220324104636225](https://0xdfimages.gitlab.io/img/image-20220324104636225.webp)

I’ll try big0us, and now it says invalid password:

![image-20220324104708730](https://0xdfimages.gitlab.io/img/image-20220324104708730.webp)

I’ve found a way to validate users.

On a failed login, a “Forgot Password?” button appears. Clicking that leads to `/reset`:

![image-20220324121113762](https://0xdfimages.gitlab.io/img/image-20220324121113762.webp)

If I enter a valid username, it says it emailed a pincode to me:

![image-20220324121207291](https://0xdfimages.gitlab.io/img/image-20220324121207291.webp)

Guessing a pin shows the form again with an updated message:

![image-20220324121429017](https://0xdfimages.gitlab.io/img/image-20220324121429017.webp)
...
There’s also `laravel_session` cookies being set, which is a good indication that the site is PHP and built on the Laravel Framework. I showed a Laravel/PHP type juggling exploit in the previous UHC box, [Ransom](about:/2022/03/15/htb-ransom.html#bypass-login), and did a deep dive into Laravel in the [Beyond Root section](about:/2022/03/15/htb-ransom.html#beyond-root) for that post. All of that is worth reading for good Laravel background.
...
![image-20220324124853028](https://0xdfimages.gitlab.io/img/image-20220324124853028.webp)
...
![image-20220324130214509](https://0xdfimages.gitlab.io/img/image-20220324130214509.webp)
...
![image-20220324134608575](https://0xdfimages.gitlab.io/img/image-20220324134608575.webp)

Hovering over each link just shows it targeting the page:

![image-20220324135221436](https://0xdfimages.gitlab.io/img/image-20220324135221436.webp)

Clicking on one does pop a new section with some text:

![image-20220324135324640](https://0xdfimages.gitlab.io/img/image-20220324135324640.webp)
...
![image-20220324140722475](https://0xdfimages.gitlab.io/img/image-20220324140722475.webp)
...
![image-20220324142618277](https://0xdfimages.gitlab.io/img/image-20220324142618277.webp)
...
![image-20220324220350820](https://0xdfimages.gitlab.io/img/image-20220324220350820.webp)
...
![image-20220325100948025](https://0xdfimages.gitlab.io/img/image-20220325100948025.webp)
...
![image-20220325101251096](https://0xdfimages.gitlab.io/img/image-20220325101251096.webp)

Still, it is just five `syscall` calls. In the listing, what’s actually happening is clearer. Each `syscall` looks like this:

![image-20220325101346001](https://0xdfimages.gitlab.io/img/image-20220325101346001.webp)
...
![image-20220325102111276](https://0xdfimages.gitlab.io/img/image-20220325102111276.webp)

0x4000dd + 0xba = 0x400197, which is where this file ends:

![image-20220325102211513](https://0xdfimages.gitlab.io/img/image-20220325102211513.webp)
