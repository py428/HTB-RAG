[HTB: Drive](/2024/02/17/htb-drive.html)

![Drive](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/drive-cover.webp)
...
[![Drive](/icons/box-drive.webp)](https://hackthebox.com/machines/drive)

[Drive](https://hackthebox.com/machines/drive)
...
Rated Difficulty ![Rated difficulty for Drive](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/drive-diff.webp)

Radar Graph ![Radar chart for Drive](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/drive-radar.webp)

User

00:38:51 Root

01:35:01 Creator ## Recon
...
The site is for a cloud storage service:
 ...
 ![image-20240213150627933](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213150627933.webp)![expand](/icons/expand.png)
...
![image-20240213151221403](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213151221403.webp)

Submitting sends a POST to `/contact/`, and the response shows a message:

![image-20240213151313088](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213151313088.webp)

I’ll send some XSS payloads, but nothing every connects back.

Registration goes to `/register/`:

![image-20240213150856804](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213150856804.webp)

Login at `/login/` looks similar:

![image-20240213150918358](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213150918358.webp)

#### Authenticated Site

Once I log in, there’s a `/home/` page that shows files:

![image-20240213153151709](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213153151709.webp)

The only file there has a message from the admins:

![image-20240213153238372](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213153238372.webp)

In the “Files” menu, I can upload a file, and it tells about the kinds of files that are accepted above the form:

![image-20240213153328812](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213153328812.webp)

I can upload a file, and then there are more options than “Just View”:

![image-20240213153416105](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213153416105.webp)
...
![image-20240213155142486](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213155142486.webp)

In the “My Files” section, there’s a way to do this with a GET request:

![image-20240213155504474](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213155504474.webp)
...
![image-20240213153718203](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213153718203.webp)

When viewing the group, I’ll see that “admin” is added, but the two non-sense ones are not:

![image-20240213153742908](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213153742908.webp)

This is a way to enumerate users.

The “Reports” section shows my activity:

![image-20240213154210661](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213154210661.webp)
...
![image-20240213154503987](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213154503987.webp)

#### Directory Brute Force

I’ll start `feroxbuster` on the site, but after a minute is starts returning 500s

 [![image-20240213154649927](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213154649927.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213154649927.png)
...
![image-20240213170947570](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213170947570.webp)

#### IDOR

The `/[id]/block/` page will show files that I otherwise can’t access:

![image-20240213171232529](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213171232529.webp)
...
![image-20240213171354041](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213171354041.webp)

99 has says that the dev team needs to stop using the platform for chat, and references security issues:

![image-20240213171520216](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213171520216.webp)

Most importantly, 79 has a username and password:

![image-20240213171143248](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240213171143248.webp)
...
To get better access, I’ll use SSH to create a tunnel from port 3000 on my box to port 3000 on Drive with `-L 3000:localhost:3000`. Now in Firefox:
 ...
 ![image-20240214101435680](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240214101435680.webp)![expand](/icons/expand.png)

On the “Explore” link, there are a couple of users visible to unauthenticated users:

![image-20240214101507929](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240214101507929.webp)
...
![image-20240214101907531](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240214101907531.webp)

This repo is for the website:

![image-20240214102029108](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240214102029108.webp)
...
- The `geeks_site` folder has a last comment message referencing going back to “default Django hashes due to problems in BCrypt”, dated 26 December 2022. That specifically applies to a `settings.py` file. The history of the file shows it set to SHA1 to Bcrypt and back to SHA1:
	![image-20240214102424700](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240214102424700.webp)
