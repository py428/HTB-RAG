[HTB: Topology](/2023/11/04/htb-topology.html)

![Topology](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/topology-cover.webp)
...
[![Topology](/icons/box-topology.webp)](https://hackthebox.com/machines/topology)

[Topology](https://hackthebox.com/machines/topology)
...
Rated Difficulty ![Rated difficulty for Topology](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/topology-diff.webp)

Radar Graph ![Radar chart for Topology](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/topology-radar.webp)

User

01:01:05 Root

01:19:01 Creator ## Recon
...
The site is for a mathematics department at a university:
 ...
 ![image-20230906175002708](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906175002708.webp)![expand](/icons/expand.png)
...
![image-20230906175752952](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906175752952.webp)
...
![image-20230906182732234](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906182732234.webp)
...
![image-20230906212016627](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906212016627.webp)

The images load out of `/files`, which has listing enabled:

![image-20230906212109921](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906212109921.webp)
...
![image-20230906212644417](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906212644417.webp)

`equation.php` is the page linked to from the main site. It has a LaTeX Equation Generator page:

![image-20230906212720350](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906212720350.webp)
...
![image-20231102141043763](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231102141043763.webp)
...
![image-20230906213554262](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906213554262.webp)
...
![image-20230906213842020](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906213842020.webp)
...
With file read, one useful thing to look at is the Apache configuration. The default location is `/etc/apache2/sites-enabled/000-default.conf`
 ...
 ![](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/topology-000-default.webp)![expand](/icons/expand.png)
...
![image-20230906214911221](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906214911221.webp)

The `AuthUserFile` defines that access. Reading `/var/www/dev/.htpasswd` shows the hash:

![image-20230906214948812](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230906214948812.webp)
...
The site is about software developed by the staff from the university:
 ...
 ![image-20230907105933702](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230907105933702.webp)![expand](/icons/expand.png)
...
![image-20231102142008301](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231102142008301.webp)
...
![image-20231102163135052](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231102163135052.webp)

This isn’t execution, but it is bypassing the filter. What does work is `\write`. On it’s own, it’s blocked:

![image-20231102163221608](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231102163221608.webp)
...
![image-20231102170149211](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231102170149211.webp)

Going over to `latex.topology.htb/tempfiles`, it’s there:

![image-20231102170220688](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231102170220688.webp)

I’ll change the written text to a PHP webshell, and the output filename to `cmd.php`:

On reloading, `cmd.php` is there:

![image-20231102170344705](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231102170344705.webp)

And using it as a webshell works for execution:

![image-20231102170405993](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231102170405993.webp)
...
![image-20231102170451593](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231102170451593.webp)
...
![image-20230908101642678](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230908101642678.webp)
