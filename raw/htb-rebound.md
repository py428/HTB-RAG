[HTB: Rebound](/2024/03/30/htb-rebound.html)

![Rebound](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/rebound-cover.webp)
...
[![Rebound](/icons/box-rebound.webp)](https://hackthebox.com/machines/rebound)

[Rebound](https://hackthebox.com/machines/rebound)
...
Rated Difficulty ![Rated difficulty for Rebound](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/rebound-diff.webp)

Radar Graph ![Radar chart for Rebound](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/rebound-radar.webp)

User

18:04:12 Root

23:22:14 Creator ## Recon
...
Bloodhound doesn’t show any kind of outbound control from either ldap\_monitor or oorend. Typically this is where I move to other stuff, but without much else, I’ll look around what what interesting targets might be. The “Shortest Paths to High Value Targets” query shows this spegehitti:
 ...
 [![image-20240317174350223](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240317174350223.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240317174350223.png)
...
`powerview.py` is a [neat tool](https://github.com/aniqfakhrul/powerview.py) for doing deeper analysis of Windows object properties remotely. Based off the no-longer-maintained `powerview.ps1` (still available [on GitHub](https://github.com/PowerShellMafia/PowerSploit/blob/master/Recon/PowerView.ps1)).
...
![image-20240327120049364](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240327120049364.webp)
...
![image-20240318183829635](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240318183829635.webp)
...
A more careful way (and the author’s suggested method) is to use a Shadow Credential, similar to what I showed in [Absolute](about:/2023/05/27/htb-absolute.html#shadow-credential) and [Outdated](about:/2022/12/10/htb-outdated.html#get-sflowers-ntlm).
...
![image-20240318213926626](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240318213926626.webp)

It seems like that’s my current target.

### Cross Session Relay

I’m going to abuse the logged in session by TBrady by triggering an authentication back to my box and relaying it to dump a hash. I did something similar in [Absolute](about:/2023/05/27/htb-absolute.html#shell-as-administrator), but there I got the administrator account, which allowed me to just add an admin user and be done. Here I’ll be targeting the TBrady user, so what I can get via relay is more limited.
...
I’ll clone [KrbRelay](https://github.com/cube0x0/KrbRelay) to my Windows VM and compile it in Visual Studio (just like in [Absolute](about:/2023/05/27/htb-absolute.html#compile)). I’ll upload it to Rebound:
...
![image-20240320140332357](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240320140332357.webp)
...
It is using S4U2Self to get a ticket for the administrator user for delegator$, and then trying to use S4U2Proxy to forward it, but it doesn’t work. The `-self` flag tells `getSt.py` to stop after the S4U2Self, getting a ticket for administrator for delegator$. The resulting ticket is missing the forwardable flag:
 ...
 [![image-20240320105630470](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240320105630470.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240320105630470.png)
