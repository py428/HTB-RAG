[HTB: BoardLight](/2024/09/28/htb-boardlight.html)

![BoardLight](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/boardlight-cover.webp)
...
[![BoardLight](/icons/box-boardlight.webp)](https://hackthebox.com/machines/boardlight)

[BoardLight](https://hackthebox.com/machines/boardlight)
...
Rated Difficulty ![Rated difficulty for BoardLight](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/boardlight-diff.webp)

Radar Graph ![Radar chart for BoardLight](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/boardlight-radar.webp)

User

00:09:56 Root

00:36:31 Creator ## Recon
...
The website is for a cybersecurity company:
 ...
 ![image-20240531065748640](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240531065748640.webp)![expand](/icons/expand.png)

The page has a contact us form, but it doesn’t send data anywhere. There is an email address at the bottom:

![image-20240531065904194](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240531065904194.webp)
...
A 404 page simple returns the [default Apache 404](about:/cheatsheets/404#apache--httpd). For an existing page that ends with `.php`, there’s a different 404:
...
That’s a [default for PHP-FPM](about:/cheatsheets/404#php-fpm), which is PHP implementation of the process that takes requests from Apache and handles running `php` on the right page.
...
![image-20240531070947268](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240531070947268.webp)
...
![image-20240531083544551](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240531083544551.webp)

Most of the features are grayed out, but I can create websites:

![image-20240531092054159](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240531092054159.webp)
...
![image-20240531071605330](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240531071605330.webp)
...
![image-20240531092203415](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240531092203415.webp)

That said, the keyword being checked for is case sensitive. If I change that to `<?Php phpinfo(); ?>`, it saves just fine:

![image-20240531092602396](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240531092602396.webp)
...
![image-20240531093103409](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240531093103409.webp)
