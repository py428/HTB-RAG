[HTB: Zipper](/2019/02/23/htb-zipper.html)

![Zipper-cover](https://0xdfimages.gitlab.io/img/zipper-cover.webp)
...
[![Zipper](/icons/box-zipper.webp)](https://hackthebox.com/machines/zipper)

[Zipper](https://hackthebox.com/machines/zipper)
...
Rated Difficulty ![Rated difficulty for Zipper](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/zipper-diff.webp)

Radar Graph ![Radar chart for Zipper](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/zipper-radar.webp)

User

01:57:59 Root

02:08:18 Creator ## Recon
...
I wasn’t able to log into the GUI as zapper, but Zabbix also has an API, which is documented [in the Zabbix docs](https://www.zabbix.com/documentation/3.0/manual/api/reference). To interact with the api, I’ll send `curl` POST requests to `/zabbix/api_jsonrpc.php`.
...
![Zipper Gui Hostid image](https://0xdfimages.gitlab.io/img/zipper-gui-hostid.gif)
