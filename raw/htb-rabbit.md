[HTB: Rabbit](/2022/04/28/htb-rabbit.html)

![Rabbit](https://0xdfimages.gitlab.io/img/rabbit-cover.webp)
...
[![Rabbit](/icons/box-rabbit.webp)](https://hackthebox.com/machines/rabbit)

[Rabbit](https://hackthebox.com/machines/rabbit)
...
Rated Difficulty ![Rated difficulty for Rabbit](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/rabbit-diff.webp)

Radar Graph ![Radar chart for Rabbit](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/rabbit-radar.webp)

User

11:34:47 Root

16:06:36 Creator ## Recon
...
![image-20220425123054776](https://0xdfimages.gitlab.io/img/image-20220425123054776.webp)
...
![image-20220425125133977](https://0xdfimages.gitlab.io/img/image-20220425125133977.webp)
...
![image-20220425125239724](https://0xdfimages.gitlab.io/img/image-20220425125239724.webp)
...
![image-20220425132404995](https://0xdfimages.gitlab.io/img/image-20220425132404995.webp)

`http://10.10.10.71:8080/joomla/administrator/manifests/files/joomla.xml` shows the version, 3.8.1:

![image-20220425132602756](https://0xdfimages.gitlab.io/img/image-20220425132602756.webp)
...
![image-20220425133148967](https://0xdfimages.gitlab.io/img/image-20220425133148967.webp)
...
![image-20220425154955083](https://0xdfimages.gitlab.io/img/image-20220425154955083.webp)
...
![image-20220425155212511](https://0xdfimages.gitlab.io/img/image-20220425155212511.webp)
...
![image-20220425160236378](https://0xdfimages.gitlab.io/img/image-20220425160236378.webp)

When I change it to `8335=8336`, it returns a 200, but with an error:

![image-20220425160329144](https://0xdfimages.gitlab.io/img/image-20220425160329144.webp)
...
![image-20220425160653291](https://0xdfimages.gitlab.io/img/image-20220425160653291.webp)

Putting a `'` at the end of the url after `plans` leads to an error:

![image-20220425160740620](https://0xdfimages.gitlab.io/img/image-20220425160740620.webp)
...
![image-20220425160849674](https://0xdfimages.gitlab.io/img/image-20220425160849674.webp)

That’s a good indication of UNION injection. I’ll try adding columns until I get to `id=plans UNION select 1,2,3,4,5`:

![image-20220425160948859](https://0xdfimages.gitlab.io/img/image-20220425160948859.webp)
...
![image-20220425165339436](https://0xdfimages.gitlab.io/img/image-20220425165339436.webp)
...
![image-20220425172125054](https://0xdfimages.gitlab.io/img/image-20220425172125054.webp)
...
![image-20220425173353785](https://0xdfimages.gitlab.io/img/image-20220425173353785.webp)
...
![image-20220428085349342](https://0xdfimages.gitlab.io/img/image-20220428085349342.webp)
...
![image-20220425174332299](https://0xdfimages.gitlab.io/img/image-20220425174332299.webp)
...
I’ll use the `^` to escape the `<` and `>` as shown [on robvanderwoude.com](https://www.robvanderwoude.com/escapechars.php), same as I did in [Fighter](about:/2022/04/25/htb-fighter.html#reverse-shell-option-2). I had to play a bit with the `"` to get them to work, but that did. I’ll also have to escape the `\` with a second `\`.
...
![image-20220425164922703](https://0xdfimages.gitlab.io/img/image-20220425164922703.webp)

If I get that right, it returns the password in clear text:

![image-20220425164955007](https://0xdfimages.gitlab.io/img/image-20220425164955007.webp)
