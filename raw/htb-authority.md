[HTB: Authority](/2023/12/09/htb-authority.html)

![](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/authority-cover.webp)
...
[![](/icons/box-authority.webp)](https://hackthebox.com/machines/authority)

[Authority](https://hackthebox.com/machines/authority)
...
Rated Difficulty ![](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/authority-diff.webp)

Radar Graph ![](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/authority-radar.webp)

User

00:34:55 Root

00:45:56 Creators   ## Recon
...
![image-20231123160052304](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231123160052304.webp)
...
![image-20231206130126887](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231206130126887.webp)
...
![image-20231123163312293](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231123163312293.webp)

#### Site

The web root redirects to `/pwm/`, presents an instance of [PWM](https://github.com/pwm-project/pwm):

![image-20231123164727269](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231123164727269.webp)
...
![image-20231127125440973](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127125440973.webp)
...
![image-20231127125640132](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127125640132.webp)
...
![image-20231127125337887](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127125337887.webp)

The result is this popup:

![image-20231127125309961](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127125309961.webp)
...
![image-20231127125848531](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127125848531.webp)
...
![image-20231127130156435](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127130156435.webp)
...
![image-20231127130405797](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127130405797.webp)

The creds used are stored, but not retrievable through the web GUI:

![image-20231127130505380](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127130505380.webp)
...
![image-20231127130706990](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127130706990.webp)
...
![image-20231127131357051](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127131357051.webp)
...
It’s always worth enumerating ADCS on a Windows DC. I’ve shown `certipy` (`pipx install certipy-ad`, [GitHub](https://github.com/ly4k/Certipy)) before on [Absolute](about:/2023/05/27/htb-absolute.html#shadow-credential) and [Escape](about:/2023/06/17/htb-escape.html#shell-as-administrator). I’ll use the `find` command to identify templates, and with `-vulnerable` only show vulnerable ones:
...
![image-20231127135102471](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127135102471.webp)

In this case, it’s `Domain Computers` who can enroll with this template, not `Domain Users`.

#### Create Computer Account

In [Support](about:/2022/12/17/htb-support.html#create-fakecomputer) I had an exploitation path that required a fake computer. I’ll do the same thing here, though on Support I did it from a shell on the target, while here I’ll show how to do it remotely with [Impacket](https://github.com/SecureAuthCorp/impacket).
...
![image-20231127142325929](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231127142325929.webp)
