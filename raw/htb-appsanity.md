[HTB: Appsanity](/2024/03/09/htb-appsanity.html)

![Appsanity](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/appsanity-cover.webp)
...
[![Appsanity](/icons/box-appsanity.webp)](https://hackthebox.com/machines/appsanity)

[Appsanity](https://hackthebox.com/machines/appsanity)
...
Rated Difficulty ![Rated difficulty for Appsanity](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/appsanity-diff.webp)

Radar Graph ![Radar chart for Appsanity](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/appsanity-radar.webp)

User

02:23:37 Root

03:57:12 Creator ## Recon
...
![image-20240228141258968](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228141258968.webp)
...
![image-20240228142755460](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228142755460.webp)
...
The site is for a medical consulting company:
 ...
 ![image-20240228142848349](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228142848349.webp)![expand](/icons/expand.png)
...
There’s not too much of interest on the site, but I can register an account. On doing so and logging in, there’s a profile page (`/Profile`):
 ...
 ![image-20240228145204220](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228145204220.webp)![expand](/icons/expand.png)
...
![image-20240228152857988](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228152857988.webp)
...
![image-20240228151359622](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228151359622.webp)
...
![image-20240228150900922](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228150900922.webp)

If I change that to 2, it redirects to `/Signin`:

![image-20240228150947366](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228150947366.webp)
...
![image-20240228151115857](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228151115857.webp)
...
![image-20240228153945486](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228153945486.webp)

On refreshing, the browser redirects to `/Profile`:

![image-20240228204337077](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228204337077.webp)
...
![image-20240228205713028](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228205713028.webp)

Any time I can submit a link to a site it’s worth digging into. If I put in my host as the link:

![image-20240228205912348](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228205912348.webp)
...
![image-20240228205937617](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228205937617.webp)
...
![image-20240228210100701](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228210100701.webp)
...
![image-20240228205809613](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228205809613.webp)

I’ll fill it out, and after passing all the client-side validation, submit, and it returns:

![image-20240228210355992](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228210355992.webp)

If I use a PDF, it shows:

![image-20240228210517146](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240228210517146.webp)
...
![image-20240301152956347](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301152956347.webp)
...
![image-20240301153102616](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301153102616.webp)
...
![image-20240301154046582](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301154046582.webp)
...
![image-20240301154132381](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301154132381.webp)

I can grab the URL from that, and back in Repeater, fetch the PDF:

![image-20240301154253109](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301154253109.webp)
...
![image-20240301155905617](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301155905617.webp)
...
![image-20240301160121230](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301160121230.webp)
...
![image-20240301160338898](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301160338898.webp)
...
![image-20240301160435787](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301160435787.webp)

Then there is a new link, and I can fetch it over the SSRF:

![image-20240301160518473](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301160518473.webp)
...
![image-20240301160928009](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301160928009.webp)
...
![image-20240301161029674](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301161029674.webp)
...
![image-20240301171747299](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301171747299.webp)

Looking at `index`, there are functions related to encryption / decryption:

![image-20240301171827229](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240301171827229.webp)
...
These are not.NET binaries, so I’ll use Ghidra, starting with `ReportManagement.exe`. Looking at the strings to get oriented, there are a bunch of interesting ones all grouped together in memory and where they are referenced:
 ...
 [![image-20240308093321459](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308093321459.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308093321459.png)
...
![image-20240308093911014](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308093911014.webp)
...
![appsanity-reportmanagement-re-process](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/appsanity-reportmanagement-re-process.webp)
...
![image-20240308103834508](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308103834508.webp)
...
![image-20240308104427246](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308104427246.webp)

There’s a bunch of failures trying to open `C:\inetpub\ExaminationPanel\ExaminationPanel\Reports`:

![image-20240308104539790](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308104539790.webp)
...
![image-20240308105416242](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308105416242.webp)
...
![image-20240308112559877](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308112559877.webp)
...
Now I’ll start the program in x64dbg. There’s a while loop that starts at 140004900 that only enters if there are files in `Libraries`. Stepping into the loop, it loads the string `.dll`, and then `test.dll`:
 ...
 [![image-20240308113232601](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308113232601.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308113232601.png)

Still, it doesn’t reach `CreateProcessW`. A bit further down, the “externaupload” string is referenced with a `memcmp`:

![image-20240308113809619](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308113809619.webp)
...
![image-20240308115459179](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240308115459179.webp)
