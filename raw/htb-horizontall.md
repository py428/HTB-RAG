[HTB: Horizontall](/2022/02/05/htb-horizontall.html)

![Horizontall](https://0xdfimages.gitlab.io/img/horizontall-cover.webp)
...
[![Horizontall](/icons/box-horizontall.webp)](https://hackthebox.com/machines/horizontall)

[Horizontall](https://hackthebox.com/machines/horizontall)
...
Rated Difficulty ![Rated difficulty for Horizontall](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/horizontall-diff.webp)

Radar Graph ![Radar chart for Horizontall](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/horizontall-radar.webp)

User

00:14:24 Root

00:33:37 Creator ## Recon
...
![image-20210728145254757](https://0xdfimages.gitlab.io/img/image-20210728145254757.webp)
...
![image-20210802130528194](https://0xdfimages.gitlab.io/img/image-20210802130528194.webp)
...
![image-20210802130601072](https://0xdfimages.gitlab.io/img/image-20210802130601072.webp)
...
![image-20210802131003331](https://0xdfimages.gitlab.io/img/image-20210802131003331.webp)

## Shell as strapi

### Exploit Identification

Some Googling for “strapi exploit” leads to a few things of interest. I first found CVE-2019-19609, which is an authenticated RCE exploit, nicely explained [on BitTherapy](https://bittherapy.net/post/strapi-framework-remote-code-execution/). That’ll be useful if I can get authenticated.
...
![image-20210802134604970](https://0xdfimages.gitlab.io/img/image-20210802134604970.webp)
...
![image-20210802140217813](https://0xdfimages.gitlab.io/img/image-20210802140217813.webp)
...
![image-20210802142559157](https://0xdfimages.gitlab.io/img/image-20210802142559157.webp)
...
![image-20210802143547930](https://0xdfimages.gitlab.io/img/image-20210802143547930.webp)
...
![image-20210802143923384](https://0xdfimages.gitlab.io/img/image-20210802143923384.webp)

There’s a PHP deserialization exploit that gets remote code execution against Laravel debug mode. The blog post is very detailed, and at the end, there’s a link to their [GitHub containing the exploit](https://github.com/ambionics/laravel-exploits). I’ll also need `phpggc`, available [on GitHub](https://github.com/ambionics/phpggc), to generate the deserialization payload.
...
![image-20220202161658349](https://0xdfimages.gitlab.io/img/image-20220202161658349.webp)

It worked, and I could login.

#### The Patch

The pull request to fix this issue in strapi is [on GitHub](https://github.com/strapi/strapi/pull/4443). Viewing the changed files, it only changes one line in each of two files:

![image-20220202161924658](https://0xdfimages.gitlab.io/img/image-20220202161924658.webp)
...
![image-20220202173440715](https://0xdfimages.gitlab.io/img/image-20220202173440715.webp)
