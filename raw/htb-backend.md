[HTB: Backend](/2022/04/12/htb-backend.html)

![Backend](https://0xdfimages.gitlab.io/img/backend-cover.webp)
...
[![Backend](/icons/box-backend.webp)](https://hackthebox.com/machines/backend)

[Backend](https://hackthebox.com/machines/backend)
...
![image-20220411112833859](https://0xdfimages.gitlab.io/img/image-20220411112833859.webp)
...
![image-20220411144907095](https://0xdfimages.gitlab.io/img/image-20220411144907095.webp)

`/api/v1` shows two more endpoints:

![image-20220411144932854](https://0xdfimages.gitlab.io/img/image-20220411144932854.webp)
...
When trying different endpoints here, I don’t know of a single nice tool for this. `feroxbuster` is nice because it let’s you give multiple HTTP methods, and it’s fast. But you have to identify status codes you want to see. There’s no way to say “show me everything that isn’t 404”. Based on some issues I was having on this box, the author of `feroxbuster` actually added some features, which aren’t quite live yet, but will be any day, and I’ll cover those [below](#feroxbuster-updates).
...
![image-20220411151549634](https://0xdfimages.gitlab.io/img/image-20220411151549634.webp)
...
![image-20220411151755631](https://0xdfimages.gitlab.io/img/image-20220411151755631.webp)
...
![image-20220411160523272](https://0xdfimages.gitlab.io/img/image-20220411160523272.webp)
...
![image-20220411170317575](https://0xdfimages.gitlab.io/img/image-20220411170317575.webp)

Some of the endpoints have locks next to them:

![image-20220411170354018](https://0xdfimages.gitlab.io/img/image-20220411170354018.webp)

Clicking on the doc will pop a form where I can login:

![image-20220411170421737](https://0xdfimages.gitlab.io/img/image-20220411170421737.webp)
...
![image-20220411171412351](https://0xdfimages.gitlab.io/img/image-20220411171412351.webp)

There’s also an admin section which includes the `file` endpoint `feroxbuster` found, and two others:

![image-20220411171754313](https://0xdfimages.gitlab.io/img/image-20220411171754313.webp)
...
![image-20220411171958857](https://0xdfimages.gitlab.io/img/image-20220411171958857.webp)
...
![image-20220411172347159](https://0xdfimages.gitlab.io/img/image-20220411172347159.webp)
...
![image-20220411173139825](https://0xdfimages.gitlab.io/img/image-20220411173139825.webp)
...
![image-20220411170620487](https://0xdfimages.gitlab.io/img/image-20220411170620487.webp)

On trying it, it returns `user.txt`:

![image-20220411170713345](https://0xdfimages.gitlab.io/img/image-20220411170713345.webp)

“Update Password” (`/api/v1/user/updatepass`) takes a JSON body with `guid` and `password`:

![image-20220411171500284](https://0xdfimages.gitlab.io/img/image-20220411171500284.webp)
...
![image-20220411173908260](https://0xdfimages.gitlab.io/img/image-20220411173908260.webp)

Looking down a bit at the documentation, 201 is success:

![image-20220411173929182](https://0xdfimages.gitlab.io/img/image-20220411173929182.webp)

I’ll head back up to the “Authorize” button, and this time give it the admin info (with the newly set password):

![image-20220411174017081](https://0xdfimages.gitlab.io/img/image-20220411174017081.webp)

On clicking “Authorize”, it seems to work:

![image-20220411174033160](https://0xdfimages.gitlab.io/img/image-20220411174033160.webp)

Now `/api/v1/admin/` confirms it:

![image-20220411174201449](https://0xdfimages.gitlab.io/img/image-20220411174201449.webp)
...
![image-20220411174303071](https://0xdfimages.gitlab.io/img/image-20220411174303071.webp)
