[HTB: Caption](/2025/01/25/htb-caption.html)

![Caption](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/caption-cover.webp)
...
[![Caption](/icons/box-caption.webp)](https://hackthebox.com/machines/caption)

[Caption](https://hackthebox.com/machines/caption)
...
Rated Difficulty ![Rated difficulty for Caption](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/caption-diff.webp)

Radar Graph ![Radar chart for Caption](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/caption-radar.webp)

User

00:23:12 Root

01:01:12 Creator ## Recon
...
![image-20240916172345700](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916172345700.webp)
...
The `server` header shows Werkzeug and Python, suggesting this is a Python Flask application. The 404 page shows the [default Flask 404](about:/cheatsheets/404#flask), matching the `server` header:

![image-20240916172809309](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916172809309.webp)
...
![image-20240916174202797](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916174202797.webp)
...
![image-20240916175230686](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916175230686.webp)

They work here, showing two repos:

![image-20240916175248603](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916175248603.webp)

After the patch about a week after release, these repos are just public, and the default creds no longer work:

![image-20250122090206772](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250122090206772.webp)
...
![image-20240916175353095](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916175353095.webp)
...
![image-20240916183047273](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916183047273.webp)

#### Caption-Portal

This repo has `app` and `config` folders, and a `README`:

![image-20240916175926536](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916175926536.webp)
...
![image-20240916180020889](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916180020889.webp)
...
![image-20240916183205727](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916183205727.webp)

In the patched Caption there’s one more commit at the top (which I’ll discuss in [Beyond Root](#patches)):

![image-20250122091221554](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250122091221554.webp)

In the one titled “Update access control”, there’s a password deleted for the margo user:

![image-20240916183354628](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916183354628.webp)
...
The `ExecStart` value shows the command line when it runs, with the following options defined [in the Varnish docs](https://varnish-cache.org/docs/7.6/reference/varnishd.html):
...
![image-20240916185256906](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916185256906.webp)
...
![image-20240916190105365](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240916190105365.webp)
...
![image-20240920061532239](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920061532239.webp)
...
![image-20240919171413823](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919171413823.webp)
...
![image-20240919172315256](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919172315256.webp)
...
![image-20240919173601464](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919173601464.webp)
...
![image-20240920060840987](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920060840987.webp)

The response shows that it wasn’t served from cache. In the content of the page, `TESTING` is there:

![image-20240920060957216](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920060957216.webp)
...
![image-20240920061109474](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920061109474.webp)
...
![image-20240920080648623](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920080648623.webp)
...
![image-20240920093210027](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920093210027.webp)
...
![image-20240920100103807](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920100103807.webp)
...
![](https://www.youtube.com/watch?v=LVDBpON4_IQ)
...
It’d be nice to figure out what user I’m running as. Typically that would be something like www-data, but it’s worth checking if it’s a user from `/etc/passwd`. Typically I check `/proc/self/environ`, but it doesn’t work here (probably due to the content length / file size as explained [in this video](https://www.youtube.com/watch?v=Cife4ejJGlo)).
...
![image-20240920142950483](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920142950483.webp)
...
![image-20240920143420133](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920143420133.webp)

It’s created the alias. I’ll run the second line, but rather than writing it to a file, I’ll just execute:

![image-20240920143502276](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920143502276.webp)
...
![image-20240920143750479](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920143750479.webp)
...
![image-20240920143934000](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920143934000.webp)

There’s three files there. I’ll grab the private key:

![image-20240920144022256](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920144022256.webp)
...
![image-20240920144325810](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920144325810.webp)
...
![image-20240920144801831](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920144801831.webp)
...
![image-20240920145019707](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920145019707.webp)

This is a bypass of the HAProxy ACL. As admin, it loads the page:

![image-20240920145153567](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240920145153567.webp)
...
![image-20250123144456753](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250123144456753.webp)

The change to the HAProxy rules can be seen in a commit on GitBucket:

![image-20250123144532907](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250123144532907.webp)
