[HTB: Response](/2023/02/04/htb-response.html)

![Response](https://0xdfimages.gitlab.io/img/response-cover.webp)
...
[![Response](/icons/box-response.webp)](https://hackthebox.com/machines/response)

[Response](https://hackthebox.com/machines/response)
...
Rated Difficulty ![Rated difficulty for Response](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/response-diff.webp)

Radar Graph ![Radar chart for Response](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/response-radar.webp)

User

03:22:52 Root

17:46:49 Creator ## Recon
...
![image-20230130130952378](https://0xdfimages.gitlab.io/img/image-20230130130952378.webp)
...
![image-20230130205312129](https://0xdfimages.gitlab.io/img/image-20230130205312129.webp)
...
![image-20230130135302771](https://0xdfimages.gitlab.io/img/image-20230130135302771.webp)
...
This looks like a SHA256 hash based on the length, but it doesn’t work when I try to regenerate it. It is likely a keyed hash (or HMAC), such that only someone with the secret key can generate the hashes. I’ve seen this kind of integrity protection before. In [Proper](about:/2021/08/21/htb-proper.html#access-to-licenses) I had to leak the salt/key to generate my own keys on the fly and perform SQL injection.
...
![image-20230202131350228](https://0xdfimages.gitlab.io/img/image-20230202131350228.webp)
...
![image-20230130211115888](https://0xdfimages.gitlab.io/img/image-20230130211115888.webp)

Still, further down the page, there’s a `session` and `session_digest`:

![image-20230130211155461](https://0xdfimages.gitlab.io/img/image-20230130211155461.webp)
...
![image-20230130211521938](https://0xdfimages.gitlab.io/img/image-20230130211521938.webp)
...
![image-20230131135328668](https://0xdfimages.gitlab.io/img/image-20230131135328668.webp)

I’ll use that to send to `/fetch` and get the base64-encoded body:

![image-20230131135430373](https://0xdfimages.gitlab.io/img/image-20230131135430373.webp)
...
![](https://0xdfimages.gitlab.io/img/ResponseProxy.webp)
...
![](https://www.youtube.com/watch?v=01Zxb1RyOaM)

The final script is (also available [on GitLab](https://gitlab.com/0xdf/ctfscripts/-/blob/master/htb-response/response_http.py)):
...
![image-20230131143359222](https://0xdfimages.gitlab.io/img/image-20230131143359222.webp)
...
![image-20230131144018346](https://0xdfimages.gitlab.io/img/image-20230131144018346.webp)
...
![image-20230131150649827](https://0xdfimages.gitlab.io/img/image-20230131150649827.webp)
...
The `-D` is giving the admin information I set in the docker compose, and the `-w` is the admin password from there. [This explainshell breakdown](https://explainshell.com/explain?cmd=ldapadd+-x+-H+ldap%3A%2F%2Flocalhost+-D+%22cn%3Dadmin%2Cdc%3Dresponse%2Cdc%3Dhtb%22+-w+0xdf0xdf+-f+users.ldif) shows the full command.
...
![image-20230131160814129](https://0xdfimages.gitlab.io/img/image-20230131160814129.webp)

On forwarding that, it logs in as admin:

![image-20230131160839752](https://0xdfimages.gitlab.io/img/image-20230131160839752.webp)
...
![image-20230201141030676](https://0xdfimages.gitlab.io/img/image-20230201141030676.webp)
...
![image-20230201141504189](https://0xdfimages.gitlab.io/img/image-20230201141504189.webp)
...
![image-20230131161210479](https://0xdfimages.gitlab.io/img/image-20230131161210479.webp)
...
![image-20230131164521935](https://0xdfimages.gitlab.io/img/image-20230131164521935.webp)
...
![image-20230131163913780](https://0xdfimages.gitlab.io/img/image-20230131163913780.webp)

#### FTP Over XMLHTTP

My next thought is to create a JavaScript payload that will read from the FTP server. Borrowing a payload from [CrossFitTwo](about:/2021/08/14/htb-crossfittwo.html#cors-bypass), I’ll modify it to this:
...
![image-20230131171947128](https://0xdfimages.gitlab.io/img/image-20230131171947128.webp)
...
So what if that hits the FTP server? To demonstrate in a FTP scenario, I’ll boot up an old box that has anonymous FTP access, [Luke](about:/2019/09/14/htb-luke.html#ftp---tcp-21), and `nc` to the FTP server, sending that data:
...
![image-20230131212738257](https://0xdfimages.gitlab.io/img/image-20230131212738257.webp)
...
While doing analysis of the `scan` application, I noticed that the `log.txt` file was constantly changing:
 ...
 ![image-20230201154014162](https://0xdfimages.gitlab.io/img/image-20230201154014162.webp)![image-20230201154021295](https://0xdfimages.gitlab.io/img/image-20230201154021295.webp) ![image-20230201154029788](https://0xdfimages.gitlab.io/img/image-20230201154029788.webp)
...
![image-20230201151728970](https://0xdfimages.gitlab.io/img/image-20230201151728970.webp)
...
![](https://0xdfimages.gitlab.io/img/ResponseScan.webp)
...
![image-20230201161038480](https://0xdfimages.gitlab.io/img/image-20230201161038480.webp)
...
![image-20230201161723744](https://0xdfimages.gitlab.io/img/image-20230201161723744.webp)
...
![image-20230201163209412](https://0xdfimages.gitlab.io/img/image-20230201163209412.webp)
...
![image-20230201163433392](https://0xdfimages.gitlab.io/img/image-20230201163433392.webp)
...
![image-20230201170512931](https://0xdfimages.gitlab.io/img/image-20230201170512931.webp)
...
![image-20230201170802610](https://0xdfimages.gitlab.io/img/image-20230201170802610.webp)
...
![image-20230201221217985](https://0xdfimages.gitlab.io/img/image-20230201221217985.webp)
...
![image-20230202064541364](https://0xdfimages.gitlab.io/img/image-20230202064541364.webp)
...
![image-20230202065710117](https://0xdfimages.gitlab.io/img/image-20230202065710117.webp)
...
![image-20230202150228361](https://0xdfimages.gitlab.io/img/image-20230202150228361.webp)

Then POSTs to `/fetch` on `proxy.response.htb` to get that page:

![image-20230202150330884](https://0xdfimages.gitlab.io/img/image-20230202150330884.webp)
...
![image-20230202150534342](https://0xdfimages.gitlab.io/img/image-20230202150534342.webp)
...
![image-20230202151002584](https://0xdfimages.gitlab.io/img/image-20230202151002584.webp)

The attacker connects as b0b, and once inside the chat, makes a request to admin:

![image-20230202151055399](https://0xdfimages.gitlab.io/img/image-20230202151055399.webp)

The admin says agrees:

![image-20230202151416004](https://0xdfimages.gitlab.io/img/image-20230202151416004.webp)

Then (in TCP stream 96) an ELF is fetched from the attacker at `/auto_update`:

![image-20230202151326780](https://0xdfimages.gitlab.io/img/image-20230202151326780.webp)
...
![image-20230202151927533](https://0xdfimages.gitlab.io/img/image-20230202151927533.webp)

There’s a lot, but I can filter on `auto` and the one file is left:

![image-20230202152027859](https://0xdfimages.gitlab.io/img/image-20230202152027859.webp)
...
![image-20230202152250651](https://0xdfimages.gitlab.io/img/image-20230202152250651.webp)
...
![image-20230202152559865](https://0xdfimages.gitlab.io/img/image-20230202152559865.webp)
...
![image-20230202154904655](https://0xdfimages.gitlab.io/img/image-20230202154904655.webp)
...
![](https://www.youtube.com/watch?v=-RlZCTYcgvk)
...
![image-20230202162653716](https://0xdfimages.gitlab.io/img/image-20230202162653716.webp)
...
![image-20230203063607550](https://0xdfimages.gitlab.io/img/image-20230203063607550.webp)
...
![image-20230203063729063](https://0xdfimages.gitlab.io/img/image-20230203063729063.webp)
...
![image-20230202164321563](https://0xdfimages.gitlab.io/img/image-20230202164321563.webp)
...
The full output of the parsed pcap is available [on GitLab](https://gitlab.com/0xdf/ctfscripts/-/blob/master/htb-response/msf_output.txt). I’ll cover some highlights.

Each request packet seems to have a `COMMAND_ID` and a `REQUEST_ID`. The `COMMAND_ID` defines the type of command (it can be looked up [in command\_ids.h](https://github.com/rapid7/mettle/blob/52de3c892701e0101746b46ee8b47b76cde8d2d4/mettle/src/command_ids.h)). The `REQUEST_ID` seems to be unique for the request. For example:
...
0x41f = 1055 = `COMMAND_ID_STDAPI_SYS_CONFIG_GETUID`:=. The response sends back the `COMMAND_ID` and `REQUEST_ID` (sometimes with some extra data?) along with a `UUID` and the result:
...
The final script is available [on GitLab](https://gitlab.com/0xdf/ctfscripts/-/blob/master/htb-response/parse_msf.py).
...
![image-20230203111834631](https://0xdfimages.gitlab.io/img/image-20230203111834631.webp)
...
![image-20230203111946035](https://0xdfimages.gitlab.io/img/image-20230203111946035.webp)
...
![image-20230203140031021](https://0xdfimages.gitlab.io/img/image-20230203140031021.webp)
...
![image-20230203141743926](https://0xdfimages.gitlab.io/img/image-20230203141743926.webp)
