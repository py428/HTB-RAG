[HTB: Inject](/2023/07/08/htb-inject.html)

![Inject](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/inject-cover.webp)
...
[![Inject](/icons/box-inject.webp)](https://hackthebox.com/machines/inject)

[Inject](https://hackthebox.com/machines/inject)
...
Rated Difficulty ![Rated difficulty for Inject](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/inject-diff.webp)

Radar Graph ![Radar chart for Inject](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/inject-radar.webp)

User

00:42:52 Root

00:54:22 Creator ## Recon
...
[![image-20230313172233599](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313172233599.png)](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313172233599.png)

[*Click for full image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313172233599.png)

The Blogs page (`/blogs`) has three articles:

[![image-20230313172900444](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313172900444.png)](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313172900444.png)

[*Click for full image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313172900444.png)

But clicking on them doesn’t go to anything.

Trying to register just gives an “Under Construction” message:

![image-20230313173054827](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313173054827.webp)

At the top right of the page, there’s an upload link, which goes to `/upload`:

![image-20230313173320461](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313173320461.webp)

If I try to upload a dummy text file, it rejects it:

![image-20230313173426299](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313173426299.webp)

If I give it an image, it returns a link to that image:

![image-20230313174838711](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313174838711.webp)
...
![image-20230313173718202](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313173718202.webp)

Googling for that exact message returns a bunch of stuff about Tomcat:

![image-20230313173834603](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313173834603.webp)
...
![image-20230313175115351](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313175115351.webp)

If I change `htb-desktop.png` to `.`, it lists the files in that directory:

![image-20230313175315092](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313175315092.webp)

I can also perform a directory traversal to leave this directory:

![image-20230313175415503](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313175415503.webp)
...
![image-20230313212935425](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313212935425.webp)
...
![image-20230313175654118](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313175654118.webp)
...
![image-20230313175805245](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313175805245.webp)

`html` is empty (or inaccessible). `WebApp` has the root of a Java project:

![image-20230313175854360](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313175854360.webp)
...
I’ll open VSCode and the directory containing my copy of the `pom.xml` file. At first, I wasn’t getting anything back, but that’s because my machine didn’t have Maven (the Java build system) installed, as seen in the Snyk output:
 ...
 [![image-20230706133820912](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230706133820912.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230706133820912.png)
...
![image-20230706134029158](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230706134029158.webp)
...
![image-20230313183004040](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313183004040.webp)
...
![image-20230313183519151](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313183519151.webp)
...
![image-20230313184201736](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313184201736.webp)
...
![image-20230313184312048](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313184312048.webp)
...
![image-20230313213946016](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230313213946016.webp)
