[HTB: Perfection](/2024/07/06/htb-perfection.html)

![Perfection](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/perfection-cover.webp)
...
[![Perfection](/icons/box-perfection.webp)](https://hackthebox.com/machines/perfection)

[Perfection](https://hackthebox.com/machines/perfection)
...
Rated Difficulty ![Rated difficulty for Perfection](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/perfection-diff.webp)

Radar Graph ![Radar chart for Perfection](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/perfection-radar.webp)

User

00:10:14 Root

00:22:11 Creator ## Recon
...
The site is a grade calculator:
 ...
 ![image-20240625132146487](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625132146487.webp)![expand](/icons/expand.png)

There are two links. The about page (`/about`) shows two team members:

![image-20240625133142328](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625133142328.webp)

The calculator (`/weighted-grade`) has a form that takes up to five grades with weights:

![image-20240625133242212](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625133242212.webp)

To use it as intended:

![image-20240625133337290](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625133337290.webp)

On submitting, it shows:

![image-20240625133356465](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625133356465.webp)
...
![image-20240625132509145](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625132509145.webp)

Image searching for that string shows a bunch of references to “Sinatra”:

![image-20240625133044110](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625133044110.webp)
...
![image-20240625141242356](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625141242356.webp)

In the page that shows up as:

![image-20240625141341528](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625141341528.webp)
...
![image-20240625141855757](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625141855757.webp)
...
The thing to notice is that in either of the above cases, the regex doesn’t check across newlines. I exploited a similar vulnerability in PHP in [HTB Clicker](about:/2024/01/27/htb-clicker.html#bypass-check-via-newline-injection). The idea is that I can send something like “0xdf%0a$” and see if it is still flagged, where “%0a” is a URL-encoded newline. I’m including something at the front of the string in case the regex is like the second one above, where it needs to match on something (if that “+” (one or more) was a “\*” (zero or more) I wouldn’t need it, but better to be safe).

It works:

![image-20240625143450873](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625143450873.webp)
...
![image-20240625144147232](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625144147232.webp)

URL-encoding the potentially bad characters (selecting from “<” through “>” in Repeater and hitting Ctrl-u) fixes that:

![image-20240625144222270](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625144222270.webp)
...
![image-20240625144413233](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625144413233.webp)
...
![image-20240625144609271](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240625144609271.webp)
