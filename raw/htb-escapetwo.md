[HTB: EscapeTwo](/2025/05/24/htb-escapetwo.html)

![EscapeTwo](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/escapetwo-cover.webp)
...
[![EscapeTwo](/icons/box-escapetwo.webp)](https://hackthebox.com/machines/escapetwo)

[EscapeTwo](https://hackthebox.com/machines/escapetwo)
...
Rated Difficulty ![Rated difficulty for EscapeTwo](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/escapetwo-diff.webp)

Radar Graph ![Radar chart for EscapeTwo](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/escapetwo-radar.webp)

User

00:20:26 Root

00:24:57 Creators   Scenario
...
The box shows many of the ports associated with a [Windows Domain Controller](about:/cheatsheets/os#windows-domain-controller). The domain is `sequel.htb`, and the hostname is `DC01`. I’ll add this to my `/etc/hosts` file:
...
I am given credentials for a low priv user at the start of the box:

As is common in real life Windows pentests, you will start this box with credentials for the following account:  
rose / KxEPkKe6R8su

This is meant to reflect many real world pentests that start this way. I’ll verify they do work over SMB:
...
![image-20250117121130090](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250117121130090.webp)
...
![image-20250522103635485](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250522103635485.webp)
...
![image-20250117121900287](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250117121900287.webp)
...
![image-20250117122137633](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250117122137633.webp)
...
![image-20250117122254071](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250117122254071.webp)
...
![image-20250117132536020](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250117132536020.webp)

Ryan has `WriteOwner` over CA\_SVC:

![image-20250117132632738](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250117132632738.webp)
...
![image-20250117133133902](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250117133133902.webp)
...
![image-20250117140420368](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250117140420368.webp)
