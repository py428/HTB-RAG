[HTB: Instant](/2025/03/01/htb-instant.html)

![Instant](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/instant-cover.webp)
...
[![Instant](/icons/box-instant.webp)](https://hackthebox.com/machines/instant)

[Instant](https://hackthebox.com/machines/instant)
...
Rated Difficulty ![Rated difficulty for Instant](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/instant-diff.webp)

Radar Graph ![Radar chart for Instant](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/instant-radar.webp)

User

00:14:06 Root

00:44:11 Creator ## Recon
...
The site is for a money exchange app:
 ...
 ![image-20250221141903504](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221141903504.webp)![expand](/icons/expand.png)
...
The main page loads as `/index.html`, suggesting this may be a static website. The 404 page is the [default Apache page](about:/cheatsheets/404#apache--httpd):

![image-20250221142214029](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221142214029.webp)
...
![image-20250221143055880](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221143055880.webp)

There’s an app that requires login. Trying to log in pops an error message:

![image-20250221143142147](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221143142147.webp)

It can’t reach `mywalletv1.instant.htb`.

Clicking on “Register Account Now” loads another form:

![image-20250221144215597](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221144215597.webp)

The “Forgot Password” link just says to email support:

![image-20250221144242476](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221144242476.webp)
...
![image-20250222062551833](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250222062551833.webp)
...
![image-20250221144443857](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221144443857.webp)
...
![image-20250221145449579](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221145449579.webp)
...
Visiting the root page returns a different 404, the default [Flask 404 page](about:/cheatsheets/404#flask):

![image-20250221151802132](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221151802132.webp)
...
I’ll load the Swagger page to see the full (exposed) API:
 ...
 ![image-20250221151106205](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221151106205.webp)![expand](/icons/expand.png)
...
![image-20250221151405928](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221151405928.webp)

In the `read/log` endpoint, I’ll enter `1.log`, and it returns the contents of a test log:

![image-20250221152021011](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221152021011.webp)

### Directory Traversal / File Read

This endpoint can be abused with directory traversal and file read. For example, `../../../etc/passwd`:

![image-20250221152155078](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221152155078.webp)

More interestingly, because this is running from a user’s home directory, I can grab `user.txt`:

![image-20250221152241788](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221152241788.webp)

I can also grab an SSH key:

![image-20250221152307304](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250221152307304.webp)
...
![Solar-PuTTY | SSH Client Software](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/Screenshot_0_Solar-PuTTY-800x582.webp)
