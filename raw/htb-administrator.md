[HTB: Administrator](/2025/04/19/htb-administrator.html)

![Administrator](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/administrator-cover.webp)
...
[![Administrator](/icons/box-administrator.webp)](https://hackthebox.com/machines/administrator)

[Administrator](https://hackthebox.com/machines/administrator)
...
Rated Difficulty ![Rated difficulty for Administrator](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/administrator-diff.webp)

Radar Graph ![Radar chart for Administrator](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/administrator-radar.webp)

User

00:06:01 Root

00:09:06 Creator Scenario
...
The box looks like a [Windows domain controller](about:/cheatsheets/os#windows-domain-controller) (Kerberos, LDAP, SMB, etc). It also has WinRM (5985) open if I find creds for a user with those permissions.
...
I’ll start Bloodhound-CE in a Docker container (see my [Blazoried post](about:/2024/11/09/htb-blazorized.html#bloodhound) for details) and load the data. I’ll start by finding Olivia and marking them as owned. Bloodhound shows one user with outbound control:

![image-20241115181154270](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20241115181154270.webp)

michael is in the Remote Management Users group as well:

![image-20241116160939456](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20241116160939456.webp)
...
![image-20241116160756713](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20241116160756713.webp)
...
![image-20241116161754037](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20241116161754037.webp)
...
![image-20250415170047931](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250415170047931.webp)
...
![image-20241116165154002](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20241116165154002.webp)

I’ll fill it in with what I’ve got:

![image-20241116165241356](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20241116165241356.webp)

It has three entries:

![image-20241116165359412](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20241116165359412.webp)
...
Given I have a shell on the box, I could do this from either Windows or from my Linux host. I showed the Windows attack on [Blazorized](about:/2024/11/09/htb-blazorized.html#targeted-kerberoast), so I’ll do it from Linux here. Bloodhound gives full instructions for doing this:

![image-20241117065000695](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20241117065000695.webp)
...
![image-20241117150439982](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20241117150439982.webp)
