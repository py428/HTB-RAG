[HTB: SteamCloud](/2022/02/14/htb-steamcloud.html)

![SteamCloud](https://0xdfimages.gitlab.io/img/steamcloud-cover.webp)
...
[![SteamCloud](/icons/box-steamcloud.webp)](https://hackthebox.com/machines/steamcloud)

[SteamCloud](https://hackthebox.com/machines/steamcloud)
...
Those all seem Kubernetes-related, and match what I saw on [Unobtainium](about:/2021/09/04/htb-unobtainium.html#nmap).
...
![image-20220213164430344](https://0xdfimages.gitlab.io/img/image-20220213164430344.webp)

The anonymous user can’t `/`.

I can install a tool like `kubectl` (instructions [on kubernetes.io](https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/)) and try to interact, but it just prompts for auth:
...
![image-20220213165532092](https://0xdfimages.gitlab.io/img/image-20220213165532092.webp)
...
Just like in [Unobtainium](about:/2021/09/04/htb-unobtainium.html#filesystem-as-root), the trick here is to create a pod (container) that has the root file system mapped into it. Then I can execute in the pod, and access the mapped volume, which is the full file system of the host.
