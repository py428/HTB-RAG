[HTB: Mailroom](/2023/08/19/htb-mailroom.html)

![Mailroom](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/mailroom-cover.webp)
...
[![Mailroom](/icons/box-mailroom.webp)](https://hackthebox.com/machines/mailroom)

[Mailroom](https://hackthebox.com/machines/mailroom)
...
Rated Difficulty ![Rated difficulty for Mailroom](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/mailroom-diff.webp)

Radar Graph ![Radar chart for Mailroom](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/mailroom-radar.webp)

User

02:19:03 Root

03:15:15 Creator ## Recon
...
The site is for a shipping company:
 ...
 ![image-20230419160721819](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419160721819.webp)![expand](/icons/expand.png)
...
![image-20230419161810857](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419161810857.webp)

It says that the AI will read and reply. That’s interesting. When I submit something, a message appears above the button:

![image-20230419161900652](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419161900652.webp)

Clicking the link leads to a page with the inquiry:

![image-20230419161921365](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419161921365.webp)

The page also does have `mailroom.htb` in the footer:

![image-20230419161938290](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419161938290.webp)
...
The site is an instance of Gitea:
 ...
 ![image-20230419164903573](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419164903573.webp)![expand](/icons/expand.png)

The version is 1.18.0, which was [released](https://github.com/go-gitea/gitea/releases/tag/v1.18.0) on December 29, 2022:

![image-20230419165204964](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419165204964.webp)
...
![image-20230419164943735](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419164943735.webp)

The Users page has three users:

![image-20230420181808065](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420181808065.webp)
...
![image-20230419171600904](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419171600904.webp)

Looking at `index.php`, it is definitely not a match with the main site I have accessed already.

 [![image-20230419174711670](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419174711670.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419174711670.png)

In `auth.php`, there’s a reference to a full domain:

 [![image-20230419174819985](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419174819985.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419174819985.png)
...
![image-20230419170950730](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230419170950730.webp)
...
![image-20230420170252171](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420170252171.webp)

On submitting, checking out the returned link, “test” is in bold:

![image-20230420170317817](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420170317817.webp)
...
![image-20230420170540506](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420170540506.webp)
...
![image-20230420204631791](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420204631791.webp)

Now when I load the domain, it works:

![image-20230420204701916](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420204701916.webp)

#### Login

When I enter tristan’s email and password, it responds with a message telling me to check my email:

![image-20230420204802539](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420204802539.webp)
...
![image-20230420204907507](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420204907507.webp)
...
![image-20230420214538081](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420214538081.webp)

If I submit a query id from the dash board to “Read Inqueries”, it shows the content of the inquiry:

![image-20230420214652222](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420214652222.webp)

Similarly, if I send that same ID to “Check Status”:

![image-20230420214716550](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420214716550.webp)
...
![image-20230420215006183](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420215006183.webp)

On sending, it hangs for a few seconds, and then returns failure:

![image-20230420215017503](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420215017503.webp)
...
![image-20230420215545709](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230420215545709.webp)
...
2. Some other process has this file open. That isn’t always the case. If I run `watch -d 'ls -la ~` I’ll see the `.lock` file show up and go away:
	![image-20230421083913849](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230421083913849.webp)
...
![](https://www.youtube.com/watch?v=pQrjQLktqss)
