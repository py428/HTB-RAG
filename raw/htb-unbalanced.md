[HTB: Unbalanced](/2020/12/05/htb-unbalanced.html)

![Unbalanced](https://0xdfimages.gitlab.io/img/unbalanced-cover.webp)
...
[![Unbalanced](/icons/box-unbalanced.webp)](https://hackthebox.com/machines/unbalanced)

[Unbalanced](https://hackthebox.com/machines/unbalanced)
...
Rated Difficulty ![Rated difficulty for Unbalanced](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/unbalanced-diff.webp)

Radar Graph ![Radar chart for Unbalanced](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/unbalanced-radar.webp)

User

01:49:26 Root

02:09:09 Creators   ## Recon
...
Having just solved [Joker](about:/2020/08/13/htb-joker.html#enumeration-through-proxy) (where I also needed to use a Squid Proxy), this was familiar. I added the Squid proxy as a FoxyProxy configuration:

![image-20200813214257180](https://0xdfimages.gitlab.io/img/image-20200813214257180.webp)

With that proxy enabled, I tried to visit `http://127.0.0.1/`:

![image-20200813214327478](https://0xdfimages.gitlab.io/img/image-20200813214327478.webp)

I either need creds to access this url, or it is blocked somehow. I’ll go look for creds and/or the config.

### RSync - TCP 873

I’ll use the `rsync` command to take a look at what modules are available on Unbalanced, just like I did in [Zetta](about:/2020/02/22/htb-zetta.html#rsync---tcp-8730):
...
I remember from [Joker](about:/2020/08/13/htb-joker.html#tftp---udp-69) getting creds out of this file, but I don’t see any here. I do see how it is configured to allow connections through to an internal network of 172.16.0.0/12 (that’s a big IP space), but also there’s a host name, intranet.unbalanced.htb.
...
![image-20200817151540889](https://0xdfimages.gitlab.io/img/image-20200817151540889.webp)
...
![image-20200817152157470](https://0xdfimages.gitlab.io/img/image-20200817152157470.webp)
...
![image-20200819153452638](https://0xdfimages.gitlab.io/img/image-20200819153452638.webp)

The admin panel is located at `/admin` (which can be found from the link in the above image). It gives a dashboard:

![image-20200819153708739](https://0xdfimages.gitlab.io/img/image-20200819153708739.webp)

There’s a link to Login, which leads to a form:

![image-20200819153742373](https://0xdfimages.gitlab.io/img/image-20200819153742373.webp)
...
![image-20200820160051438](https://0xdfimages.gitlab.io/img/image-20200820160051438.webp)
...
![image-20200820161648754](https://0xdfimages.gitlab.io/img/image-20200820161648754.webp)

I’ll start Netcat with `nc -lnvp 80`, and then add the following new blocklist:

![image-20200820162029391](https://0xdfimages.gitlab.io/img/image-20200820162029391.webp)
...
![image-20200820162949485](https://0xdfimages.gitlab.io/img/image-20200820162949485.webp)
