[HTB: Overflow](/2022/04/09/htb-overflow.html)

![Overflow](https://0xdfimages.gitlab.io/img/overflow-cover.webp)
...
[![Overflow](/icons/box-overflow.webp)](https://hackthebox.com/machines/overflow)

[Overflow](https://hackthebox.com/machines/overflow)
...
Rated Difficulty ![Rated difficulty for Overflow](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/overflow-diff.webp)

Radar Graph ![Radar chart for Overflow](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/overflow-radar.webp)

User

01:33:14 Root

02:01:30 Creator ## Recon
...
![image-20210927162034997](https://0xdfimages.gitlab.io/img/image-20210927162034997.webp)

“Sign Up” leads to `register.php`:

![image-20210927162102159](https://0xdfimages.gitlab.io/img/image-20210927162102159.webp)
...
![image-20210927162350865](https://0xdfimages.gitlab.io/img/image-20210927162350865.webp)

`/home/profile/` gives a profile page, but the buttons don’t do anything:

![image-20210927162510334](https://0xdfimages.gitlab.io/img/image-20210927162510334.webp)
...
![image-20210927165941658](https://0xdfimages.gitlab.io/img/image-20210927165941658.webp)
...
When there’s some encrypted object that leaks information about if the padding is good or not, I can attack that with a Padding Oracle Attack. I went into detail on how this attack works in the [Lazy](about:/2020/07/29/htb-lazy.html#path-1-padding-oracle-attack) writeup, so check out that for a full background. The really short version is that because it tells me when the padding is bad, I can brute force across the bytes of the cookie to read the decrypted plaintext, as well as create a cookie with different plaintext.
...
![image-20210927195536003](https://0xdfimages.gitlab.io/img/image-20210927195536003.webp)
...
![image-20210928122307248](https://0xdfimages.gitlab.io/img/image-20210928122307248.webp)
...
![image-20210928122657857](https://0xdfimages.gitlab.io/img/image-20210928122657857.webp)
...
![image-20210928131318128](https://0xdfimages.gitlab.io/img/image-20210928131318128.webp)
...
![image-20210928132249274](https://0xdfimages.gitlab.io/img/image-20210928132249274.webp)
...
![image-20210928143716922](https://0xdfimages.gitlab.io/img/image-20210928143716922.webp)

Clicking around, there isn’t much here. But under Extensions, there’s a link to “User Defined Tags”:

![image-20210928143943033](https://0xdfimages.gitlab.io/img/image-20210928143943033.webp)

There’s one there currently:

![image-20220406203300202](https://0xdfimages.gitlab.io/img/image-20220406203300202.webp)
...
![image-20210929163823612](https://0xdfimages.gitlab.io/img/image-20210929163823612.webp)
...
![image-20210928145329124](https://0xdfimages.gitlab.io/img/image-20210928145329124.webp)
...
I can see that above by shifting 31 bits to the right, or looking at the hex and seeing the first character is `f`, which is `1111`. To display it as a negative number, I’ll just subtract 2 <sup>32</sup>:
...
![image-20210930083358132](https://0xdfimages.gitlab.io/img/image-20210930083358132.webp)
...
![image-20210930095520033](https://0xdfimages.gitlab.io/img/image-20210930095520033.webp)
...
![](https://www.youtube.com/watch?v=ZroW5AHGK6Q)
