[HTB: SolarLab](/2024/09/21/htb-solarlab.html)

![SolarLab](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/solarlab-cover.webp)
...
[![SolarLab](/icons/box-solarlab.webp)](https://hackthebox.com/machines/solarlab)

[SolarLab](https://hackthebox.com/machines/solarlab)
...
Rated Difficulty ![Rated difficulty for SolarLab](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/solarlab-diff.webp)

Radar Graph ![Radar chart for SolarLab](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/solarlab-radar.webp)

User

00:24:32 Root

01:08:12 Creator ## Recon
...
The website is for a company that makes an instant messaging program:
 ...
 ![image-20240517151149144](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517151149144.webp)![expand](/icons/expand.png)
...
![image-20240517152545988](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517152545988.webp)

I don’t have creds and basic injections don’t work. I will note the error message on a failed login:

![image-20240919131005477](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919131005477.webp)
...
![image-20240517152723754](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517152723754.webp)
...
`details-file.xlxs` has information about various users and accounts:
 ...
 [![image-20240517153625828](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517153625828.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517153625828.png)
...
![image-20240919131949057](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919131949057.webp)
...
![image-20240517155209474](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517155209474.webp)

The “Leave Request” button goes to a form:

![image-20240517155303636](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517155303636.webp)

Clicking “Generate PDF” leads to a PDF:

![image-20240517155356318](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517155356318.webp)
...
![image-20240517155621146](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517155621146.webp)
...
![image-20240517155854220](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517155854220.webp)
...
![image-20240517162108295](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517162108295.webp)
...
![image-20240517161203143](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517161203143.webp)
...
![image-20240517162428815](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517162428815.webp)
...
![image-20240517163311613](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240517163311613.webp)
...
![image-20240919144728248](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919144728248.webp)
...
![image-20240919152244309](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919152244309.webp)
...
![image-20240919153256926](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919153256926.webp)

#### POC

To test this exploit, I’ll try to read a log file at `/setup/setup-s/%u002e%u002e/%u002e%u002e/log.jsp`, and it works:

![image-20240919153433480](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919153433480.webp)

### Create Admin User

I’ll start by getting a cookie and CSRF token from `plugin-admin.jsp` in the same directory as the log file above:

![image-20240919153727014](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919153727014.webp)

To create a user, I’ll visit `user-create.jsp` in the same directory, passing the necessary info (and with these cookies set):

![image-20240919154141478](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919154141478.webp)
...
![image-20240919154311004](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919154311004.webp)

### OpenFile Plugin RCE

This is the same process as the root step on [Jab](about:/2024/06/29/htb-jab.html#rce-plugin). The same blog post has a link to [this repo](https://github.com/miko550/CVE-2023-32315), which include a script to do what I just did manually, as well as `openfire-management-tool-plugin.jar`. I’ll download a copy of that file.

Now on “Plugins” at the top menu, there’s a form to upload a plugin:

![image-20240919154538123](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919154538123.webp)

Once it uploads, it shows up in the list:

![image-20240919154607686](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919154607686.webp)

Under Server –> Server Settings, Management Tool now shows up at the bottom of the left menu:

![image-20240919154707282](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919154707282.webp)

Clicking it asks for a password, which is “123”:

![image-20240919154735781](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919154735781.webp)

On entering, there’s a few options, but on selecting “system command” from the menu, it gives a form to execute a command:

![image-20240919155255623](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919155255623.webp)

It works:

![image-20240919155310647](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240919155310647.webp)
