[HTB: Delivery](/2021/05/22/htb-delivery.html)

![Delivery](https://0xdfimages.gitlab.io/img/delivery-cover.webp)
...
[![Delivery](/icons/box-delivery.webp)](https://hackthebox.com/machines/delivery)

[Delivery](https://hackthebox.com/machines/delivery)
...
Rated Difficulty ![Rated difficulty for Delivery](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/delivery-diff.webp)

Radar Graph ![Radar chart for Delivery](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/delivery-radar.webp)

User

00:42:52 Root

00:44:25 Creator ## Recon
...
![image-20210106154413236](https://0xdfimages.gitlab.io/img/image-20210106154413236.webp)
...
![image-20210106154548581](https://0xdfimages.gitlab.io/img/image-20210106154548581.webp)
...
![image-20210106161636820](https://0xdfimages.gitlab.io/img/image-20210106161636820.webp)

As a guest user, I can create a ticket:

![image-20210518150259572](https://0xdfimages.gitlab.io/img/image-20210518150259572.webp)

And it will give me a page saying it’s been accepted:

![image-20210518150324085](https://0xdfimages.gitlab.io/img/image-20210518150324085.webp)

The email to add to the ticket is interesting. I’ll note that.

The Sign In link has a form, as well as a registration link:

![image-20210518150408579](https://0xdfimages.gitlab.io/img/image-20210518150408579.webp)
...
![image-20210518150544712](https://0xdfimages.gitlab.io/img/image-20210518150544712.webp)
...
![image-20210518150752101](https://0xdfimages.gitlab.io/img/image-20210518150752101.webp)

This page gives the current ticket, with the option to update it:

![image-20210518150837191](https://0xdfimages.gitlab.io/img/image-20210518150837191.webp)

### delivery.htb - TCP 8065

The main page here is a login form:

![image-20210518151248957](https://0xdfimages.gitlab.io/img/image-20210518151248957.webp)

The create account link leads to another form:

![image-20210518151629166](https://0xdfimages.gitlab.io/img/image-20210518151629166.webp)

Submitting also leads to an email confirmation step:

![image-20210518151658316](https://0xdfimages.gitlab.io/img/image-20210518151658316.webp)
...
![image-20210106162055815](https://0xdfimages.gitlab.io/img/image-20210106162055815.webp)
...
![image-20210106162333924](https://0xdfimages.gitlab.io/img/image-20210106162333924.webp)

Visiting the link in the ticket verifies the account:

![image-20210106162356701](https://0xdfimages.gitlab.io/img/image-20210106162356701.webp)

One logging in, there’s a chance to join a team:

![image-20210106162452740](https://0xdfimages.gitlab.io/img/image-20210106162452740.webp)

On joining that team, there’s a single channel, with some chat from root:

![image-20210106162655389](https://0xdfimages.gitlab.io/img/image-20210106162655389.webp)
