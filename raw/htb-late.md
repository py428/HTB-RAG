[HTB: Late](/2022/07/30/htb-late.html)

![Late](https://0xdfimages.gitlab.io/img/late-cover.webp)
...
[![Late](/icons/box-late.webp)](https://hackthebox.com/machines/late)

[Late](https://hackthebox.com/machines/late)
...
Rated Difficulty ![Rated difficulty for Late](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/late-diff.webp)

Radar Graph ![Radar chart for Late](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/late-radar.webp)

User

00:07:15 Root

00:16:01 Creator ## Recon
...
![image-20220725132202832](https://0xdfimages.gitlab.io/img/image-20220725132202832.webp)
...
![image-20220725132917432](https://0xdfimages.gitlab.io/img/image-20220725132917432.webp)
...
![](https://0xdfimages.gitlab.io/img/late-test.webp)
...
![image-20220725135359723](https://0xdfimages.gitlab.io/img/image-20220725135359723.webp)

That’s easily fixed, but it returns the OCRed text without issue:

![image-20220725135445653](https://0xdfimages.gitlab.io/img/image-20220725135445653.webp)
...
![](https://0xdfimages.gitlab.io/img/late-ssti-poc.webp)
...
![image-20220725141152069](https://0xdfimages.gitlab.io/img/image-20220725141152069.webp)
...
![image-20220725141751822](https://0xdfimages.gitlab.io/img/image-20220725141751822.webp)
...
![](https://0xdfimages.gitlab.io/img/late-ssti-poc-rce-16587734024135.webp)
...
![](https://0xdfimages.gitlab.io/img/late-ssti-rev-10.10.14.6.webp)
...
There’s an interesting file in `/usr/local/sbin` called `ssh-alert.sh`. Running [LinPEAS](https://github.com/carlospolop/privilege-escalation-awesome-scripts-suite/tree/master/linPEAS) calls it out a few times:
 ...
 ![image-20220725162802389](https://0xdfimages.gitlab.io/img/image-20220725162802389.webp)![image-20220725162830594](https://0xdfimages.gitlab.io/img/image-20220725162830594.webp) ![image-20220725162904695](https://0xdfimages.gitlab.io/img/image-20220725162904695.webp)
...
![](https://www.youtube.com/watch?v=hv5DCc7P9XM)
