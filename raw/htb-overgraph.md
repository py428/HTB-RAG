[HTB: Overgraph](/2022/08/06/htb-overgraph.html)

![Overgraph](https://0xdfimages.gitlab.io/img/overgraph-cover.webp)
...
[![Overgraph](/icons/box-overgraph.webp)](https://hackthebox.com/machines/overgraph)

[Overgraph](https://hackthebox.com/machines/overgraph)
...
Rated Difficulty ![Rated difficulty for Overgraph](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/overgraph-diff.webp)

Radar Graph ![Radar chart for Overgraph](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/overgraph-radar.webp)

User

19:40:57 Root

21:05:38 Creator ## Recon
...
![image-20220726164511654](https://0xdfimages.gitlab.io/img/image-20220726164511654.webp)
...
![image-20220726165005187](https://0xdfimages.gitlab.io/img/image-20220726165005187.webp)
...
![image-20220726181834700](https://0xdfimages.gitlab.io/img/image-20220726181834700.webp)
...
![image-20220726181945308](https://0xdfimages.gitlab.io/img/image-20220726181945308.webp)
...
![image-20220727084710647](https://0xdfimages.gitlab.io/img/image-20220727084710647.webp)

On entering “0xdf@graph.htb”, it shows a new form:

![image-20220727084821934](https://0xdfimages.gitlab.io/img/image-20220727084821934.webp)
...
![image-20220726191805044](https://0xdfimages.gitlab.io/img/image-20220726191805044.webp)
...
![image-20220726191925901](https://0xdfimages.gitlab.io/img/image-20220726191925901.webp)
...
![image-20220727064318277](https://0xdfimages.gitlab.io/img/image-20220727064318277.webp)

This will come in handy.

The “DOCS” and “SCHEMA” tabs in the playground also show useful information:

![image-20220727125209692](https://0xdfimages.gitlab.io/img/image-20220727125209692.webp)
...
![image-20220727143737732](https://0xdfimages.gitlab.io/img/image-20220727143737732.webp)
...
![image-20220727120630283](https://0xdfimages.gitlab.io/img/image-20220727120630283.webp)
...
![image-20220727150822866](https://0xdfimages.gitlab.io/img/image-20220727150822866.webp)
...
![image-20220727121727823](https://0xdfimages.gitlab.io/img/image-20220727121727823.webp)
...
![image-20220727121854243](https://0xdfimages.gitlab.io/img/image-20220727121854243.webp)

The site is a bit flaky, but I can send a message back (sometimes I’ll have to refresh to see it):

![image-20220727122357248](https://0xdfimages.gitlab.io/img/image-20220727122357248.webp)
...
![image-20220727123150910](https://0xdfimages.gitlab.io/img/image-20220727123150910.webp)
...
![image-20220727123253203](https://0xdfimages.gitlab.io/img/image-20220727123253203.webp)

`/tasks` seems to just have a bunch of static stuff that isn’t interacted with:

![image-20220727123329843](https://0xdfimages.gitlab.io/img/image-20220727123329843.webp)

#### Dev Tools

On logging in, the site assigns a JWT token as a Cookie that’s named `auth`:

![image-20220727131203143](https://0xdfimages.gitlab.io/img/image-20220727131203143.webp)
...
![image-20220727131446589](https://0xdfimages.gitlab.io/img/image-20220727131446589.webp)
...
![image-20220727134042508](https://0xdfimages.gitlab.io/img/image-20220727134042508.webp)
...
![image-20220727135434637](https://0xdfimages.gitlab.io/img/image-20220727135434637.webp)
...
![image-20220727145236202](https://0xdfimages.gitlab.io/img/image-20220727145236202.webp)
...
![image-20220727145432645](https://0xdfimages.gitlab.io/img/image-20220727145432645.webp)

These values also update in Local Storage:

![image-20220727145634364](https://0xdfimages.gitlab.io/img/image-20220727145634364.webp)
...
![image-20220727150531292](https://0xdfimages.gitlab.io/img/image-20220727150531292.webp)

Both are vulnerable.

Looking in Local Storage, it’s the unexecuted data still:

![image-20220727150605298](https://0xdfimages.gitlab.io/img/image-20220727150605298.webp)
...
![image-20220727151549853](https://0xdfimages.gitlab.io/img/image-20220727151549853.webp)
...
![image-20220727152353617](https://0xdfimages.gitlab.io/img/image-20220727152353617.webp)
...
![image-20220727155346944](https://0xdfimages.gitlab.io/img/image-20220727155346944.webp)

I’ll run a query like this in the Playground and get the tasks assigned to Larry:

![image-20220727155810208](https://0xdfimages.gitlab.io/img/image-20220727155810208.webp)
...
![image-20220727160249022](https://0xdfimages.gitlab.io/img/image-20220727160249022.webp)

I’ll try updating the `id` field to Larry’s. When I send this, it fails:

![image-20220727160355388](https://0xdfimages.gitlab.io/img/image-20220727160355388.webp)
...
![image-20220727165559322](https://0xdfimages.gitlab.io/img/image-20220727165559322.webp)
...
![image-20220727170135294](https://0xdfimages.gitlab.io/img/image-20220727170135294.webp)
...
```
![image-20220727171640868](https://0xdfimages.gitlab.io/img/image-20220727171640868.webp)
...
![image-20220727202118391](https://0xdfimages.gitlab.io/img/image-20220727202118391.webp)
...
![image-20220727202344018](https://0xdfimages.gitlab.io/img/image-20220727202344018.webp)

Now when I go to `/uploads`, select a small `.mkv` file, and click Submit, there’s a message suggesting it was successful:

![image-20220727202426297](https://0xdfimages.gitlab.io/img/image-20220727202426297.webp)
...
![image-20220728135844554](https://0xdfimages.gitlab.io/img/image-20220728135844554.webp)
...
![image-20220728185011483](https://0xdfimages.gitlab.io/img/image-20220728185011483.webp)

Then when I edit I’ll select note 13, which will check for buffer addresses in at 13 x 8 = 0x68 bytes after `message_array`:

![image-20220728185011483](https://0xdfimages.gitlab.io/img/image-20220728185011483-arrows.webp)
...
![](https://www.youtube.com/watch?v=CAIWF9HzfAc)
