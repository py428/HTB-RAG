[HTB: Headless](/2024/07/20/htb-headless.html)

![Headless](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/headless-cover.webp)
...
[![Headless](/icons/box-headless.webp)](https://hackthebox.com/machines/headless)

[Headless](https://hackthebox.com/machines/headless)
...
Rated Difficulty ![Rated difficulty for Headless](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/headless-diff.webp)

Radar Graph ![Radar chart for Headless](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/headless-radar.webp)

User

00:10:44 Root

00:13:42 Creator ## Recon
...
![image-20240711133513899](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711133513899.webp)

The link leads to `/support` which offers a contact form:

![image-20240711133537818](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711133537818.webp)
...
![image-20240711134005471](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711134005471.webp)

If I try some HTML injection by putting something in the message between `<b>` tags, such as “\<b>Hello?\</b>”, I get an error message:

![image-20240711133737728](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711133737728.webp)
...
![image-20240711134450593](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711134450593.webp)
...
![image-20240711134759523](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711134759523.webp)
...
![image-20240711142844634](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711142844634.webp)

I’ll URL decode the `message` and it still triggers:

![image-20240711143023229](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711143023229.webp)
...
![image-20240711143109677](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711143109677.webp)

`>` on it’s own doesn’t trigger it. My guess is that it’s looking for HTML tags, so it needs both `<` and `>`:

![image-20240711143159106](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711143159106.webp)

It also triggers on SSTI attempts (both `{{` and `}}`):

![image-20240711143239592](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711143239592.webp)
...
![image-20240711143852636](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711143852636.webp)

If I add a `<script>` tag to that header (or any header), it seems to process:

![image-20240711144056541](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711144056541.webp)

The “Show response in browser” option is useful here:

![image-20240711144129302](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711144129302.webp)

That’s XSS:

![image-20240711144200954](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711144200954.webp)
...
![image-20240712094756025](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240712094756025.webp)
...
![image-20240711145941904](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711145941904.webp)
...
![image-20240711150158243](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711150158243.webp)

Now on visiting `/dashboard`, a different page loads:

![image-20240711150506982](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711150506982.webp)
...
![image-20240711152940524](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711152940524.webp)
...
![image-20240711153553800](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711153553800.webp)
...
![image-20240711153728250](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711153728250.webp)
...
![image-20240711153948859](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711153948859.webp)
...
![image-20240711154231029](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711154231029.webp)
...
![image-20240711154931693](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711154931693.webp)
...
The second string is URL-safe base64-encoded (the `_` character isn’t part of the standard base64 alphabet). It decodes easily in [Cyberchef](https://gchq.github.io/CyberChef/#recipe=From_Base64\('A-Za-z0-9-_',true,false\)To_Hexdump\(16,false,false,false\)&input=dUFsbVhsVHZtOHZ5aWhqTmFQRFdudkJfWmZz), albeit to random garbage (which would make sense as a signature):
 ...
 [![image-20240711144613685](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711144613685.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711144613685.png)
...
Just like with the user data, the second bunch decodes as URL-safe base64, but to nothing interesting:
 ...
 [![image-20240711162400510](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711162400510.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711162400510.png)

#### Modifying

I can try modifying parts of the cookie. If I start with the unmodified user cookie, I get 401 UNAUTHORIZED for `/dashbard`:

![image-20240711162900240](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711162900240.webp)

If I delete a character from the end of the cookie, it crashes:

![image-20240711162922858](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711162922858.webp)

If I revert that back to ok, and replace the first part with the encoded “admin” string, it still crashes:

![image-20240711163004749](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240711163004749.webp)
...
![image-20240712074216653](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240712074216653.webp)

“That really should be a 401 response, not a 500” I remember thinking. But looking in Burp, it *is* a 401:

![image-20240712074333849](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240712074333849.webp)
