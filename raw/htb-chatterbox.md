[HTB: Chatterbox](/2018/06/18/htb-chatterbox.html)
...
[![Chatterbox](/icons/box-chatterbox.webp)](https://hackthebox.com/machines/chatterbox)

[Chatterbox](https://hackthebox.com/machines/chatterbox)
...
Rated Difficulty ![Rated difficulty for Chatterbox](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/chatterbox-diff.webp)

Radar Graph ![Radar chart for Chatterbox](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/chatterbox-radar.webp)

User

00:31:19 Root

01:13:25 Creator ## Recon
...
In general, TCP/9255 is Monitor on Network, and TCP/9256 is unassigned. That’s not terribly helpful. However, there are multiple references to `AChat` (for example, [on SpeedGuide](https://www.speedguide.net/port.php?port=9256)), and there’s a [SEH-based stack buffer overflow](https://www.exploit-db.com/exploits/36025/) for it.

### AChat Local Testing

I grabbed a copy of the vulnerable version [from SourceForge](https://sourceforge.net/projects/achat/files/AChat%20beta/AChat%20beta%207%20\(v0.150\)/achat0-150setup.exe/download), and installed it on a Windows VM. After a simple installation, `AChat` was up and running: ![Chatterbox Achat image](https://0xdfimages.gitlab.io/img/chatterbox-achat.png)
...
![Chatterbox Achat Calc image](https://0xdfimages.gitlab.io/img/chatterbox-achat-calc.png)
