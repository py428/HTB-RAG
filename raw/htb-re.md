[HTB: RE](/2020/02/01/htb-re.html)

![RE](https://0xdfimages.gitlab.io/img/re-cover.webp)
...
[![RE](/icons/box-re.webp)](https://hackthebox.com/machines/re)

[RE](https://hackthebox.com/machines/re)
...
Rated Difficulty ![Rated difficulty for RE](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/re-diff.webp)

Radar Graph ![Radar chart for RE](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/re-radar.webp)

User

00:59:22 Root

05:25:02 Creator ## Author’s Perspective
...
![image-20191126162214171](https://0xdfimages.gitlab.io/img/image-20191126162214171.webp)

I’ll update my `/etc/hosts` file to map reblog.htb to 10.10.10.144, and then allow the redirect. I get a page titled “RE Blog”.

![1553711547170](https://0xdfimages.gitlab.io/img/1553711547170.webp)
...
![image-20191126165016795](https://0xdfimages.gitlab.io/img/image-20191126165016795.webp)
...
![image-20191126165604284](https://0xdfimages.gitlab.io/img/image-20191126165604284.webp)

I’ll select “Open Document” and click on the “Macro…” button. I’ll navigte to select my macro:

![image-20191126165650380](https://0xdfimages.gitlab.io/img/image-20191126165650380.webp)

When I hit “OK”, I see it now in the list:

![image-20191126165705659](https://0xdfimages.gitlab.io/img/image-20191126165705659.webp)
...
![1553715660330](https://0xdfimages.gitlab.io/img/1553715660330.webp)

I’ll use powershell to get another Nishang shell:

![image-20200124203309334](https://0xdfimages.gitlab.io/img/image-20200124203309334.webp)
...
I’ll upload [Mimikatz](https://github.com/gentilkiwi/mimikatz) to RE (I had some of the same version issues I had in Helpline, and the [same solution](about:/2019/08/17/htb-helpline-kali.html#fix-issue-with-version) fixed it):
...
Having the hashes for coby is enough to [decrypt the file](https://github.com/gentilkiwi/mimikatz/wiki/howto-~-decrypt-EFS-files), just like I [did in Helpline](about:/2019/08/17/htb-helpline-kali.html#read-roottxt). But I can take a shorter route here. That NTLM is crackable. I could break it in `hashcat` with `rockyou`, but in this case I toss it into hashes.org (now gone):

![image-20200125112620176](https://0xdfimages.gitlab.io/img/image-20200125112620176.webp)
