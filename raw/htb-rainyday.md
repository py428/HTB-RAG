[HTB: RainyDay](/2023/02/18/htb-rainyday.html)

![RainyDay](https://0xdfimages.gitlab.io/img/rainyday-cover.webp)
...
[![RainyDay](/icons/box-rainyday.webp)](https://hackthebox.com/machines/rainyday)

[RainyDay](https://hackthebox.com/machines/rainyday)
...
Rated Difficulty ![Rated difficulty for RainyDay](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/rainyday-diff.webp)

Radar Graph ![Radar chart for RainyDay](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/rainyday-radar.webp)

User

01:48:31 Root

05:11:34 Creator ## Recon
...
![image-20230210115420693](https://0xdfimages.gitlab.io/img/image-20230210115420693.webp)
...
![image-20230210115754725](https://0xdfimages.gitlab.io/img/image-20230210115754725.webp)

If I try to register, it returns that registration is currently closed:

![image-20230210115840867](https://0xdfimages.gitlab.io/img/image-20230210115840867.webp)
...
![image-20230210122157558](https://0xdfimages.gitlab.io/img/image-20230210122157558.webp)
...
![image-20230210152332874](https://0xdfimages.gitlab.io/img/image-20230210152332874.webp)

Clicking “New Container” asks for a name and an image:

![image-20230210152409586](https://0xdfimages.gitlab.io/img/image-20230210152409586.webp)

Now it shows up at the bottom of the containers page:

![image-20230210152438899](https://0xdfimages.gitlab.io/img/image-20230210152438899.webp)
...
![image-20230210170109823](https://0xdfimages.gitlab.io/img/image-20230210170109823.webp)
...
![image-20230210170451666](https://0xdfimages.gitlab.io/img/image-20230210170451666.webp)
...
![](https://www.youtube.com/watch?v=cu_wOqZbCqw)

The final script is available [on GitLab](https://gitlab.com/0xdf/ctfscripts/-/blob/master/htb-rainyday/file_read.py).
...
![image-20230214102641081](https://0xdfimages.gitlab.io/img/image-20230214102641081.webp)
...
![image-20230214134651354](https://0xdfimages.gitlab.io/img/image-20230214134651354.webp)
...
That isn’t in the container, but rather on the host. The container is `chroot` -ed into the container part of the host file system (I’ve looked at this before in [container breakouts](/2021/05/17/digging-into-cgroups.html) and in [Scanned](about:/2022/09/10/htb-scanned.html#sandbox-exploit)).
...
It seems the `__import__` function (used by the `import` keyword) has been removed. How Python’s import system works is nicely described [on Ten Thousand Meters](https://tenthousandmeters.com/blog/python-behind-the-scenes-11-how-the-python-import-system-works/). This must be why `safe_python` is “safe”.
...
The solution to this challenge is something I showed on [day 20 of HackVent 2022](about:/hackvent2022/hard#hv2220) - Unicode characters. From that writeup:
...
![image-20230214202748582](https://0xdfimages.gitlab.io/img/image-20230214202748582.webp)
