[HTB: Jupiter](/2023/10/21/htb-jupiter.html)

![Jupiter](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/jupiter-cover.webp)
...
[![Jupiter](/icons/box-jupiter.webp)](https://hackthebox.com/machines/jupiter)

[Jupiter](https://hackthebox.com/machines/jupiter)
...
Rated Difficulty ![Rated difficulty for Jupiter](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/jupiter-diff.webp)

Radar Graph ![Radar chart for Jupiter](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/jupiter-radar.webp)

User

00:49:16 Root

01:05:20 Creator ## Recon
...
The site is about space tourism and data analysis:
 ...
 ![image-20230831153548709](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831153548709.webp)![expand](/icons/expand.png)
...
![image-20230831154551219](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831154551219.webp)
...
![image-20230831154731680](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831154731680.webp)
...
![image-20230831155551744](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831155551744.webp)
...
![image-20230831161136180](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831161136180.webp)
...
![image-20230831162307047](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831162307047.webp)
...
![image-20230831172351464](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831172351464.webp)
...
![image-20230831172547214](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831172547214.webp)

The token is in the file. On entering that, it loads the Jupyter interface:

![image-20230831172624288](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831172624288.webp)
...
![image-20230831172715704](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831172715704.webp)
...
![image-20230831172949096](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831172949096.webp)

With my cursor in that cell, Shift-Enter will run it:

![image-20230831173015339](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831173015339.webp)

#### SSH

I can work from that same cell, updating the code and using Shift-Enter to execute.

![image-20230831173126161](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831173126161.webp)

I’ll create a `.ssh` directory and write my public key into `authorized_keys`:

![image-20230831173357355](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831173357355.webp)
...
![image-20230831175909064](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831175909064.webp)

There’s an example `config.json` file there:

![image-20230831175534890](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230831175534890.webp)
