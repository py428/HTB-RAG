[HTB: Dynstr](/2021/10/16/htb-dynstr.html)

![Dynstr](https://0xdfimages.gitlab.io/img/dynstr-cover.webp)
...
[![Dynstr](/icons/box-dynstr.webp)](https://hackthebox.com/machines/dynstr)

[Dynstr](https://hackthebox.com/machines/dynstr)
...
Rated Difficulty ![Rated difficulty for Dynstr](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/dynstr-diff.webp)

Radar Graph ![Radar chart for Dynstr](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/dynstr-radar.webp)

User

00:42:23 Root

00:44:55 Creator ## Recon
...
![image-20210613135249803](https://0xdfimages.gitlab.io/img/image-20210613135249803.webp)
...
![image-20210613144052430](https://0xdfimages.gitlab.io/img/image-20210613144052430.webp)
...
The largest number that Bash is holding in a variable on my system is 2 <sup>63</sup> -1. One more than that rolls around to the most negative number that fits in a two’s complement 64-bit signed int.
...
All MD5 hashes: 16 <sup>32</sup> = 340282366920938463463374607431768211456

MD5 hashes all digits: 10 <sup>32</sup> = 100000000000000000000000000000000

MD5 hashes that start with a character: 16 <sup>31</sup> \* 6 = 127605887595351923798765477786913079296
