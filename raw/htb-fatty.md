![Fatty](https://0xdfimages.gitlab.io/img/fatty-cover.webp)
...
[![Fatty](/icons/box-fatty.webp)](https://hackthebox.com/machines/fatty)

[Fatty](https://hackthebox.com/machines/fatty)
...
Rated Difficulty ![Rated difficulty for Fatty](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/fatty-diff.webp)

Radar Graph ![Radar chart for Fatty](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/fatty-radar.webp)

User

03:07:32 Root

15:26:36 Creator ## Recon
...
It turns out I already have the OpenJDK Java 8 version on my Kali image (it may be there by default, I rebuilt my VM recently). If I didn’t, I could get the Oracle version [from Oracle](https://www.oracle.com/java/technologies/javase-jdk8-downloads.html). Now I’ll use `update-alternatives` (see [post](/2020/03/24/update-alternatives.html)) to set 8 to the primary version:
...
![GUI login](https://0xdfimages.gitlab.io/img/image-20200804202536731.webp)

When I enter creds and hit Login, there’s an error:

![login error](https://0xdfimages.gitlab.io/img/image-20200804202647852.webp)
...
![image-20200320162159460](https://0xdfimages.gitlab.io/img/image-20200320162159460.webp)
...
![image-20200318165813430](https://0xdfimages.gitlab.io/img/image-20200318165813430.webp)

On clicking OK, there’s a empty window with commands in the menus at the top:

![image-20200318165907246](https://0xdfimages.gitlab.io/img/image-20200318165907246.webp)
...
I want to start with something simple to show that I can modify the client. I wrote an [entire post](about:/2020/08/08/jar-files-analysis-and-modifications.html#modifying-compiled-classes) on how to do these modifications (now updated with Fatty examples and pinned in the table of contents for this post), so see that for details. The summary of the steps is:
...
![image-20200324144531466](https://0xdfimages.gitlab.io/img/image-20200324144531466.webp)
...
![image-20200324144742189](https://0xdfimages.gitlab.io/img/image-20200324144742189.webp)
...
![image-20200325150026999](https://0xdfimages.gitlab.io/img/image-20200325150026999.webp)
...
![image-20200805080046884](https://0xdfimages.gitlab.io/img/image-20200805080046884.webp)

Adding a file that shouldn’t exist, `../0xdf`, filtering hit again:

![image-20200805080129343](https://0xdfimages.gitlab.io/img/image-20200805080129343.webp)
...
![image-20200325152121725](https://0xdfimages.gitlab.io/img/image-20200325152121725.webp)
...
![image-20200326073439172](https://0xdfimages.gitlab.io/img/image-20200326073439172.webp)
...
![image-20200326073730714](https://0xdfimages.gitlab.io/img/image-20200326073730714.webp)

I can also open the text files with the open button (for example, in `../logs`, `info-log.txt`):

![image-20200326073832211](https://0xdfimages.gitlab.io/img/image-20200326073832211.webp)
...
![image-20200327055528651](https://0xdfimages.gitlab.io/img/image-20200327055528651.webp)
```
...
![image-20200327125412731](https://0xdfimages.gitlab.io/img/image-20200327125412731.webp)
...
![image-20200327152331693](https://0xdfimages.gitlab.io/img/image-20200327152331693.webp)
...
![image-20200327143134989](https://0xdfimages.gitlab.io/img/image-20200327143134989.webp)
