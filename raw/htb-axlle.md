[HTB: Axlle](/2024/11/16/htb-axlle.html)

![Axlle](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/axlle-cover.webp)
...
[![Axlle](/icons/box-axlle.webp)](https://hackthebox.com/machines/axlle)

[Axlle](https://hackthebox.com/machines/axlle)
...
Rated Difficulty ![Rated difficulty for Axlle](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/axlle-diff.webp)

Radar Graph ![Radar chart for Axlle](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/axlle-radar.webp)

User

03:06:49 Root

03:34:53 Creator ## Recon
...
The site is for a software development company:
 ...
 ![image-20240626092146141](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626092146141.webp)![expand](/icons/expand.png)

The interesting part of the page is in the middle:

![image-20240626092425827](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626092425827.webp)
...
The main site also loads as `index.html`, suggesting it’s a static page. The 404 page is the [standard IIS page](about:/cheatsheets/404#iis):

![image-20240626092603094](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626092603094.webp)
...
It also recommends the [Excel 2010 SDK](https://www.microsoft.com/en-us/download/details.aspx?id=20199) installed to the default location. The most recent Excel SDK is the 2013 version. Either will work, though I’ll need to update the project to use the 2013 version if I go that route. For the sake of understanding, I will. I’ll download it [from Microsoft](https://www.microsoft.com/en-us/download/details.aspx?id=35567). It by default installs at `C:\`, which is fine:

![image-20240626163558408](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626163558408.webp)
...
![image-20240626163928895](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626163928895.webp)
...
![image-20240626164115099](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626164115099.webp)

I’ll update the date to 2013 (in two placed in that path).

There’s another issue under “Linker” –> “Input” that I’ll update:

![image-20240626164327130](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626164327130.webp)

These could also be changed in the `HelloWorldXll.vcxproj` file:

 [![image-20240626164417129](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626164417129.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626164417129.png)

Once I fix that, it builds just fine:

 [![image-20240626164437062](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626164437062.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626164437062.png)

The result is in the `x64\Debug` folder:

![image-20240626165209883](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626165209883.webp)

Double clicking opens Excel, which pops a warning:

![image-20240626165242824](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626165242824.webp)

If I click “Enable this add-in for this session only”:

![image-20240626165302253](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626165302253.webp)
...
![image-20240626165802848](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626165802848.webp)
...
![image-20240626170553828](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626170553828.webp)
...
![image-20240626195346773](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240626195346773.webp)
