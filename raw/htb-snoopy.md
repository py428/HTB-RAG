[HTB: Snoopy](/2023/09/23/htb-snoopy.html)

![Snoopy](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/snoopy-cover.webp)
...
[![Snoopy](/icons/box-snoopy.webp)](https://hackthebox.com/machines/snoopy)

[Snoopy](https://hackthebox.com/machines/snoopy)
...
Rated Difficulty ![Rated difficulty for Snoopy](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/snoopy-diff.webp)

Radar Graph ![Radar chart for Snoopy](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/snoopy-radar.webp)

User

02:02:14 Root

02:05:42 Creator ## Recon
...
The site is for a security firm:
 ...
 ![image-20230509134416310](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509134416310.webp)![expand](/icons/expand.png)

The footer does have an email address:

![image-20230509134621524](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509134621524.webp)

There are some other usernames with emails as well on the “About” page:

![image-20230509134710205](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509134710205.webp)

I’ll note all these down.

The front page has links to `/download` and `/download?file=announcement.pdf`.

![image-20230921093614437](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230921093614437.webp)

Both download a zip archive, `press_release.zip`, but they are different sizes:

![image-20230509141625352](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509141625352.webp)

The first one has a PDF. The one without a file parameter contains the announcement PDF, plus an `.mp4` video:

![image-20230509141746351](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509141746351.webp)

The last bit of the video has the product manager’s email again:

![image-20230509141822502](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509141822502.webp)

The “Contact” page has a form to submit questions:

 ![image-20230509134930957](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509134930957.webp)![expand](/icons/expand.png)
...
![image-20230509134806721](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509134806721.webp)

It shows on the page as well:

![image-20230509135026762](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509135026762.webp)
...
![image-20230509135302477](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509135302477.webp)
...
Visiting `mm.snoopy.htb` returns a [Mattermost](https://mattermost.com/) page:
 ...
 ![image-20230509142734548](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509142734548.webp)![expand](/icons/expand.png)

Selecting “View in Browser” leads to a login page:

![image-20230509142837370](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509142837370.webp)
...
![image-20230509143635189](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509143635189.webp)
...
![image-20230509143706461](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509143706461.webp)

However, if I enter one of the employees from the site, it gives a different error:

![image-20230509143757041](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509143757041.webp)
...
![image-20230509152805795](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509152805795.webp)
...
![image-20230509153726493](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509153726493.webp)
...
![image-20230509154124652](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509154124652.webp)
...
![](https://www.youtube.com/watch?v=2a4OJeSZ_N0)
...
I’ll grab the link above, `http://mm.snoopy.htb/reset_password_complete?token=3D9opkx= uomfaxkhtwoskxak9msk9fzefkfrpyiexne8g95s675tuj7quytttcmuown`. Visiting the link asks for a new password:

![image-20230509171438255](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509171438255.webp)

Trying to change it will fail:

![image-20230509172553956](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509172553956.webp)
...
![image-20230509172703249](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509172703249.webp)
...
![image-20230509173047988](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509173047988.webp)

I’m able to log in.

![image-20230509173132945](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509173132945.webp)
...
![image-20230509175430992](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509175430992.webp)

And then later cbrown comes back to it:

![image-20230509175520882](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509175520882.webp)

Between that, there’s a conversation about antivirus:

![image-20230509175549292](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509175549292.webp)
...
![image-20230509175824987](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509175824987.webp)

If I click on “Find channel” and search for “se”, it finds the Server Provisioning Channel:

![image-20230509175917765](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509175917765.webp)
...
![image-20230509193113410](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509193113410.webp)

Most of these are default Mattermost commands, but `/server_provision` jumps out as different:

![image-20230509193211488](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509193211488.webp)

It doesn’t have a description. Sending it opens a dialog:

![image-20230509193301539](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509193301539.webp)

I’ll fill out the form. The Operating system has two options, but only one that isn’t marked “Disabled”:

![image-20230509193637230](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509193637230.webp)
...
![image-20230509174852965](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230509174852965.webp)
...
![image-20230510091703886](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230510091703886.webp)
...
![image-20230510092440169](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230510092440169.webp)
...
![image-20230510113951341](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230510113951341.webp)

Further down, there’s a change to `t/t4115-apply-symlink.sh` ([on GitHub](https://github.com/git/git/commit/c867e4fa180bec4750e9b54eb10f459030dbebfd#diff-d37fceb39eb9394533430ff8956cad41dd7f9233672dc778fd5690625906069f)). In this file, it adds tests that should now fail!

![image-20230510122051917](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230510122051917.webp)
...
![image-20230510132938408](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230510132938408.webp)
...
![image-20230510172620920](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230510172620920.webp)
...
![image-20230510170430588](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230510170430588.webp)
...
![image-20230510172335764](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230510172335764.webp)
...
![image-20230920222934372](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230920222934372.webp)
