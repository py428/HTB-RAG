[HTB: Conceal](/2019/05/18/htb-conceal.html)

![Conceal-cover](https://0xdfimages.gitlab.io/img/conceal-cover.webp)
...
[![Conceal](/icons/box-conceal.webp)](https://hackthebox.com/machines/conceal)

[Conceal](https://hackthebox.com/machines/conceal)
...
Rated Difficulty ![Rated difficulty for Conceal](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/conceal-diff.webp)

Radar Graph ![Radar chart for Conceal](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/conceal-radar.webp)

User

07:00:14 Root

23:36:41 Creator ## Recon
...
I could look up [iso.3.6.1.2.1.1.4 and see that it is sysContact](https://www.alvestrand.no/objectid/1.3.6.1.2.1.1.4.html), but it’s easier if I just enable MIB support for `snmpwalk` (for details, see the [Mischief post](about:/2019/01/05/htb-mischief.html#background)), and run that again:
...
![Conceal Shell image](https://0xdfimages.gitlab.io/img/conceal-shell.gif)
...
I’ll build and upload a copy of [Watson](https://github.com/rasta-mouse/Watson). For full details on that process, check out my [Bounty write-up](about:/2018/10/27/htb-bounty.html#watson).
