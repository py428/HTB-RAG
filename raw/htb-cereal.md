![Cereal](https://0xdfimages.gitlab.io/img/cereal-cover.webp)
...
[![Cereal](/icons/box-cereal.webp)](https://hackthebox.com/machines/cereal)

[Cereal](https://hackthebox.com/machines/cereal)
...
Rated Difficulty ![Rated difficulty for Cereal](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/cereal-diff.webp)

Radar Graph ![Radar chart for Cereal](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/cereal-radar.webp)

User

23:57:04 Root

1d 13:12:23 Creator ## Recon
...
![image-20210311163036686](https://0xdfimages.gitlab.io/img/image-20210311163036686.webp)
...
![image-20210311163350756](https://0xdfimages.gitlab.io/img/image-20210311163350756.webp)

Just guessing didn’t get in, and didn’t reveal information about which was wrong, username or password:

![image-20210311163427277](https://0xdfimages.gitlab.io/img/image-20210311163427277.webp)
...
![image-20210311164605003](https://0xdfimages.gitlab.io/img/image-20210311164605003.webp)
...
![image-20210311174325829](https://0xdfimages.gitlab.io/img/image-20210311174325829.webp)
...
![image-20210311165014305](https://0xdfimages.gitlab.io/img/image-20210311165014305.webp)
...
![image-20210311165536537](https://0xdfimages.gitlab.io/img/image-20210311165536537.webp)
...
But it’s much easier to use `gitdumper` from [GitTools](https://github.com/internetwache/GitTools). I’ve used this before on [Travel](about:/2020/09/12/htb-travel.html#automated-clone) and [Dyplesher](about:/2020/10/24/htb-dyplesher.html#get-git). After cloning the repo, I’ll give it the url and an output directory:
...
![image-20210311202229336](https://0xdfimages.gitlab.io/img/image-20210311202229336.webp)
...
![image-20210526210003118](https://0xdfimages.gitlab.io/img/image-20210526210003118.webp)
...
![image-20210526210054380](https://0xdfimages.gitlab.io/img/image-20210526210054380.webp)
...
![image-20210424061647159](https://0xdfimages.gitlab.io/img/image-20210424061647159.webp)
...
![image-20210424061849164](https://0xdfimages.gitlab.io/img/image-20210424061849164.webp)
...
![image-20210424142315300](https://0xdfimages.gitlab.io/img/image-20210424142315300.webp)
...
![image-20210425143524732](https://0xdfimages.gitlab.io/img/image-20210425143524732.webp)
...
![image-20210526213326981](https://0xdfimages.gitlab.io/img/image-20210526213326981.webp)
...
![image-20210427180233487](https://0xdfimages.gitlab.io/img/image-20210427180233487.webp)

And it runs commands:

![image-20210427192054343](https://0xdfimages.gitlab.io/img/image-20210427192054343.webp)
...
![image-20210427203554690](https://0xdfimages.gitlab.io/img/image-20210427203554690.webp)

Calling `type` on it dumps it out, much of which is binary garbage, but also the rest of which gives some clues:

![image-20210427203807825](https://0xdfimages.gitlab.io/img/image-20210427203807825.webp)
...
![image-20210428070756319](https://0xdfimages.gitlab.io/img/image-20210428070756319.webp)
...
![image-20210525160749074](https://0xdfimages.gitlab.io/img/image-20210525160749074.webp)
...
![image-20210525173627726](https://0xdfimages.gitlab.io/img/image-20210525173627726.webp)
...
![image-20210525174110193](https://0xdfimages.gitlab.io/img/image-20210525174110193.webp)
...
![image-20210527162525418](https://0xdfimages.gitlab.io/img/image-20210527162525418.webp)
...
![image-20210527163023098](https://0xdfimages.gitlab.io/img/image-20210527163023098.webp)
...
![image-20210525175219888](https://0xdfimages.gitlab.io/img/image-20210525175219888.webp)
...
![image-20210525175451099](https://0xdfimages.gitlab.io/img/image-20210525175451099.webp)

Then I’ll pick Build Solution from the Build menu, and it generates two binaries:

![image-20210525204046149](https://0xdfimages.gitlab.io/img/image-20210525204046149.webp)
...
![image-20210527145430876](https://0xdfimages.gitlab.io/img/image-20210527145430876.webp)
...
![image-20210527145530251](https://0xdfimages.gitlab.io/img/image-20210527145530251.webp)
```
