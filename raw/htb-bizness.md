![Bizness](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/bizness-cover.webp)
...
[![Bizness](/icons/box-bizness.webp)](https://hackthebox.com/machines/bizness)

[Bizness](https://hackthebox.com/machines/bizness)
...
Rated Difficulty ![Rated difficulty for Bizness](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/bizness-diff.webp)

Radar Graph ![Radar chart for Bizness](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/bizness-radar.webp)

User

00:01:46 Root

00:59:52 Creator ## Recon
...
The site is for some kind of business consultancy:
 ...
 ![image-20240520152508545](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520152508545.webp)![expand](/icons/expand.png)
...
![image-20240520152749265](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520152749265.webp)
...
![image-20240520153025698](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520153025698.webp)

This is Tomcat 9.0.82.

`/marketing/control` leads to an OFBiz error page:

![image-20240520154527972](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520154527972.webp)

`/marketing` redirects to `/marketing/control/main` which is a login page:

![image-20240520154556542](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520154556542.webp)

The tiny footer on this page gives the OFBiz version:

![image-20240521085027223](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240521085027223.webp)
...
![image-20240520154101157](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520154101157.webp)
...
>   
> Ref: [https://t.co/NSgI7IQckp](https://t.co/NSgI7IQckp)  
>   
...
I’ll grab a copy of Java 11 [from Oracle](https://www.oracle.com/java/technologies/javase/jdk11-archive-downloads.html) and install it, and use `update-alternatives` to set it as my active Java:
...
![image-20240520164610348](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520164610348.webp)

I’ll select “Derby Embedded” and give it the path to the folder:

![image-20240520164716383](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520164716383.webp)

Now it shows up on the left side:

![image-20240520210352925](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520210352925.webp)

I’ll add a filter for “user” and there’s the `USER_LOGIN` table:

![image-20240520164928264](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520164928264.webp)

Double clicking on it gives the schema in the Properties tab:

![image-20240520164955624](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520164955624.webp)

And the data in the Data tab:

![image-20240520165023493](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520165023493.webp)
...
![image-20240520165637871](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520165637871.webp)
...
![image-20240520170218467](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240520170218467.webp)
