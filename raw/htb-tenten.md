[HTB: Tenten](/2020/07/14/htb-tenten.html)

![Tenten](https://0xdfimages.gitlab.io/img/tenten-cover.webp)
...
[![Tenten](/icons/box-tenten.webp)](https://hackthebox.com/machines/tenten)

[Tenten](https://hackthebox.com/machines/tenten)
...
Rated Difficulty ![Rated difficulty for Tenten](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/tenten-diff.webp)

Radar Graph ![Radar chart for Tenten](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/tenten-radar.webp)

User

21d 03:51:56 Root

21d 03:51:42 Creator ## Recon
...
![image-20200713140940510](https://0xdfimages.gitlab.io/img/image-20200713140940510.webp)

There’s a comment on the post, but it looks like the sample WordPress comment:

![image-20200713141013629](https://0xdfimages.gitlab.io/img/image-20200713141013629.webp)
...
![image-20200713233059264](https://0xdfimages.gitlab.io/img/image-20200713233059264.webp)

Clicking Apply Now leads to a form, with a field to upload a resume:

![image-20200713233119231](https://0xdfimages.gitlab.io/img/image-20200713233119231.webp)
...
![image-20200714115350755](https://0xdfimages.gitlab.io/img/image-20200714115350755.webp)

If I change the `8` to a `1`, I get the title associated with the Hello World! post:

![image-20200714115312742](https://0xdfimages.gitlab.io/img/image-20200714115312742.webp)
...
![image-20200713152624679](https://0xdfimages.gitlab.io/img/image-20200713152624679.webp)
