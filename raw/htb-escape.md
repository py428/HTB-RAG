[HTB: Escape](/2023/06/17/htb-escape.html)

![Escape](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/escape-cover.webp)
...
[![Escape](/icons/box-escape.webp)](https://hackthebox.com/machines/escape)

[Escape](https://hackthebox.com/machines/escape)
...
Rated Difficulty ![Rated difficulty for Escape](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/escape-diff.webp)

Radar Graph ![Radar chart for Escape](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/escape-radar.webp)

User

00:14:14 Root

00:29:17 Creator ## Recon
...
The document is a little over a page with information about connecting to MSSQL:
 ...
 [![image-20230609163617386](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230609163617386.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230609163617386.png)
...
I can try to enabled it (as I showed [here in Scrambled’s Alternative Roots](about:/2022/10/01/htb-scrambled-beyond-root.html#get-execution-via-mssql)), but this account doesn’t have permission:
...
There’s no interesting data in the database and I can’t run commands. The next thing to try is to get the SQL server to connect back to my host and authenticate, and capture a challenge / response that I can try to brute force. I showed this for [Querier](about:/2019/06/22/htb-querier.html#database-privesc-reporter--mssql-svc) as well as in my [Getting Creds via NTLMv2](about:/2019/01/13/getting-net-ntlm-hases-from-windows.html#database-access) post.
...
With file read and write as administrator, I can turn that into execution as administrator. [This PayloadsAllTheThings page](https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Windows%20-%20Privilege%20Escalation.md#eop---privileged-file-write) shows various methods. I [showed the DiagHub method](about:/2019/07/06/htb-hackback.html#arbitrary-write--diaghub--system) in HackBack, though it has since been patched. I [showed the WerTrigger method](about:/2021/08/21/htb-proper.html#shell-via-wertrigger) in Proper, and I believe that one still works.
