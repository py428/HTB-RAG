[HTB: Admirer](/2020/09/26/htb-admirer.html)

![Admirer](https://0xdfimages.gitlab.io/img/admirer-cover.webp)
...
[![Admirer](/icons/box-admirer.webp)](https://hackthebox.com/machines/admirer)

[Admirer](https://hackthebox.com/machines/admirer)
...
Rated Difficulty ![Rated difficulty for Admirer](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/admirer-diff.webp)

Radar Graph ![Radar chart for Admirer](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/admirer-radar.webp)

User

00:57:47 Root

01:33:13 Creators   ## Recon
...
![image-20200504143521419](https://0xdfimages.gitlab.io/img/image-20200504143521419.webp)
...
![image-20200504143706686](https://0xdfimages.gitlab.io/img/image-20200504143706686.webp)
...
![image-20200504144115234](https://0xdfimages.gitlab.io/img/image-20200504144115234.webp)
...
- Trying to get execution via PHPInfo (like in [Nineveh](about:/2020/04/22/htb-nineveh.html#shell-as-www-data-via-phpinfophp)).
...
![image-20200504164955919](https://0xdfimages.gitlab.io/img/image-20200504164955919.webp)
...
Getting my local MySQL server setup so that Adminer could connect to it was a very similar process to what I did in [HTB: Kryptos](about:/2019/09/21/htb-kryptos.html#auth-bypass). I won’t go into quite as much detail, but it was very useful to use Wireshark to see more detailed messages as to why connections were failing.
...
![image-20200504210219358](https://0xdfimages.gitlab.io/img/image-20200504210219358.webp)

And I’m in:

![image-20200504210323918](https://0xdfimages.gitlab.io/img/image-20200504210323918.webp)

#### File Read

I tried to read `/etc/password` and other files in `/etc`, but only got an error:

![image-20200504210730692](https://0xdfimages.gitlab.io/img/image-20200504210730692.webp)

But when I asked for `/var/www/html/index.php`, it reads 123 rows:

![image-20200504210823350](https://0xdfimages.gitlab.io/img/image-20200504210823350.webp)
...
![image-20200925052845895](https://0xdfimages.gitlab.io/img/image-20200925052845895.webp)
