[HTB: Sightless](/2025/01/11/htb-sightless.html)

![Sightless](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sightless-cover.webp)
...
[![Sightless](/icons/box-sightless.webp)](https://hackthebox.com/machines/sightless)

[Sightless](https://hackthebox.com/machines/sightless)
...
Rated Difficulty ![Rated difficulty for Sightless](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sightless-diff.webp)

Radar Graph ![Radar chart for Sightless](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sightless-radar.webp)

User

00:13:07 Root

00:55:50 Creator ## Recon
...
The site is for a tech support firm:
 ...
 ![image-20240908153622200](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908153622200.webp)![expand](/icons/expand.png)
...
![image-20240908160955589](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908160955589.webp)
...
![image-20240908162714640](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908162714640.webp)
...
![image-20240908162917012](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908162917012.webp)

There are no connectiosn under “Manage connections”. Creating a new connection offers a huge list of DBs to choose from:

![image-20240908163123097](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908163123097.webp)
...
![image-20240908163250218](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908163250218.webp)
...
![image-20240908165423325](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908165423325.webp)

This provides a version (and a link to the GitHub for the project):

![image-20240908165450452](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908165450452.webp)

The project shows that it is written in JavaScript / TypeScript:

![image-20240908170943498](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908170943498.webp)
...
![image-20240908170640168](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908170640168.webp)
...
![image-20240908171103156](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908171103156.webp)
...
![image-20240908173020674](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908173020674.webp)
...
![image-20240908225634548](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908225634548.webp)
...
![image-20240908231857570](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908231857570.webp)
...
![image-20240909095510723](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240909095510723.webp)
...
![image-20240909181347605](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240909181347605.webp)

At Burp, I’ll paste the payload as the `loginname`:

![image-20240909190207566](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240909190207566.webp)
...
On logging in, there’s a dashboard:
 ...
 ![image-20240909210936134](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240909210936134.webp)![expand](/icons/expand.png)

Under Resources –> Admins, it shows the expected admin as well as my added admin:

![image-20240909212215198](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240909212215198.webp)

Under Resources –> Customers, there’s a single user:

![image-20240909212306859](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240909212306859.webp)

Clicking the Edit icon loads a form with a bunch of options for this user:

 ![image-20240909212407029](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240909212407029.webp)![expand](/icons/expand.png)
...
The new password does log into Froxlor as web1:
 ...
 ![image-20240909215657440](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240909215657440.webp)![expand](/icons/expand.png)

Under “FTP Accounts”, there’s one for web1:

![image-20240909215723711](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240909215723711.webp)
...
![image-20240908164152402](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908164152402.webp)
...
![image-20240908164430824](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240908164430824.webp)
...
![image-20240910142535567](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910142535567.webp)

When it I give it the correct port, two entities show up under Remote Target:

![image-20240910142555107](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910142555107.webp)

#### Capturing Password

Clicking “inspect” for the first row launches a window showing the activity in dev tools, similar to what I showed for the intended path on [Agile](about:/2023/08/05/htb-agile.html#chrome-debug):

![image-20240910142753112](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910142753112.webp)

At some point the bot will log in:

![image-20240910142839889](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910142839889.webp)

Showing the log page where the XSS would occur:

![image-20240910142855090](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910142855090.webp)
...
![image-20240910143044087](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910143044087.webp)
...
![image-20240910143213202](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910143213202.webp)

The payload tab gives the username and password:

![image-20240910143230096](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910143230096.webp)

#### Login

Those creds work to get into Froxlor:

 ![image-20240910143846812](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910143846812.webp)![expand](/icons/expand.png)
...
![image-20240910144022645](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910144022645.webp)

Clicking edit brings up:

 ![image-20240910152020506](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910152020506.webp)![expand](/icons/expand.png)
...
![image-20240910144346693](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910144346693.webp)
...
![image-20240910152111423](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910152111423.webp)

Under System –> Settings, there’s an option for PHP-FPM:

![image-20240910145140313](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910145140313.webp)

At the top of this page is a toggle to disable it, which I’ll switch to off, and save:

![image-20240910145227273](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240910145227273.webp)
