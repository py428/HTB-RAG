[HTB: Tentacle](/2021/06/19/htb-tentacle.html)

![Tentacle](https://0xdfimages.gitlab.io/img/tentacle-cover.webp)
...
[![Tentacle](/icons/box-tentacle.webp)](https://hackthebox.com/machines/tentacle)

[Tentacle](https://hackthebox.com/machines/tentacle)
...
Rated Difficulty ![Rated difficulty for Tentacle](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/tentacle-diff.webp)

Radar Graph ![Radar chart for Tentacle](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/tentacle-radar.webp)

User

14:51:41 Root

16:35:51 Creator ## Recon
...
![image-20210606064725593](https://0xdfimages.gitlab.io/img/image-20210606064725593.webp)
...
I attempted to set up the Squid in FoxyProxy the way I did in [Unbalanced](about:/2020/12/05/htb-unbalanced.html#squid---tcp-3128) and [Joker](about:/2020/08/13/htb-joker.html#enumeration-through-proxy). For some reason, on trying to request `http://10.10.10.224`, Firefox would just hang. Looking at the stream in Wireshark, first Firefox issues a `CONNECT` request:
...
![image-20210606110713223](https://0xdfimages.gitlab.io/img/image-20210606110713223.webp)
...
```
![image-20210606110849958](https://0xdfimages.gitlab.io/img/image-20210606110849958.webp)
...
WARNING: Your password may be exposed if you enter it here and are logged 
         in remotely using an insecure (non-encrypted) channel. 
...
![](https://0xdfimages.gitlab.io/img/tentacle-keytab1.webp)
...
![](https://0xdfimages.gitlab.io/img/tentacle-keytab2-1623955871273.webp)
...
![image-20210617145338860](https://0xdfimages.gitlab.io/img/image-20210617145338860.webp)
...
![](https://0xdfimages.gitlab.io/img/tentacle-keytab4.webp)
