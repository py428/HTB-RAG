[HTB: Absolute](/2023/05/27/htb-absolute.html)

![Absolute](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/absolute-cover.webp)
...
[![Absolute](/icons/box-absolute.webp)](https://hackthebox.com/machines/absolute)

[Absolute](https://hackthebox.com/machines/absolute)
...
Rated Difficulty ![Rated difficulty for Absolute](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/absolute-diff.webp)

Radar Graph ![Radar chart for Absolute](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/absolute-radar.webp)

User

03:17:54 Root

1d 01:04:22 Creator ## Recon
...
![image-20230521125137159](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230521125137159.webp)
...
![image-20230521125805708](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230521125805708.webp)
...
Alternatively, `crackmapexec` can also handle this check (shown with a smaller username list to demonstrate the difference):
 ...
 [![image-20230522132556877](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522132556877.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522132556877.png)
...
![image-20230522153157773](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522153157773.webp)

Unfortunately, this user has no local admin rights, no execution rights, and no outbound object control rights of interest:

![image-20230522153310358](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522153310358.webp)
...
![image-20230522153411507](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522153411507.webp)
...
![image-20230522154143073](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522154143073.webp)
...
I’ll update my `hosts` file to include `_ldap._tcp.dc.absolute.htb`, and re-run the program. After 25-30 seconds after execution, there’s an attempt to bind to LDAP on Absolute:
 ...
 [![image-20230522154437465](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522154437465.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522154437465.png)

Following that stream, it looks like there may be creds in there:

![image-20230522154514432](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522154514432.webp)
...
![image-20230522154622698](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522154622698.webp)
...
![image-20230522155353341](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522155353341.webp)

m.lovegod is a member of three groups, but not Network Audit:

![image-20230522155511238](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522155511238.webp)

winrm\_user is a member of Remote Management Users, which means that they can connect to WinRM and get a shell:

![image-20230522155706485](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522155706485.webp)
...
![image-20230522164623610](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230522164623610.webp)

To get this attack to work, I had to configure Absolute’s IP as a DNS server for my VPN interface:

![image-20230523132312087](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230523132312087.webp)
...
> This MS patch also effects krbrelay. It looks like we had our fun with rpc->ldap [https://t.co/lAWJltswBg](https://t.co/lAWJltswBg)
> 
...
![image-20230523164307773](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230523164307773.webp)
...
![image-20230526063508856](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230526063508856.webp)
...
![image-20230526064424415](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230526064424415.webp)
