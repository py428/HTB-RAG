[HTB: DevVortex](/2024/04/27/htb-devvortex.html)

![DevVortex](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/devvortex-cover.webp)
...
[![DevVortex](/icons/box-devvortex.webp)](https://hackthebox.com/machines/devvortex)

[DevVortex](https://hackthebox.com/machines/devvortex)
...
Rated Difficulty ![Rated difficulty for DevVortex](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/devvortex-diff.webp)

Radar Graph ![Radar chart for DevVortex](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/devvortex-radar.webp)

User

00:18:02 Root

00:20:46 Creator ## Recon
...
The website is for a web design / development company:
 ...
 ![image-20240422182959553](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240422182959553.webp)![expand](/icons/expand.png)
...
![image-20240422183808342](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240422183808342.webp)
...
The dev site is different from the main one:
 ...
 ![image-20240422184549565](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240422184549565.webp)![expand](/icons/expand.png)
...
![image-20240422185203347](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240422185203347.webp)
...
![enter image description here](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/devvortex-o8gvv.webp)

And another example [on Black Hills Web Works](https://blackhillswebworks.com/2010/02/20/creating-a-custom-joomla-404-error-page/):

![Joomla 404 page](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/devvortex-Joomla-404-page.webp)

Joomla’s admin page is at `/administrator/`, which does load a Joomla login form:

![image-20240422190101646](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240422190101646.webp)
...
![image-20240422190257177](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240422190257177.webp)
...
![image-20240422204744227](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240422204744227.webp)
...
![image-20240422210020126](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240422210020126.webp)
...
![image-20240425124714709](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240425124714709.webp)
...
![image-20240423072754211](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423072754211.webp)

lewis is an admin user on the site.

The `config/application` endpoint has the MySQL DB connection information:

![image-20240423073013422](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423073013422.webp)
...
It seems that lewis does share the same password for the DB connection and their account on Joomla, as going to `/administrator` and login in works:
 ...
 ![image-20240423073352494](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423073352494.webp)![expand](/icons/expand.png)
...
The System option on the left admin panel side bar will open the System Dashboard:
 ...
 ![image-20240423080805631](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423080805631.webp)![expand](/icons/expand.png)

I’ll click on “Site Templates” to open the templates page:

![image-20240423080843237](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423080843237.webp)

Clicking on the template “Cassoiopeia Details and Files” opens the editor for that template:

![image-20240423081306430](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423081306430.webp)
...
![image-20240423081658584](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423081658584.webp)

To start, I’ll just add a simple `meta` tag to make sure it shows up:

![image-20240423081745916](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423081745916.webp)

But on clicking save, the following error comes up:

![image-20240423081818197](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423081818197.webp)
...
![image-20240423082122071](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423082122071.webp)
...
![image-20240423082252028](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423082252028.webp)

Visiting a page that doesn’t exist (like `/0xdf`) raises an error page:

![image-20240423082319686](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423082319686.webp)

At the top of the source is the `echo` output:

![image-20240423082427377](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423082427377.webp)

#### Webshell

I’ll add the following PHP code to the top of `error.php`:

![image-20240423082539183](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423082539183.webp)

If the argument `0xdf` is passed, run it with `system` and stop, and otherwise do the page as normal. It works:

![image-20240423082619177](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423082619177.webp)
...
![](https://www.youtube.com/watch?v=sdF8YSPHql4)

At the end, I have a webshell:

![image-20240423150735374](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423150735374.webp)
...
This is very similar to the vulnerability I exploited in [Sau](about:/2024/01/06/htb-sau.html#exploit-less) where `systemctl` opened in `less` and I could break out.
...
![image-20240423170454738](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240423170454738.webp)
