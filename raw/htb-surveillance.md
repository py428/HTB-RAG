[HTB: Surveillance](/2024/04/20/htb-surveillance.html)

![Surveillance](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/surveillance-cover.webp)
...
[![Surveillance](/icons/box-surveillance.webp)](https://hackthebox.com/machines/surveillance)

[Surveillance](https://hackthebox.com/machines/surveillance)
...
Rated Difficulty ![Rated difficulty for Surveillance](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/surveillance-diff.webp)

Radar Graph ![Radar chart for Surveillance](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/surveillance-radar.webp)

User

00:12:56 Root

01:22:30 Creators   ## Recon
...
The site is for a home security company:
 ...
 ![image-20240417145155685](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240417145155685.webp)![expand](/icons/expand.png)
...
![image-20240417153353872](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240417153353872.webp)
...
![image-20240417173056794](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240417173056794.webp)
...
![surveillance-MicrosoftTeams-image](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/surveillance-MicrosoftTeams-image-1713435488195-3.webp)
...
![image-20240418063027165](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240418063027165.webp)
...
- l use the same `vid` trick as in [Intentions](about:/2023/10/14/htb-intentions.html#arbitrary-object-instantiation) to reference the MSL file using a wildcard:
```
POST /index.php HTTP/1.1
Host: surveillance.htb
User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:124.0) Gecko/20100101 Firefox/124.0
...
![image-20240418101456469](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240418101456469.webp)
...
![image-20240418101544477](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240418101544477.webp)
...
![image-20240418101739697](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240418101739697.webp)
...
![image-20240418161553529](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240418161553529.webp)
...
![image-20240418161857080](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240418161857080.webp)
...
![image-20240418172641645](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240418172641645.webp)

About half way down is one that seems interesting:

![image-20240418172700693](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240418172700693.webp)

Clicking the “?” generates this pop-up:

![image-20240418172718397](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240418172718397.webp)

#### Generate Shared Library

I’ll create the following short C program (just like in [Clicker](about:/2024/01/27/htb-clicker.html#method-3-via-ld_preload)):
