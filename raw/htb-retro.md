[HTB: Retro](/2025/06/24/htb-retro.html)

![Retro](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/retro-cover.webp)
...
[![Retro](/icons/box-retro.webp)](https://hackthebox.com/machines/retro)

[Retro](https://hackthebox.com/machines/retro)
...
The box shows many of the ports associated with a [Windows Domain Controller](about:/cheatsheets/os#windows-domain-controller). The domain is `retro.vl`, and the hostname is `DC`.
...
I noted the extra computer in the domain above, and it’s named BANKING$, which matches with the note. Combining that with the hint in the note of ancient reminds of Pre-Windows 2000 computers. I exploited this in [Vintage](about:/2025/04/26/htb-vintage.html#analysis), and there’s a nice [TrustedSec post](https://trustedsec.com/blog/diving-into-pre-created-computer-accounts) as well. These computer accounts use their hostname, all lowercase, as their password.
