[HTB: Doctor](/2021/02/06/htb-doctor.html)

![Doctor](https://0xdfimages.gitlab.io/img/doctor-cover.webp)
...
[![Doctor](/icons/box-doctor.webp)](https://hackthebox.com/machines/doctor)

[Doctor](https://hackthebox.com/machines/doctor)
...
Rated Difficulty ![Rated difficulty for Doctor](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/doctor-diff.webp)

Radar Graph ![Radar chart for Doctor](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/doctor-radar.webp)

User

00:36:05 Root

00:36:12 Creator ## Recon
...
![image-20201031152834778](https://0xdfimages.gitlab.io/img/image-20201031152834778.webp)
...
![image-20201031153416538](https://0xdfimages.gitlab.io/img/image-20201031153416538.webp)
...
![image-20201031153543167](https://0xdfimages.gitlab.io/img/image-20201031153543167.webp)

Once I log in, it presents a relatively empty page:

![image-20201101045903292](https://0xdfimages.gitlab.io/img/image-20201101045903292.webp)
...
![image-20201101050043569](https://0xdfimages.gitlab.io/img/image-20201101050043569.webp)
...
![img](https://0xdfimages.gitlab.io/img/doctor-serverside.webp)

So I submitted the first test with injection attempts in both the title and the message:

![image-20201101054424798](https://0xdfimages.gitlab.io/img/image-20201101054424798.webp)

I don’t see any injections when the post is displayed back:

![image-20201101054457363](https://0xdfimages.gitlab.io/img/image-20201101054457363.webp)

The next test failed too:

![image-20201101054536447](https://0xdfimages.gitlab.io/img/image-20201101054536447.webp)
...
Whenever I have a form that displays back to my on the page, it’s good to check for user interaction (like in [SecNotes](about:/2019/01/19/htb-secnotes.html#get-tylers-credentials)) and/or cross site scripting (XSS). I created two links, and put a script box in the body:

![image-20201101100239532](https://0xdfimages.gitlab.io/img/image-20201101100239532.webp)

I started a Python webserver, and on hitting submit, the post was created:

![image-20201101100337162](https://0xdfimages.gitlab.io/img/image-20201101100337162.webp)
...
![image-20201101100729739](https://0xdfimages.gitlab.io/img/image-20201101100729739.webp)
...
![image-20201108113043144](https://0xdfimages.gitlab.io/img/image-20201108113043144.webp)
...
def home():
        ...
        return render_template('home.html', posts=posts, =current_user)
...
def new_post():
    ...
    if form.validate_on_submit():
        post = Post(title=form.title.data, content=form.content.data, =current_user)
        db.session.add(post)
        db.session.commit()
