[HTB: Paper](/2022/06/18/htb-paper.html)

![Paper](https://0xdfimages.gitlab.io/img/paper-cover.webp)
...
[![Paper](/icons/box-paper.webp)](https://hackthebox.com/machines/paper)

[Paper](https://hackthebox.com/machines/paper)
...
Rated Difficulty ![Rated difficulty for Paper](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/paper-diff.webp)

Radar Graph ![Radar chart for Paper](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/paper-radar.webp)

User

00:23:52 Root

00:29:19 Creator ## Recon
...
![image-20220605113359028](https://0xdfimages.gitlab.io/img/image-20220605113359028.webp)
...
![image-20220605113813775](https://0xdfimages.gitlab.io/img/image-20220605113813775.webp)
...
![image-20220605124740432](https://0xdfimages.gitlab.io/img/image-20220605124740432.webp)
...
![image-20220605125451674](https://0xdfimages.gitlab.io/img/image-20220605125451674.webp)
...
![image-20220605125626426](https://0xdfimages.gitlab.io/img/image-20220605125626426.webp)

The next page asks me to pick a username:

![image-20220605125644551](https://0xdfimages.gitlab.io/img/image-20220605125644551.webp)

And on clicking “Use this username” I’m in the chat:

![image-20220605125734188](https://0xdfimages.gitlab.io/img/image-20220605125734188.webp)
...
![image-20220605130816342](https://0xdfimages.gitlab.io/img/image-20220605130816342.webp)
...
![image-20220605131142761](https://0xdfimages.gitlab.io/img/image-20220605131142761.webp)
...
![image-20220605131251132](https://0xdfimages.gitlab.io/img/image-20220605131251132.webp)

This command is vulnerable to directory traversal:

![image-20220605131501215](https://0xdfimages.gitlab.io/img/image-20220605131501215.webp)

It seems hardened against command injection:

![image-20220605131538877](https://0xdfimages.gitlab.io/img/image-20220605131538877.webp)

#### Read Files

The bot can show file content:

![image-20220605133028301](https://0xdfimages.gitlab.io/img/image-20220605133028301.webp)

The directory traversal vulnerability is present in this command as well. `file ../../../etc/passwd` shows the contents of that file:

![image-20220605132938566](https://0xdfimages.gitlab.io/img/image-20220605132938566.webp)
...
![image-20220605133200037](https://0xdfimages.gitlab.io/img/image-20220605133200037.webp)

The `.env` file is immediately interesting, as those files tend to hold secrets for the project:

![image-20220605133232357](https://0xdfimages.gitlab.io/img/image-20220605133232357.webp)
