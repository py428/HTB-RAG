![PivotAPI](https://0xdfimages.gitlab.io/img/pivotapi-cover.webp)
...
[![PivotAPI](/icons/box-pivotapi.webp)](https://hackthebox.com/machines/pivotapi)

[PivotAPI](https://hackthebox.com/machines/pivotapi)
...
Rated Difficulty ![Rated difficulty for PivotAPI](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/pivotapi-diff.webp)

Radar Graph ![Radar chart for PivotAPI](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/pivotapi-radar.webp)

User

02:00:14 Root

02:19:56 Creators   ## Recon
...
![image-20210212163342131](https://0xdfimages.gitlab.io/img/image-20210212163342131.webp)

I didn’t see much useful here at this point. The domain has 26 users (Usuarios Del Dominio = Domain Users):

![image-20210429164955203](https://0xdfimages.gitlab.io/img/image-20210429164955203.webp)
...
![image-20210212105835607](https://0xdfimages.gitlab.io/img/image-20210212105835607.webp)

#### Email Contents

“Server MSSQL” talks about the migration from Oracle to MSSQL at the start of 2020:

> Date: Sun, 09 Aug 2020 11:04:14 +0000 To: “cybervaca@licordebellota.htb” <cybervaca@licordebellota.htb> Subject: Server MSSQL
> 
> Good afternoon,
> 
...
> Date: Sun, 09 Aug 2020 11:42:20 +0000 To: “helpdesk@licordebellota.htb” <helpdesk@licordebellota.htb> Subject: WinRM Service
> 
> Good afternoon.
> 
...
![image-20210212124906614](https://0xdfimages.gitlab.io/img/image-20210212124906614.webp)
...
![image-20210212125833689](https://0xdfimages.gitlab.io/img/image-20210212125833689.webp)
...
![image-20210212161009304](https://0xdfimages.gitlab.io/img/image-20210212161009304.webp)
...
![image-20210716091719264](https://0xdfimages.gitlab.io/img/image-20210716091719264.webp)
...
I like to use the `kpcli` to enumerate a KeePass DB (like I’ve shown previously in [Safe](about:/2019/10/26/htb-safe.html#explore-db), `sudo apt install kpcli`).
...
![image-20210429173620450](https://0xdfimages.gitlab.io/img/image-20210429173620450.webp)
...
![image-20210217181217086](https://0xdfimages.gitlab.io/img/image-20210217181217086.webp)

On hitting play, there’s a clear path:

![image-20210429173507087](https://0xdfimages.gitlab.io/img/image-20210429173507087.webp)

### Change Dr.Zaiuss’s Password

I’ll clone [https://github.com/PowerShellMafia/PowerSploit](https://github.com/PowerShellMafia/PowerSploit) and checkout the dev branch.
...
![image-20210218085229181](https://0xdfimages.gitlab.io/img/image-20210218085229181.webp)
...
![image-20210218090139395](https://0xdfimages.gitlab.io/img/image-20210218090139395.webp)
...
![image-20210218090224391](https://0xdfimages.gitlab.io/img/image-20210218090224391.webp)
...
![image-20210429174405632](https://0xdfimages.gitlab.io/img/image-20210429174405632.webp)

That is `ForceChangePassword` permissions on Gibeon and Stoormq:

![image-20210429174428335](https://0xdfimages.gitlab.io/img/image-20210429174428335.webp)
...
![image-20210426121335088](https://0xdfimages.gitlab.io/img/image-20210426121335088.webp)
