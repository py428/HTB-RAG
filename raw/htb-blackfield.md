[HTB: Blackfield](/2020/10/03/htb-blackfield.html)

![Blackfield](https://0xdfimages.gitlab.io/img/blackfield-cover.webp)
...
[![Blackfield](/icons/box-blackfield.webp)](https://hackthebox.com/machines/blackfield)

[Blackfield](https://hackthebox.com/machines/blackfield)
...
Rated Difficulty ![Rated difficulty for Blackfield](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/blackfield-diff.webp)

Radar Graph ![Radar chart for Blackfield](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/blackfield-radar.webp)

User

00:31:13 Root

00:59:23 Creator ## Recon
...
![image-20200608170323022](https://0xdfimages.gitlab.io/img/image-20200608170323022.webp)

When I click the “1”, I can see that support has “ForceChangePassword” on AUDIT2020:

![image-20200608170401907](https://0xdfimages.gitlab.io/img/image-20200608170401907.webp)
...
`SeBackUpPrivilege` basically allows for full system read. I showed this two weeks ago in [Multimaster](about:/2020/09/19/htb-multimaster.html#read-as-system). This is because svc\_backup is in the Backup Operators group:
...
It turns out to be [encrypted file system](https://en.wikipedia.org/wiki/Encrypting_File_System) (EFS). I used EFS on all the flags and files of interest in [RE](about:/2020/02/01/htb-re.html#read-roottxt-as-system), largely because if there was an unintended path that led to system (which there turned out to be), I wanted to make it as hard as possible. Typically I’d run `cipher /c [file]` to see if the file is encrypted and who can decrypt it:
