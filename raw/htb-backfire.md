[HTB: Backfire](/2025/06/07/htb-backfire.html)

![Backfire](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/backfire-cover.webp)
...
[![Backfire](/icons/box-backfire.webp)](https://hackthebox.com/machines/backfire)

[Backfire](https://hackthebox.com/machines/backfire)
...
Rated Difficulty ![Rated difficulty for Backfire](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/backfire-diff.webp)

Radar Graph ![Radar chart for Backfire](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/backfire-radar.webp)

User

01:14:50 Root

02:35:22 Creators   ## Recon
...
Based on the [OpenSSH and nginx versions](about:/cheatsheets/os#debian), the host is likely running Debian 12 bookworm. There’s no sign of host-based routing or any kind of domain name, so I’ll proceed by targeting the IP.

### Website - TCP 443

#### Site

Visiting `https://10.10.11.49/` returns the [default nginx 404](about:/cheatsheets/404#nginx):

![image-20250124133226450](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124133226450.webp)
...
![image-20250124133509255](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124133509255.webp)
...
![image-20250124133821473](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124133821473.webp)
...
![image-20250124134532894](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124134532894.webp)
...
![image-20250124150846210](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124150846210.webp)
...
I’ll run this with a simple `ping` command to see if it works, using the creds from the [config above](about:/2025/06/07/htb-backfire.html#http---tcp-8000):
...
[Hardhat C2](https://github.com/DragoQCC/HardHatC2) is an open source C# C2 framework. The note from ilya says that sergej didn’t change anything. The default config file is located [on GitHub](https://github.com/DragoQCC/HardHatC2/blob/74a86e6680309c7e192826a7ceff6642501e81a7/TeamServer/appsettings.json):
...
![image-20250124162105885](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124162105885.webp)

Logging in as this user, there’s a ton more functionality, including a terminal:

![image-20250124162317629](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124162317629.webp)
...
![image-20250124162430127](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124162430127.webp)
...
![image-20250124162551833](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124162551833.webp)
...
![image-20250124162826075](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124162826075.webp)

I’ll create a user with Team Lead role and log in. At the terminal, I’ll see the hostname:

![image-20250124163007485](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124163007485.webp)

I’ll issue a [bash reverse shell](https://www.youtube.com/watch?v=OjkVep2EIlw):

![image-20250124163052440](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250124163052440.webp)
