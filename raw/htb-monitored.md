[HTB: Monitored](/2024/05/11/htb-monitored.html)

![Monitored](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/monitored-cover.webp)
...
[![Monitored](/icons/box-monitored.webp)](https://hackthebox.com/machines/monitored)

[Monitored](https://hackthebox.com/machines/monitored)
...
Rated Difficulty ![Rated difficulty for Monitored](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/monitored-diff.webp)

Radar Graph ![Radar chart for Monitored](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/monitored-radar.webp)

User

02:26:35 Root

03:10:33 Creators   ## Recon
...
![image-20240508155916679](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508155916679.webp)

The “Access Nagios XI” leads to a login page at `/nagiosxi/login.php`:

![image-20240508161546921](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508161546921.webp)
...
![image-20240508164304849](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508164304849.webp)

It’s interesting, as if I put in svc and a different password, the error message is different:

![image-20240508164340230](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508164340230.webp)

Same if I do another username:

![image-20240508164357872](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508164357872.webp)
...
![image-20240508171454083](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508171454083.webp)
...
![image-20240508172535777](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508172535777.webp)

If I try `/nagiosxi/api/`, it returns 403:

![image-20240508172659938](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508172659938.webp)

If I try `/nagiosxi/0xdf`, it returns 404:

![image-20240508172855638](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508172855638.webp)
...
![image-20240508185409410](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508185409410.webp)

Simple enough, I’ll switch the verb to POST:

![image-20240508185434977](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508185434977.webp)

It wants a username and password. I’ll try those as parameters:

![image-20240508185530931](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508185530931.webp)
...
![image-20240508190358226](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508190358226.webp)

#### More Research

To figure out how to use the token provided by the `authenticate` endpoint, I’ll search for it:

![image-20240508190512477](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508190512477.webp)
...
![image-20240508190642836](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508190642836.webp)
...
![image-20240508191024423](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508191024423.webp)

If I try the endpoint in the forum post, it seems to work:

![image-20240508191149371](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508191149371.webp)
...
![image-20240508191550659](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508191550659.webp)
...
![image-20240508192552019](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508192552019.webp)

Going to the account settings, I’ll find the API key for the svc user:

![image-20240508192645539](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508192645539.webp)
...
![image-20240508193124753](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508193124753.webp)
...
![image-20240508194342678](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508194342678.webp)

That seems to be working. I’ll try an SQL injection:

![image-20240508194415753](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240508194415753.webp)
...
![image-20240509071411173](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509071411173.webp)
...
![image-20240509073545924](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509073545924.webp)

This exploit won’t work here, but it does show using this endpoint with the following data:

![image-20240509073619286](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509073619286.webp)
...
![image-20240509074140835](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509074140835.webp)
...
![image-20240509073926283](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509073926283.webp)

Once I check and submit, I’m in as an admin user:

![image-20240509120702308](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509120702308.webp)
...
![image-20240509074927207](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509074927207.webp)

I’ll click on “Commands”:

 [![image-20240509074948845](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509074948845.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509074948845.png)
...
![image-20240509075120460](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509075120460.webp)

There’s nothing really to run the command here. Back on the Core Config page, I’ll go to “Hosts”:

![image-20240509075336368](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509075336368.webp)

Clicking on localhost brings up it’s page:

![image-20240509075409450](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509075409450.webp)

There’s a “Check command” dropdown, which I’ll set to “0xdf shell”, and now a “Run Check Command” button appears:

![image-20240509075503583](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240509075503583.webp)
