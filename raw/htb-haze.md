[HTB: Haze](/2025/06/28/htb-haze.html)

![Haze](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/haze-cover.webp)
...
[![Haze](/icons/box-haze.webp)](https://hackthebox.com/machines/haze)

[Haze](https://hackthebox.com/machines/haze)
...
Rated Difficulty ![Rated difficulty for Haze](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/haze-diff.webp)

Radar Graph ![Radar chart for Haze](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/haze-radar.webp)

User

02:02:08 Root

02:47:01 Creator ## Recon
...
The box shows many of the ports associated with a [Windows Domain Controller](about:/cheatsheets/os#windows-domain-controller). The domain is `haze.htb`, and the hostname is `dc01`.
...
![image-20250623134355318](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250623134355318.webp)
...
![image-20250623181537355](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250623181537355.webp)

That looks exactly like the [default Apache 404 page](about:/cheatsheets/404#apache--httpd) with `ServerSignature Off` configured.

#### Splunk API - TCP 8089

Visiting port 8089 shows the “Splunk Atom Feed”:

![image-20250623181700881](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250623181700881.webp)
...
![image-20250623202623231](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250623202623231.webp)
...
![image-20250623211506235](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250623211506235.webp)
...
![image-20250624103607374](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624103607374.webp)
...
I’ll install the tool using `uv` as shown in the `README` ([uv cheatsheet](about:/cheatsheets/uv#)), and run it, passing the secret file and the encrypted data:
...
![image-20250624111856433](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624111856433.webp)
...
![image-20250624114146278](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624114146278.webp)
...
![image-20250624114832838](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624114832838.webp)

I’ll look at mark.adams’ groups, and there are more than paul.taylor:

![image-20250624114909855](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624114909855.webp)
...
![image-20250624124133312](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624124133312.webp)
...
![image-20250624133227572](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624133227572.webp)
...
![image-20250624142317391](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624142317391.webp)
...
![image-20250624165020517](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624165020517.webp)
...
The password does work to log into the website as the admin user:
 ...
 ![image-20250624162041984](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624162041984.webp)![expand](/icons/expand.png)

This account has admin role, as can be seen under Settings > Users:

 [![image-20250624165239758](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624165239758.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624165239758.png)
...
![image-20250624170929265](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250624170929265.webp)
