...
![TwoMillion](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/twomillion-cover.webp)
...
[![TwoMillion](/icons/box-twomillion.webp)](https://hackthebox.com/machines/twomillion)

[TwoMillion](https://hackthebox.com/machines/twomillion)
...
[![image-20230602171207436](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602171207436.png)](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602171207436.png)

[*Click for full image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602171207436.png)
...
![image-20230602171248402](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602171248402.webp)

I don’t have creds yet, so nothing here. The forgot password link doesn’t go anywhere.

The “Join” section has a link to `/invite`:

![image-20230602171346375](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602171346375.webp)

This page asks for an invite code, with a message that says “Feel free to hack your way in:)”:

![image-20230606145819478](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230606145819478.webp)
...
![image-20230602171611359](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602171611359.webp)
...
![image-20230602172032579](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602172032579.webp)
...
![image-20230602173705797](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602173705797.webp)

The JavaScript is packed / minified, but at the bottom there’s two interesting strings:

![image-20230602174354605](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602174354605.webp)

Back on `/invite` (where this code is loaded), I’ll open the browser dev tools, and start typing “make” at the console:

![image-20230602174516201](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602174516201.webp)

It autocompletes that function as `makeInviteCode`. I’ll run it:

![image-20230602174549106](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602174549106.webp)
...
![image-20230602174803269](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602174803269.webp)
...
![image-20230602175237864](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602175237864.webp)

When I put that into the form on `/invite`, it redirects to `/register` with the code filled out:

![image-20230602180134413](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602180134413.webp)
...
[![image-20230602180451178](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602180451178.png)](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602180451178.png)

[*Click for full image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602180451178.png)
...
[![image-20230602180615851](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602180615851.png)](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602180615851.png)

[*Click for full image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602180615851.png)
...
![image-20230602181111143](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602181111143.webp)
...
![image-20230602181807231](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602181807231.webp)

If I try to POST to `/api/v1/admin/vpn/generate`, it returns 401 Unauthorized:

![image-20230602181939091](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602181939091.webp)

However, a PUT request to `/api/v1/admin/settings/update` doesn’t return 401, but 200, with a different error in the body:

![image-20230602182052397](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602182052397.webp)
...
![image-20230602182213019](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602182213019.webp)

Now it says email is missing. I’ll add that in the body in JSON:

![image-20230602182248469](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602182248469.webp)

Now it wants `is_admin`, so I’ll add that as `true`:

![image-20230602182332129](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602182332129.webp)

It’s looking for 0 or 1. I’ll set it to 1, and it seems to work:

![image-20230602182418615](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602182418615.webp)

If I try the verification again, it says true!

![image-20230602182448977](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602182448977.webp)
...
![image-20230603130348431](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230603130348431.webp)

I’ll add my username, and it generates a VPN key:

![image-20230603130429280](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230603130429280.webp)
...
![image-20230603130843584](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230603130843584.webp)
...
![image-20230603131015532](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230603131015532.webp)
...
![image-20230602185030063](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602185030063.webp)
...
![image-20230602185832675](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602185832675.webp)
...
![image-20230602190651754](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230602190651754.webp)
...
![image-20230606151823025](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230606151823025.webp)
...
![image-20230606151941815](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230606151941815.webp)
...
![image-20230606152116439](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230606152116439.webp)
...
![](https://www.youtube.com/watch?v=es99eG_VcaI)
