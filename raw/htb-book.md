[HTB: Book](/2020/07/11/htb-book.html)

![Book](https://0xdfimages.gitlab.io/img/book-cover.webp)
...
[![Book](/icons/box-book.webp)](https://hackthebox.com/machines/book)

[Book](https://hackthebox.com/machines/book)
...
Rated Difficulty ![Rated difficulty for Book](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/book-diff.webp)

Radar Graph ![Radar chart for Book](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/book-radar.webp)

User

03:55:38 Root

06:31:22 Creator ## Recon
...
![image-20200225110857515](https://0xdfimages.gitlab.io/img/image-20200225110857515.webp)

I can click the Sign Up button, and create an account:

![image-20200225110945917](https://0xdfimages.gitlab.io/img/image-20200225110945917.webp)

Then I can log in, and it’s a website for a library:

![image-20200225111026234](https://0xdfimages.gitlab.io/img/image-20200225111026234.webp)

The Books tab has a list of books:

![image-20200225111057627](https://0xdfimages.gitlab.io/img/image-20200225111057627.webp)
...
![image-20200225111333575](https://0xdfimages.gitlab.io/img/image-20200225111333575.webp)

Anything I submit results in a pop-up message:

![image-20200227215828506](https://0xdfimages.gitlab.io/img/image-20200227215828506.webp)
...
![image-20200225111617276](https://0xdfimages.gitlab.io/img/image-20200225111617276.webp)

It returns a pop-up and then redirects to the home page:

![image-20200225111639453](https://0xdfimages.gitlab.io/img/image-20200225111639453.webp)
...
![image-20200225111820880](https://0xdfimages.gitlab.io/img/image-20200225111820880.webp)

The credentials I created here don’t work, just returning a message box:

![image-20200225111842031](https://0xdfimages.gitlab.io/img/image-20200225111842031.webp)
...
If I try to create an account with email address `admin@book.htb`, the site returns a pop-up saying that the user exists:
 ...
 ![image-20200227201121873](https://0xdfimages.gitlab.io/img/image-20200227201121873.webp)![image-20200227201140583](https://0xdfimages.gitlab.io/img/image-20200227201140583.webp)
...
![image-20200227220103625](https://0xdfimages.gitlab.io/img/image-20200227220103625.webp)

`/admin/users.php` lists all the users:

![image-20200227220308758](https://0xdfimages.gitlab.io/img/image-20200227220308758.webp)

`/admin/messages.php` shows the messages:

![image-20200227220330382](https://0xdfimages.gitlab.io/img/image-20200227220330382.webp)

The `feedback.php` page has a table that’s empty:

![image-20200227220628005](https://0xdfimages.gitlab.io/img/image-20200227220628005.webp)
...
![image-20200227220742018](https://0xdfimages.gitlab.io/img/image-20200227220742018.webp)

The Collections tab has a link to PDFs for Users and Collections.

![image-20200227220846801](https://0xdfimages.gitlab.io/img/image-20200227220846801.webp)

The PDFs are just tables:

 ![image-20200227221025738](https://0xdfimages.gitlab.io/img/image-20200227221025738.webp)![image-20200227220954283](https://0xdfimages.gitlab.io/img/image-20200227220954283.webp)
...
![image-20200227221455887](https://0xdfimages.gitlab.io/img/image-20200227221455887.webp)
...
![image-20200227221912699](https://0xdfimages.gitlab.io/img/image-20200227221912699.webp)
...
![image-20200227222452326](https://0xdfimages.gitlab.io/img/image-20200227222452326.webp)
...
![image-20200227222709043](https://0xdfimages.gitlab.io/img/image-20200227222709043.webp)
