[HTB: Canape](/2018/09/15/htb-canape.html)
...
[![Canape](/icons/box-canape.webp)](https://hackthebox.com/machines/canape)

[Canape](https://hackthebox.com/machines/canape)
...
Rated Difficulty ![Rated difficulty for Canape](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/canape-diff.webp)

Radar Graph ![Radar chart for Canape](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/canape-radar.webp)

User

03:23:37 Root

03:47:38 Creator ## nmap
...
![Canape Web Root image](https://0xdfimages.gitlab.io/img/canape-web-root.png)

![Canape Web Quotes image](https://0xdfimages.gitlab.io/img/canape-web-quotes.png)

![Canape Web Submit image](https://0xdfimages.gitlab.io/img/canape-web-submit.png)

The “Submit A Quote” feature definitely seems like something we’ll want to look at.

### Exposed git Repo

But before playing with the site too much, I’ll check out the.git path identified in the nmap scripts: ![Canape Web Git image](https://0xdfimages.gitlab.io/img/canape-web-git.png)
...
CVE-2017-12635 is a way for non-authenticated users to get an admin access in couchdb by taking advantage of how Javascript and Erlang json parsers handle duplicate objects. Reading on CVE-2017-12635:
