[HTB: RedPanda](/2022/11/26/htb-redpanda.html)

![RedPanda](https://0xdfimages.gitlab.io/img/redpanda-cover.webp)
...
[![RedPanda](/icons/box-redpanda.webp)](https://hackthebox.com/machines/redpanda)

[RedPanda](https://hackthebox.com/machines/redpanda)
...
Rated Difficulty ![Rated difficulty for RedPanda](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/redpanda-diff.webp)

Radar Graph ![Radar chart for RedPanda](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/redpanda-radar.webp)

User

00:02:17 Root

00:46:14 Creator ## Recon
...
![image-20221121150814819](https://0xdfimages.gitlab.io/img/image-20221121150814819.webp)

Searching for a string like “0xdf” returns nothing:

![image-20221121150856968](https://0xdfimages.gitlab.io/img/image-20221121150856968.webp)

If I just search for “a” it finds four:

![image-20221121150929452](https://0xdfimages.gitlab.io/img/image-20221121150929452.webp)

Each panda has a picture, a name, a bio, and an author. The author is a link, which goes to an author’s page:

![image-20221121151044537](https://0xdfimages.gitlab.io/img/image-20221121151044537.webp)
...
![image-20221121152818540](https://0xdfimages.gitlab.io/img/image-20221121152818540.webp)

A quick Google shows this is associated with Spring Boot:

![image-20221121153020360](https://0xdfimages.gitlab.io/img/image-20221121153020360.webp)
...
![image-20221121155502494](https://0xdfimages.gitlab.io/img/image-20221121155502494.webp)
...
![image-20221121160306857](https://0xdfimages.gitlab.io/img/image-20221121160306857.webp)

The first and last will trigger the banned list, but I can try the others. For example `*{7*7}` works:

![image-20221121160417155](https://0xdfimages.gitlab.io/img/image-20221121160417155.webp)

`@{7*7}` return the same. `#{7*7}` also works, returning a bit more junk:

![image-20221121160444324](https://0xdfimages.gitlab.io/img/image-20221121160444324.webp)
...
![image-20221121160624067](https://0xdfimages.gitlab.io/img/image-20221121160624067.webp)
...
![image-20221121160855128](https://0xdfimages.gitlab.io/img/image-20221121160855128.webp)
...
![image-20221121161652572](https://0xdfimages.gitlab.io/img/image-20221121161652572.webp)

This seems to work. Next I’ll run it with `bash`:

![image-20221121161909384](https://0xdfimages.gitlab.io/img/image-20221121161909384.webp)
...
I’ll upgrade the shell using `script` and `stty` (explained [in this video](https://www.youtube.com/watch?v=DqE6DxqJg8Q)):
...
```java
if(.equals("woodenk") || .equals("damian"))
{
        String path = "/credits/" +  + "_creds.xml";
...
![image-20221122072139171](https://0xdfimages.gitlab.io/img/image-20221122072139171.webp)

#### XXE Payload

I’ll start with the downloaded `export.xml` from `/export.xml`, saving it as `0xdf_creds.xml`. I’ll add an XXE payload:

![image-20221122070855427](https://0xdfimages.gitlab.io/img/image-20221122070855427.webp)
...
![image-20221122085057394](https://0xdfimages.gitlab.io/img/image-20221122085057394.webp)
