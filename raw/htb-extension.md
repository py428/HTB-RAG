[HTB: Extension](/2023/03/18/htb-extension.html)

![Extension](https://0xdfimages.gitlab.io/img/extension-cover.webp)
...
[![Extension](/icons/box-extension.webp)](https://hackthebox.com/machines/extension)

[Extension](https://hackthebox.com/machines/extension)
...
Rated Difficulty ![Rated difficulty for Extension](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/extension-diff.webp)

Radar Graph ![Radar chart for Extension](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/extension-radar.webp)

User

14:35:13 Root

16:52:37 Creator ## Recon
...
![image-20220613152856259](https://0xdfimages.gitlab.io/img/image-20220613152856259.webp)
...
![image-20220613143119278](https://0xdfimages.gitlab.io/img/image-20220613143119278.webp)

The “Forgot your password?” link goes to `/forgot-password`, which asks for an email address:

![image-20220613143152791](https://0xdfimages.gitlab.io/img/image-20220613143152791.webp)

When I enter `0xdf@0xdf.htb` it tells me there’s no user with that email:

![image-20220622140405385](https://0xdfimages.gitlab.io/img/image-20220622140405385.webp)
...
![image-20220613143232094](https://0xdfimages.gitlab.io/img/image-20220613143232094.webp)

If I try to use an email that’s not `@snippet.htb`, it complains:

![image-20220613152709910](https://0xdfimages.gitlab.io/img/image-20220613152709910.webp)

If I switch the `snippet.htb`, it just says registration is closed:

![image-20220613152758381](https://0xdfimages.gitlab.io/img/image-20220613152758381.webp)
...
There’s two cookies set, but they don’t give away much about the environment. They do look a bit like the cookies that the PHP framework [Laravel](https://laravel.com/) sets, and it is configurable in Laravel to change `laravel_session` to something else, but nothing conclusive. For example, here’s the headers from [Altered](about:/2022/03/30/htb-altered.html#tech-stack):
...
![image-20220624131409460](https://0xdfimages.gitlab.io/img/image-20220624131409460.webp)
...
![image-20220615123321471](https://0xdfimages.gitlab.io/img/image-20220615123321471.webp)
...
![image-20220615124530481](https://0xdfimages.gitlab.io/img/image-20220615124530481.webp)
...
![image-20220615124705018](https://0xdfimages.gitlab.io/img/image-20220615124705018.webp)

It will change the rest to a POST. Forwarding that to the server, the response comes back 419:

![image-20220615124751742](https://0xdfimages.gitlab.io/img/image-20220615124751742.webp)
...
![image-20220615135446605](https://0xdfimages.gitlab.io/img/image-20220615135446605.webp)
...
![image-20220615141203603](https://0xdfimages.gitlab.io/img/image-20220615141203603.webp)

The “New Snippet” shows a form:

![image-20220615141456936](https://0xdfimages.gitlab.io/img/image-20220615141456936.webp)
...
![image-20220615205908973](https://0xdfimages.gitlab.io/img/image-20220615205908973.webp)

Clicking the public one from isaac goes to `/snippets/1` and shows some code:

![image-20220615141614229](https://0xdfimages.gitlab.io/img/image-20220615141614229.webp)
...
![image-20220615205744784](https://0xdfimages.gitlab.io/img/image-20220615205744784.webp)
...
![image-20220615210003194](https://0xdfimages.gitlab.io/img/image-20220615210003194.webp)
...
![image-20220615142650198](https://0xdfimages.gitlab.io/img/image-20220615142650198.webp)

All of the mailboxes seem to be empty.

I can reset one of the users’ passwords on the main site:

![image-20220615142726029](https://0xdfimages.gitlab.io/img/image-20220615142726029.webp)

And the email comes:

![image-20220615142744931](https://0xdfimages.gitlab.io/img/image-20220615142744931.webp)
...
![image-20220615155547395](https://0xdfimages.gitlab.io/img/image-20220615155547395.webp)
...
![image-20220615210631065](https://0xdfimages.gitlab.io/img/image-20220615210631065.webp)
...
![image-20220615211002391](https://0xdfimages.gitlab.io/img/image-20220615211002391.webp)
...
![image-20220616082952429](https://0xdfimages.gitlab.io/img/image-20220616082952429.webp)
...
![image-20220624141215097](https://0xdfimages.gitlab.io/img/image-20220624141215097.webp)
...
![image-20220623133228739](https://0xdfimages.gitlab.io/img/image-20220623133228739.webp)
...
![image-20220622175336302](https://0xdfimages.gitlab.io/img/image-20220622175336302.webp)
...
![image-20220623084328740](https://0xdfimages.gitlab.io/img/image-20220623084328740.webp)
...
![image-20220623134225362](https://0xdfimages.gitlab.io/img/image-20220623134225362.webp)

Right away, I’ll notice that it’s only removing the starting tag:

![image-20220623115135383](https://0xdfimages.gitlab.io/img/image-20220623115135383.webp)

In fact, it’s only removing the first tag:

![image-20220623115158631](https://0xdfimages.gitlab.io/img/image-20220623115158631.webp)

So I have a way to get a tag loaded. To test, I’ll create an issue with a bold tag:

![image-20220623134346844](https://0xdfimages.gitlab.io/img/image-20220623134346844.webp)

It works:

![image-20220623134406824](https://0xdfimages.gitlab.io/img/image-20220623134406824.webp)
...
![image-20220623134549864](https://0xdfimages.gitlab.io/img/image-20220623134549864.webp)
...
![image-20220623134701223](https://0xdfimages.gitlab.io/img/image-20220623134701223.webp)
...
![image-20220623140447679](https://0xdfimages.gitlab.io/img/image-20220623140447679.webp)
...
![image-20220623144707683](https://0xdfimages.gitlab.io/img/image-20220623144707683.webp)
...
![image-20220623151242976](https://0xdfimages.gitlab.io/img/image-20220623151242976.webp)
...
![image-20220623151804444](https://0xdfimages.gitlab.io/img/image-20220623151804444.webp)

It would bypass check:

![image-20220623151836661](https://0xdfimages.gitlab.io/img/image-20220623151836661.webp)
...
![image-20220623151949006](https://0xdfimages.gitlab.io/img/image-20220623151949006.webp)
...
![image-20220623154951088](https://0xdfimages.gitlab.io/img/image-20220623154951088.webp)
...
![image-20220623162637491](https://0xdfimages.gitlab.io/img/image-20220623162637491.webp)
...
![image-20220623162716169](https://0xdfimages.gitlab.io/img/image-20220623162716169.webp)
...
![image-20220623170232621](https://0xdfimages.gitlab.io/img/image-20220623170232621.webp)
...
There is a link at the bottom of the Gitea page that leads to `http://dev.snippet.htb/api/swagger`, which is the API documents. I’ve seen Swagger documents before (in [Backend](about:/2022/04/12/htb-backend.html#site) and [BackendTwo](about:/2022/05/02/htb-backendtwo.html#api-admin-access)). It’s a really nice interactive documents.

![image-20220623171024971](https://0xdfimages.gitlab.io/img/image-20220623171024971.webp)

Within each category, there’s a list of the endpoints:

![image-20220623171117718](https://0xdfimages.gitlab.io/img/image-20220623171117718.webp)

And each of those expands to show details, as well as allows for using the endpoint from within the browser:

![image-20220623171151922](https://0xdfimages.gitlab.io/img/image-20220623171151922.webp)
...
![image-20220623171328225](https://0xdfimages.gitlab.io/img/image-20220623171328225.webp)

Visiting `/api/v1/repos/search` with no parameters returns the only repo Jean has access to:

![image-20220623171433997](https://0xdfimages.gitlab.io/img/image-20220623171433997.webp)
...
![image-20220623173658761](https://0xdfimages.gitlab.io/img/image-20220623173658761.webp)
...
![image-20220623192316262](https://0xdfimages.gitlab.io/img/image-20220623192316262.webp)
...
![image-20220616155009684](https://0xdfimages.gitlab.io/img/image-20220616155009684.webp)

Clicking it sends shows a response in the page:

![image-20220624144128069](https://0xdfimages.gitlab.io/img/image-20220624144128069.webp)
...
I showed exploiting this before in [Feline](about:/2021/02/20/htb-feline.html#shell-as-root).
