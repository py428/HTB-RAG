[HTB: OpenKeyS](/2020/12/12/htb-openkeys.html)

![OpenKeyS](https://0xdfimages.gitlab.io/img/openkeys-cover.webp)
...
[![OpenKeyS](/icons/box-openkeys.webp)](https://hackthebox.com/machines/openkeys)

[OpenKeyS](https://hackthebox.com/machines/openkeys)
...
Rated Difficulty ![Rated difficulty for OpenKeyS](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/openkeys-diff.webp)

Radar Graph ![Radar chart for OpenKeyS](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/openkeys-radar.webp)

User

01:29:49 Root

01:29:37 Creators   ## Recon
...
![image-20200726125111255](https://0xdfimages.gitlab.io/img/image-20200726125111255.webp)
...
![image-20200726125521655](https://0xdfimages.gitlab.io/img/image-20200726125521655.webp)
...
![image-20200726132205821](https://0xdfimages.gitlab.io/img/image-20200726132205821.webp)

Clicking on `auth.php` will just show a blank page (because the server is running the PHP), but the `.swp` file is something I recognize as a `vim` swap file, which stores information about files open in the editor. I worked with a similar file in [OneTwoSeven](about:/2019/08/31/htb-onetwoseven.html#sftp-symlinks). I’ll download the file with `wget`, and then open it with `vim -r auth.php.swp`:

![image-20200726132902558](https://0xdfimages.gitlab.io/img/image-20200726132902558.webp)
...
![image-20200727122200762](https://0xdfimages.gitlab.io/img/image-20200727122200762.webp)
...
![image-20200727125645763](https://0xdfimages.gitlab.io/img/image-20200727125645763.webp)
...
![image-20200727191918452](https://0xdfimages.gitlab.io/img/image-20200727191918452.webp)
...
![image-20200727211834441](https://0xdfimages.gitlab.io/img/image-20200727211834441.webp)
