[HTB: Aero](/2023/09/28/htb-aero.html)

![Aero](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/aero-cover.webp)
...
[![Aero](/icons/box-aero.webp)](https://hackthebox.com/machines/aero)

[Aero](https://hackthebox.com/machines/aero)
...
The website is a repository for Windows 11 themes:
 ...
 ![image-20230926081003612](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926081003612.webp)![expand](/icons/expand.png)

Towards the bottom there’s a form to upload custom themes:

![image-20230926081129731](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926081129731.webp)
...
![image-20230926084611408](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926084611408.webp)

I’ll make a dummy file, `test.theme`, and upload it, and it takes:

![image-20230926084529399](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926084529399.webp)
...
![image-20230926082127878](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926082127878.webp)
...
![](https://www.youtube.com/watch?v=CdzgD-eMOnY)
...
I’ve got a reverse shell DLL in my [CTF Scripts repo](https://gitlab.com/0xdf/ctfscripts/-/tree/master/rev_shell_dll?ref_type=heads) that I used for the [Helpline HTB box](about:/2019/08/17/htb-helpline-win.html#payload). It won’t work here because it pulls from the local environment variables to get the callback IP and port. It also run the reverse shell on DLL load, where as the instructions for the POC say to use the `VerifyThemeVersion` function.
...
![image-20230926102531429](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926102531429.webp)

I’ll name the project and get a folder for it:

![image-20230926123358322](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926123358322.webp)
...
![image-20230926123703993](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926123703993.webp)
...
![image-20230926123753275](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926123753275.webp)
...
![image-20230926124753014](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926124753014.webp)

Running it with `rundll32` will show it works:

![image-20230926124826895](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926124826895.webp)
...
![image-20230926133614570](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926133614570.webp)
...
![image-20230926164349274](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926164349274.webp)
...
![image-20230926164832525](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926164832525.webp)

I’ll replace `notepad.exe` with PowerShell #3 (Base64) from [revshells.com](https://www.revshells.com/):

![image-20230926164949303](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926164949303.webp)
...
![image-20230926165207728](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926165207728.webp)
...
![image-20230926165332566](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230926165332566.webp)
