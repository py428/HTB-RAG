[HTB: Pikaboo](/2021/12/04/htb-pikaboo.html)

![Pikaboo](https://0xdfimages.gitlab.io/img/pikaboo-cover.webp)
...
[![Pikaboo](/icons/box-pikaboo.webp)](https://hackthebox.com/machines/pikaboo)

[Pikaboo](https://hackthebox.com/machines/pikaboo)
...
Rated Difficulty ![Rated difficulty for Pikaboo](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/pikaboo-diff.webp)

Radar Graph ![Radar chart for Pikaboo](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/pikaboo-radar.webp)

User

01:40:48 Root

03:00:15 Creators   ## Recon
...
![image-20210707115043587](https://0xdfimages.gitlab.io/img/image-20210707115043587.webp)

Clicking on any of the monsters loads a page that says PokeAPI Integration is coming soon:

![image-20210707115136899](https://0xdfimages.gitlab.io/img/image-20210707115136899.webp)
...
![image-20210707115206079](https://0xdfimages.gitlab.io/img/image-20210707115206079.webp)

The button on this page doesn’t seem to actually submit any requests.

The admin link (`/admin`) pops HTTP auth:

![image-20210707115345210](https://0xdfimages.gitlab.io/img/image-20210707115345210.webp)

Nothing I guessed allowed access, and on hitting Cancel, there’s an Unauthorized page:

![image-20210707115430373](https://0xdfimages.gitlab.io/img/image-20210707115430373.webp)
...
![image-20210707131731884](https://0xdfimages.gitlab.io/img/image-20210707131731884.webp)
...
![image-20210707133915976](https://0xdfimages.gitlab.io/img/image-20210707133915976.webp)

Before giving up, I checked something more local, and it worked:

![image-20210707134119419](https://0xdfimages.gitlab.io/img/image-20210707134119419.webp)
...
![image-20210707134842647](https://0xdfimages.gitlab.io/img/image-20210707134842647.webp)
...
![image-20211130175417591](https://0xdfimages.gitlab.io/img/image-20211130175417591.webp)

I can try to log in with FTP, and the new login shows up as well:

![image-20211130175556231](https://0xdfimages.gitlab.io/img/image-20211130175556231.webp)
...
![image-20211021063650139](https://0xdfimages.gitlab.io/img/image-20211021063650139.webp)
