[HTB: Bolt](/2022/02/19/htb-bolt.html)

![Bolt](https://0xdfimages.gitlab.io/img/bolt-cover.webp)
...
[![Bolt](/icons/box-bolt.webp)](https://hackthebox.com/machines/bolt)

[Bolt](https://hackthebox.com/machines/bolt)
...
Rated Difficulty ![Rated difficulty for Bolt](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/bolt-diff.webp)

Radar Graph ![Radar chart for Bolt](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/bolt-radar.webp)

User

00:34:28 Root

01:09:33 Creators   ## Recon
...
![](https://0xdfimages.gitlab.io/img/image-20210908135259081.webp)

The “Create Account” link leads to another form, but on submitting it fails:

![image-20210908140106137](https://0xdfimages.gitlab.io/img/image-20210908140106137.webp)
...
![image-20210908141950450](https://0xdfimages.gitlab.io/img/image-20210908141950450.webp)

It is slightly different. For example, it has a “Remember me” checkbox.

The “Create account” link leads to another form:

![image-20210908142101903](https://0xdfimages.gitlab.io/img/image-20210908142101903.webp)

This one requires an invite code. Trying to register and just guess a code returns an error:

![image-20210908142051390](https://0xdfimages.gitlab.io/img/image-20210908142051390.webp)
...
![image-20210908142237548](https://0xdfimages.gitlab.io/img/image-20210908142237548.webp)
...
![image-20210908142456124](https://0xdfimages.gitlab.io/img/image-20210908142456124.webp)
...
![image-20210908142554058](https://0xdfimages.gitlab.io/img/image-20210908142554058.webp)
...
I’ve run into this before in [Hacvent 2020](about:/hackvent2020/leet#solution) and [Flare-On 2021](/flare-on-2021/antioch). But if I hadn’t, Googling “layer.tar” returns a bunch of links about Docker images and unpacking them:

![image-20210908144511283](https://0xdfimages.gitlab.io/img/image-20210908144511283.webp)
...
![image-20220218095022269](https://0xdfimages.gitlab.io/img/image-20220218095022269.webp)
...
![image-20220218100330991](https://0xdfimages.gitlab.io/img/image-20220218100330991.webp)
...
![image-20220218101356246](https://0xdfimages.gitlab.io/img/image-20220218101356246.webp)
...
![image-20210908163231358](https://0xdfimages.gitlab.io/img/image-20210908163231358.webp)

Once I click confirm, another email arrives:

![image-20210908163221617](https://0xdfimages.gitlab.io/img/image-20210908163221617.webp)
...
![image-20220218153059513](https://0xdfimages.gitlab.io/img/image-20220218153059513.webp)

#### Shell

I am also able to `ping -c 1 10.10.14.6` and see ICMP packets in `tcpdump`, and the results is in the email:

![image-20210908165753130](https://0xdfimages.gitlab.io/img/image-20210908165753130.webp)
...
![image-20210908174457322](https://0xdfimages.gitlab.io/img/image-20210908174457322.webp)

Page 40 says that passbolt doesn’t protect against an attacker having access to the local filesystem:

![image-20210908174719849](https://0xdfimages.gitlab.io/img/image-20210908174719849.webp)

On page 21, it says that the private key is stored in the web extension local storage:

![image-20210908174624408](https://0xdfimages.gitlab.io/img/image-20210908174624408.webp)
...
![image-20210908203440001](https://0xdfimages.gitlab.io/img/image-20210908203440001.webp)
...
![image-20210908204503183](https://0xdfimages.gitlab.io/img/image-20210908204503183.webp)
...
![image-20210908204841768](https://0xdfimages.gitlab.io/img/image-20210908204841768.webp)

I’ll download and install the extension, and then click the “Refresh to detect extension” link. It offers a new form:

![image-20210908204931066](https://0xdfimages.gitlab.io/img/image-20210908204931066.webp)

I’ll give it the key from the config and hit “Next”. It now needs the password for the key:

![image-20210908205008102](https://0xdfimages.gitlab.io/img/image-20210908205008102.webp)

On entering the password and clicking “Verify”, it leads to some setup:

![image-20210908205052345](https://0xdfimages.gitlab.io/img/image-20210908205052345.webp)

On clicking next, I’m into the account:

![image-20210908205124837](https://0xdfimages.gitlab.io/img/image-20210908205124837.webp)

The root password is there. Opening the item, selecting edit, and then clicking on the eye, it shows the password:

![image-20210908205308180](https://0xdfimages.gitlab.io/img/image-20210908205308180.webp)
...
![](https://www.youtube.com/watch?v=7o1J8vHdlYc)
...
![image-20210908163747213](https://0xdfimages.gitlab.io/img/image-20210908163747213.webp)
...
![image-20210908165349973](https://0xdfimages.gitlab.io/img/image-20210908165349973.webp)
