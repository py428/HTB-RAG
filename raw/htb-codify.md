[HTB: Codify](/2024/04/06/htb-codify.html)

![Codify](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/codify-cover.webp)
...
[![Codify](/icons/box-codify.webp)](https://hackthebox.com/machines/codify)

[Codify](https://hackthebox.com/machines/codify)
...
Rated Difficulty ![Rated difficulty for Codify](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/codify-diff.webp)

Radar Graph ![Radar chart for Codify](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/codify-radar.webp)

User

00:16:40 Root

00:36:49 Creator ## Recon
...
![image-20240403174412227](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403174412227.webp)

The “limitations” link goes to `/limitations`, which talks about what modules are allowed to run:

![image-20240403174452273](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403174452273.webp)
...
![image-20240403175003731](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403175003731.webp)
...
![image-20240403175208561](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403175208561.webp)

On entering some JavaScript code and submitting, the output is shown on the right:

![image-20240403175244620](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403175244620.webp)
...
![image-20240403175725545](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403175725545.webp)
...
![image-20240403193957552](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403193957552.webp)
...
![image-20240403194209374](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403194209374.webp)
...
![image-20240403194455864](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403194455864.webp)
...
![image-20240403200034171](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403200034171.webp)
...
![image-20240403195800662](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240403195800662.webp)
...
![image-20240404072941416](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240404072941416.webp)
...
![image-20240404092743068](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240404092743068.webp)
...
- The password comparison isn’t using quote marks. Bash [has issues](https://mywiki.wooledge.org/BashPitfalls#A.5B_.24foo_.3D_.22bar.22_.5D) when doing comparisons of strings where a variable is expanded not in “”. I exploited this in [Hackvent 2023 Day 8](about:/hackvent2023/medium#hv2308).
	```bash
	if [[ $DB_PASS == $USER_PASS ]]; then
	        /usr/bin/echo "Password confirmed!"
	else
...
![](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/brute-password-1.gif)
