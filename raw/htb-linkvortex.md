[HTB: LinkVortex](/2025/04/12/htb-linkvortex.html)

![LinkVortex](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/linkvortex-cover.webp)
...
[![LinkVortex](/icons/box-linkvortex.webp)](https://hackthebox.com/machines/linkvortex)

[LinkVortex](https://hackthebox.com/machines/linkvortex)
...
Rated Difficulty ![Rated difficulty for LinkVortex](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/linkvortex-diff.webp)

Radar Graph ![Radar chart for LinkVortex](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/linkvortex-radar.webp)

User

00:08:51 Root

00:17:03 Creator ## Recon
...
Based on the [OpenSSH](https://packages.ubuntu.com/search?keywords=openssh-server) version, the host is likely running Ubuntu 22.04 jammy. The Apache version is a bit weird. I would expect to see something like “Apache httpd 2.4.52 ((Ubuntu))” for jammy like on [Unrested](about:/2025/03/04/htb-unrested.html#nmap). The short answer is that Apache is configured with `SeverTokens Prod` and `ServerSignature Off`. I’ll show and explain this in [Beyond Root](#beyond-root---apache-config).
...
`nmap` is finding that this is [Ghost](https://ghost.org/) (similar to the HTB [Ghost](about:/2025/04/05/htb-ghost.html#) machine last week), and the `robots.txt` file is the standard [Ghost CMS](https://github.com/TryGhost/Ghost/blob/v5.58.0/ghost/core/core/frontend/public/robots.txt) `robots.txt`. `/ghost` is the login page:

![image-20250407112148167](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250407112148167.webp)
...
![image-20250407105054978](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250407105054978.webp)
...
![image-20250407110413771](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250407110413771.webp)
...
![image-20250407110624412](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250407110624412.webp)
...
The Apache header is the same. The 404 is the same as the [default Apache 404](about:/cheatsheets/404#apache--httpd) except that the server and version information is not there:

![image-20250407110944782](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250407110944782.webp)
...
![image-20250407125153982](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250407125153982.webp)

I’ll try admin@linkvortex.htb with the same password, and it works!

![image-20250407125345793](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250407125345793.webp)
...
![image-20250407120644308](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250407120644308.webp)
...
![image-20250409130510799](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250409130510799.webp)

And adding a unit test to make sure zips with symlinks can’t be uploaded:

![image-20250407121650291](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250407121650291.webp)
...
![image-20250407125427331](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250407125427331.webp)
...
![](https://www.youtube.com/watch?v=pLgjI7gVwLc)
...
![image-20250408171813308](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250408171813308.webp)
...
![image-20250408172621478](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250408172621478.webp)
...
![image-20250408172751818](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250408172751818.webp)
