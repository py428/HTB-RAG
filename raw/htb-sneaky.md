[HTB: Sneaky](/2021/03/02/htb-sneaky.html)

![Sneaky](https://0xdfimages.gitlab.io/img/sneaky-cover.webp)
...
[![Sneaky](/icons/box-sneaky.webp)](https://hackthebox.com/machines/sneaky)

[Sneaky](https://hackthebox.com/machines/sneaky)
...
Rated Difficulty ![Rated difficulty for Sneaky](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sneaky-diff.webp)

Radar Graph ![Radar chart for Sneaky](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sneaky-radar.webp)

User

03:14:00 Root

03:45:01 Creator ## Recon
...
![image-20210223143227182](https://0xdfimages.gitlab.io/img/image-20210223143227182.webp)
...
![image-20210223143429564](https://0xdfimages.gitlab.io/img/image-20210223143429564.webp)

When I try root / password, it POSTs to `/dev/login.php`, which returns an unhelpful message:

![image-20210223143508981](https://0xdfimages.gitlab.io/img/image-20210223143508981.webp)
...
![image-20210223174016510](https://0xdfimages.gitlab.io/img/image-20210223174016510.webp)

The third one is Sneaky:

![image-20210223174047468](https://0xdfimages.gitlab.io/img/image-20210223174047468.webp)
...
![image-20210223203529033](https://0xdfimages.gitlab.io/img/image-20210223203529033.webp)
...
![image-20210223203848328](https://0xdfimages.gitlab.io/img/image-20210223203848328.webp)

The link returns an SSH key:

![image-20210223203906706](https://0xdfimages.gitlab.io/img/image-20210223203906706.webp)
