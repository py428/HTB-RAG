[HTB: Faculty](/2022/10/22/htb-faculty.html)

![Faculty](https://0xdfimages.gitlab.io/img/faculty-cover.webp)
...
[![Faculty](/icons/box-faculty.webp)](https://hackthebox.com/machines/faculty)

[Faculty](https://hackthebox.com/machines/faculty)
...
Rated Difficulty ![Rated difficulty for Faculty](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/faculty-diff.webp)

Radar Graph ![Radar chart for Faculty](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/faculty-radar.webp)

User

01:03:47 Root

01:23:23 Creator ## Recon
...
![image-20220621173327212](https://0xdfimages.gitlab.io/img/image-20220621173327212.webp)

Guessing random IDs doesn’t work:

![image-20220621203126041](https://0xdfimages.gitlab.io/img/image-20220621203126041.webp)

Some Googling finds this application source [on SourceCodester](https://www.sourcecodester.com/php/14535/school-faculty-scheduling-system-using-phpmysqli-source-code.html), and there’s source I could use, but I won’t need it.
...
- Another login page at `/admin/login.php`. This presents another login for, this time with username and password:
	![image-20220621203414165](https://0xdfimages.gitlab.io/img/image-20220621203414165.webp)
...
![image-20220621203655851](https://0xdfimages.gitlab.io/img/image-20220621203655851.webp)
...
![image-20220621203908417](https://0xdfimages.gitlab.io/img/image-20220621203908417.webp)

The “Course List” shows the current courses, as well as provides an interface to edit and delete them:

![image-20220621204245831](https://0xdfimages.gitlab.io/img/image-20220621204245831.webp)

“Subject List” is a very similar interface. “Faculty List” has three users:

![image-20220621204321786](https://0xdfimages.gitlab.io/img/image-20220621204321786.webp)
...
![image-20220622053511516](https://0xdfimages.gitlab.io/img/image-20220622053511516.webp)

Clicking on it redirects to a URL like `http://faculty.htb/mpdf/tmp/OKMLDkBmRPcCFe4AEb21xgzZYI.pdf` which presents a PDF:

![image-20220622053735176](https://0xdfimages.gitlab.io/img/image-20220622053735176.webp)

Looking at the metadata about the PDF (in Firefox click `>>` > “Document Properties”), it shows the “PDF Producer” as mPDF 6.0:

![image-20220622054311030](https://0xdfimages.gitlab.io/img/image-20220622054311030.webp)
...
![image-20220622065828760](https://0xdfimages.gitlab.io/img/image-20220622065828760.webp)
...
![image-20220622070133001](https://0xdfimages.gitlab.io/img/image-20220622070133001.webp)

Grabbing the PDF, it has the text from the payload:

![image-20220622070209863](https://0xdfimages.gitlab.io/img/image-20220622070209863.webp)

Clicking on the paperclip shows it has an attachment named `passwd`:

![image-20220622070232422](https://0xdfimages.gitlab.io/img/image-20220622070232422.webp)
...
![image-20221020115308352](https://0xdfimages.gitlab.io/img/image-20221020115308352.webp)
