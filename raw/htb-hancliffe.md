[HTB: Hancliffe](/2022/03/05/htb-hancliffe.html)

![Hancliffe](https://0xdfimages.gitlab.io/img/hancliffe-cover.webp)
...
[![Hancliffe](/icons/box-hancliffe.webp)](https://hackthebox.com/machines/hancliffe)

[Hancliffe](https://hackthebox.com/machines/hancliffe)
...
Rated Difficulty ![Rated difficulty for Hancliffe](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/hancliffe-diff.webp)

Radar Graph ![Radar chart for Hancliffe](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/hancliffe-radar.webp)

User

01:59:57 Root

02:47:51 Creator ## Recon
...
![image-20220303140212816](https://0xdfimages.gitlab.io/img/image-20220303140212816.webp)
...
The site for this software is [on scottparry.co](https://scottparry.co/labs/hashpass/), and the code is on [GitHub](https://github.com/scottparry/hashpass).

The idea is that I give it my full name, the website name, my master password, and it calculates a password for me:

![image-20220127161732312](https://0xdfimages.gitlab.io/img/image-20220127161732312.webp)
...
![image-20220127162210240](https://0xdfimages.gitlab.io/img/image-20220127162210240.webp)
...
![image-20220126214030187](https://0xdfimages.gitlab.io/img/image-20220126214030187.webp)
...
![image-20220126214803198](https://0xdfimages.gitlab.io/img/image-20220126214803198.webp)
...
![image-20220127140615641](https://0xdfimages.gitlab.io/img/image-20220127140615641.webp)
...
![image-20220127143725835](https://0xdfimages.gitlab.io/img/image-20220127143725835.webp)
...
![image-20220127144904131](https://0xdfimages.gitlab.io/img/image-20220127144904131.webp)
...
![image-20220129082513332](https://0xdfimages.gitlab.io/img/image-20220129082513332.webp)
...
![](https://www.youtube.com/watch?v=r4aaNt7f-lM)
...
![image-20220203161045123](https://0xdfimages.gitlab.io/img/image-20220203161045123.webp)
...
![image-20220203170114908](https://0xdfimages.gitlab.io/img/image-20220203170114908.webp)
...
![image-20220203171721105](https://0xdfimages.gitlab.io/img/image-20220203171721105.webp)
...
![image-20220306064328242](https://0xdfimages.gitlab.io/img/image-20220306064328242.webp)
...
To go down this path, I’ll disabled DEP in my test VM by following the instructions [on a1logic.com](https://www.a1logic.com/2012/06/14/disable-dep-and-aslr-on-windows-7-64bit-at-compile-time/) and rebooting.
...
![image-20220203172616918](https://0xdfimages.gitlab.io/img/image-20220203172616918.webp)

I’ll give it `JMP ESP`, and it finds several:

![image-20220203172657158](https://0xdfimages.gitlab.io/img/image-20220203172657158.webp)
...
![image-20220203215128438](https://0xdfimages.gitlab.io/img/image-20220203215128438.webp)
...
![image-20220203204855465](https://0xdfimages.gitlab.io/img/image-20220203204855465.webp)
...
![image-20220203215507285](https://0xdfimages.gitlab.io/img/image-20220203215507285.webp)
...
![image-20220203220612192](https://0xdfimages.gitlab.io/img/image-20220203220612192.webp)
...
![image-20220204064559504](https://0xdfimages.gitlab.io/img/image-20220204064559504.webp)
...
![image-20220204152150240](https://0xdfimages.gitlab.io/img/image-20220204152150240.webp)
...
![](https://0xdfimages.gitlab.io/img/hancliffe-socket-stack.webp)
...
![image-20220204153652747](https://0xdfimages.gitlab.io/img/image-20220204153652747.webp)
...
![image-20220204141100479](https://0xdfimages.gitlab.io/img/image-20220204141100479.webp)

The global is at 0x719082ac:

![image-20220204141314037](https://0xdfimages.gitlab.io/img/image-20220204141314037.webp)
```
