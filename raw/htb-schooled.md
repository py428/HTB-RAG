[HTB: Schooled](/2021/09/11/htb-schooled.html)

![Schooled](https://0xdfimages.gitlab.io/img/schooled-cover.webp)
...
[![Schooled](/icons/box-schooled.webp)](https://hackthebox.com/machines/schooled)

[Schooled](https://hackthebox.com/machines/schooled)

Medium

Retire Date 11 Sep 2021

OS ![FreeBSD](/icons/FreeBSD.webp)

Rated Difficulty ![Rated difficulty for Schooled](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/schooled-diff.webp)

Radar Graph ![Radar chart for Schooled](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/schooled-radar.webp)

User

01:31:56 Root

01:58:38 Creator ## Recon
...
At the very bottom of the page, there’s contact details and the footer that container the DNS name, `schooled.htb`.
 ...
 ![image-20210401135823357](https://0xdfimages.gitlab.io/img/image-20210401135823357.webp)![image-20210401135829512](https://0xdfimages.gitlab.io/img/image-20210401135829512.webp)
...
![image-20210401140807992](https://0xdfimages.gitlab.io/img/image-20210401140807992.webp)

Clicking around the site, each of the courses doesn’t grant access, but requires me to log in:

![image-20210401140951801](https://0xdfimages.gitlab.io/img/image-20210401140951801.webp)
...
![image-20210401143254653](https://0xdfimages.gitlab.io/img/image-20210401143254653.webp)

And a `/moodle/npm-shrinkwrap.json`:

![image-20210401143345306](https://0xdfimages.gitlab.io/img/image-20210401143345306.webp)

At `/moodle/theme/upgrade.txt`, there’s a changelog that gives the current version, 3.9:

![image-20210401143607797](https://0xdfimages.gitlab.io/img/image-20210401143607797.webp)
...
![image-20210401141242899](https://0xdfimages.gitlab.io/img/image-20210401141242899.webp)

It won’t accept any email that doesn’t come from `student.schooled.htb`:

![image-20210401141353641](https://0xdfimages.gitlab.io/img/image-20210401141353641.webp)
...
![image-20210401141610678](https://0xdfimages.gitlab.io/img/image-20210401141610678.webp)

On clicking Continue, it says my registration is confirmed, and redirects back to the page I was on, now logged in:

![image-20210401141646772](https://0xdfimages.gitlab.io/img/image-20210401141646772.webp)

#### Enroll

Of the four courses, three of them say that you can’t enroll in this course. For example, Scientific Research:

![image-20210401142213978](https://0xdfimages.gitlab.io/img/image-20210401142213978.webp)

On the other hand, Mathematics offers “self enrollment”:

![image-20210401142242252](https://0xdfimages.gitlab.io/img/image-20210401142242252.webp)

On logging in and looking around, the Announcements section has a couple of posts:

![image-20210401142335290](https://0xdfimages.gitlab.io/img/image-20210401142335290.webp)

The Reminder for joining students says that all students need to have a MoodleNet profile:

![image-20210401142418761](https://0xdfimages.gitlab.io/img/image-20210401142418761.webp)
...
![image-20210401144331846](https://0xdfimages.gitlab.io/img/image-20210401144331846.webp)
...
![image-20210401145439543](https://0xdfimages.gitlab.io/img/image-20210401145439543.webp)

Now on visiting `http://moodle.schooled.htb/moodle`, I’m logged in as Manuel Phillips:

![image-20210401145519020](https://0xdfimages.gitlab.io/img/image-20210401145519020.webp)
...
![image-20210401151238759](https://0xdfimages.gitlab.io/img/image-20210401151238759.webp)

As I start to enter Lianne, it will autofill:

![image-20210401151313068](https://0xdfimages.gitlab.io/img/image-20210401151313068.webp)
...
![image-20210401151707932](https://0xdfimages.gitlab.io/img/image-20210401151707932.webp)
...
![image-20210401170059238](https://0xdfimages.gitlab.io/img/image-20210401170059238.webp)

CLicking that gives me the view as if I’m Lianne:

![image-20210401170125333](https://0xdfimages.gitlab.io/img/image-20210401170125333.webp)

### Enable Full Permissions

As Lianne, I now have a new menu item at the very bottom on the left-side menu:

![image-20210401174412019](https://0xdfimages.gitlab.io/img/image-20210401174412019.webp)

In that area, there is a Plugins section, but there’s not much I can do in the current state:

![image-20210401174457154](https://0xdfimages.gitlab.io/img/image-20210401174457154.webp)
...
![image-20210401174846523](https://0xdfimages.gitlab.io/img/image-20210401174846523.webp)

The resulting page shows the roles and what they can do. I’ll click the gear next to Manager:

![image-20210401174932321](https://0xdfimages.gitlab.io/img/image-20210401174932321.webp)
...
![image-20210401175046114](https://0xdfimages.gitlab.io/img/image-20210401175046114.webp)
...
![image-20210401175153658](https://0xdfimages.gitlab.io/img/image-20210401175153658.webp)
...
![image-20210401175339054](https://0xdfimages.gitlab.io/img/image-20210401175339054.webp)

### RCE

A Moodle Plugin is a zip file with a certain structure of folders and PHP files. There are different types of plugins that can be read about [in the Moodle docs](https://docs.moodle.org/dev/Plugin_types). This [FAQ page](https://moodle.com/faq/how-do-i-create-a-moodle-plugin/) has a link to the [How-to guide](https://docs.moodle.org/dev/Blocks). While I could write my own, the GitHub POC I’ve been following has a link to [rce.zip](https://github.com/HoangKien1020/Moodle_RCE/blob/master/rce.zip) that provides a webshell (I’ll look at it in Beyond Root).

I’ll upload that via the administrator panel:

![image-20210401175829804](https://0xdfimages.gitlab.io/img/image-20210401175829804.webp)

The next page shows a bunch of OKs (and a couple warnings) and I can click continue at the bottom:

![image-20210401175921082](https://0xdfimages.gitlab.io/img/image-20210401175921082.webp)
