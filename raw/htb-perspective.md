[HTB: Perspective](/2022/10/15/htb-perspective.html)

![Perspective](https://0xdfimages.gitlab.io/img/perspective-cover.webp)
...
[![Perspective](/icons/box-perspective.webp)](https://hackthebox.com/machines/perspective)

[Perspective](https://hackthebox.com/machines/perspective)
...
Rated Difficulty ![Rated difficulty for Perspective](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/perspective-diff.webp)

Radar Graph ![Radar chart for Perspective](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/perspective-radar.webp)

User

13:16:51 Root

15:58:33 Creator ## Recon
...
![image-20220930164519288](https://0xdfimages.gitlab.io/img/image-20220930164519288.webp)

The “Log in” link presents a form:

![image-20221010131432583](https://0xdfimages.gitlab.io/img/image-20221010131432583.webp)
...
![image-20221010132026940](https://0xdfimages.gitlab.io/img/image-20221010132026940.webp)

The “New Products” page is empty, but offers a button to create one:

![image-20221010132258660](https://0xdfimages.gitlab.io/img/image-20221010132258660.webp)

That button leads to a form:

![image-20221010132327353](https://0xdfimages.gitlab.io/img/image-20221010132327353.webp)

There is filtering going on if the image file isn’t an JPEG file:

![image-20221010133153512](https://0xdfimages.gitlab.io/img/image-20221010133153512.webp)

On submitting, a new product is on the page:

![image-20221010132245670](https://0xdfimages.gitlab.io/img/image-20221010132245670.webp)

The “Support” link just has text:

![image-20221010132433689](https://0xdfimages.gitlab.io/img/image-20221010132433689.webp)
...
![image-20221010143916474](https://0xdfimages.gitlab.io/img/image-20221010143916474.webp)

Entering the account I created and clicking “Initiate Reset” loads the next page:

![image-20221010143948309](https://0xdfimages.gitlab.io/img/image-20221010143948309.webp)

Entering the correct answers (I used “0xdf” as the answer to all of these) provides a form to reset the password:

![image-20221010144045963](https://0xdfimages.gitlab.io/img/image-20221010144045963.webp)
...
![image-20221010155505945](https://0xdfimages.gitlab.io/img/image-20221010155505945.webp)
...
![image-20221010155908795](https://0xdfimages.gitlab.io/img/image-20221010155908795.webp)

It uploads just fine. The product is on the page with a broken image:

![image-20221010155936803](https://0xdfimages.gitlab.io/img/image-20221010155936803.webp)
...
![image-20221010160114857](https://0xdfimages.gitlab.io/img/image-20221010160114857.webp)
...
![image-20221010160254152](https://0xdfimages.gitlab.io/img/image-20221010160254152.webp)
...
![image-20221010161112324](https://0xdfimages.gitlab.io/img/image-20221010161112324.webp)
...
![image-20221010161206913](https://0xdfimages.gitlab.io/img/image-20221010161206913.webp)
...
![](https://0xdfimages.gitlab.io/img/perspective-intruder-extensions-16654332197301.webp)
...
![image-20221010163133923](https://0xdfimages.gitlab.io/img/image-20221010163133923.webp)

However, when I try to open the image, the page returns 404:

![image-20221010163202130](https://0xdfimages.gitlab.io/img/image-20221010163202130.webp)
...
![image-20221010164515359](https://0xdfimages.gitlab.io/img/image-20221010164515359.webp)
...
![image-20221010164820425](https://0xdfimages.gitlab.io/img/image-20221010164820425.webp)
...
![image-20221010165422575](https://0xdfimages.gitlab.io/img/image-20221010165422575.webp)

On loading the image, it works:

![image-20221010165436558](https://0xdfimages.gitlab.io/img/image-20221010165436558.webp)
...
![image-20221010171006532](https://0xdfimages.gitlab.io/img/image-20221010171006532.webp)
...
![image-20221011124850548](https://0xdfimages.gitlab.io/img/image-20221011124850548.webp)
...
![image-20221011072423228](https://0xdfimages.gitlab.io/img/image-20221011072423228.webp)
...
![image-20221011072714510](https://0xdfimages.gitlab.io/img/image-20221011072714510.webp)
...
![image-20221011080101669](https://0xdfimages.gitlab.io/img/image-20221011080101669.webp)
...
![image-20221011092453665](https://0xdfimages.gitlab.io/img/image-20221011092453665.webp)

There’s a link to the “New product admin panel” at `/Admin/AdminProducts`:

![image-20221011092522773](https://0xdfimages.gitlab.io/img/image-20221011092522773.webp)

I’ll enter “0xdf@perspective.htb” and it shows the products I’ve uploaded, along with a button to “Generate PDF”:

![image-20221011092621132](https://0xdfimages.gitlab.io/img/image-20221011092621132.webp)

Trying with my products that are full of broken image links fails. Trying with admin’s list (empty) generates an PDF:

![image-20221011092845896](https://0xdfimages.gitlab.io/img/image-20221011092845896.webp)

I’ll delete my old products and create a new one:

![image-20221011092953400](https://0xdfimages.gitlab.io/img/image-20221011092953400.webp)

This exports just fine:

![image-20221011093009396](https://0xdfimages.gitlab.io/img/image-20221011093009396.webp)
...
![image-20221011093502718](https://0xdfimages.gitlab.io/img/image-20221011093502718.webp)
...
![image-20221011123005021](https://0xdfimages.gitlab.io/img/image-20221011123005021.webp)

It shows up in the list now, escaped:

![image-20221011123124600](https://0xdfimages.gitlab.io/img/image-20221011123124600.webp)
...
![image-20221011123217094](https://0xdfimages.gitlab.io/img/image-20221011123217094.webp)
...
![image-20221011131118255](https://0xdfimages.gitlab.io/img/image-20221011131118255.webp)
...
![image-20221011162735226](https://0xdfimages.gitlab.io/img/image-20221011162735226.webp)
...
![](https://www.youtube.com/watch?v=bYPk--PUlPQ)
...
![image-20221011133128296](https://0xdfimages.gitlab.io/img/image-20221011133128296.webp)
...
![image-20221011133236930](https://0xdfimages.gitlab.io/img/image-20221011133236930.webp)
...
![image-20221011162127040](https://0xdfimages.gitlab.io/img/image-20221011162127040.webp)
...
![image-20221011170319706](https://0xdfimages.gitlab.io/img/image-20221011170319706.webp)
...
![image-20221012061928294](https://0xdfimages.gitlab.io/img/image-20221012061928294.webp)
...
![image-20221012062354613](https://0xdfimages.gitlab.io/img/image-20221012062354613.webp)
...
![image-20221012082757637](https://0xdfimages.gitlab.io/img/image-20221012082757637.webp)

That links leads to `/Account/Forgot`, which asks for an email address. Entering the admin email returns an error:

![image-20221012083226265](https://0xdfimages.gitlab.io/img/image-20221012083226265.webp)
...
![image-20221012084417798](https://0xdfimages.gitlab.io/img/image-20221012084417798.webp)
...
![image-20221012084918266](https://0xdfimages.gitlab.io/img/image-20221012084918266.webp)
...
![image-20221012102451702](https://0xdfimages.gitlab.io/img/image-20221012102451702.webp)
...
I’ve shown Padding Oracle Attacks a couple times, most recently in [Overflow](about:/2022/04/09/htb-overflow.html#padding-oracle-attack). I have a long description of the attack in the [Lazy post](about:/2020/07/29/htb-lazy.html#path-1-padding-oracle-attack). Because I can tell the difference between invalid date and bad padding, I can use that to brute force the encrypted data to get the stream of bytes used to encrypt/decrypt the value. With that, I can read the plaintext *and* forge new encrypted data.

`padbuster` is the most common tool to perform this attack (though I wrote a custom tool to perform this attack for [Smasher](about:/2018/11/24/htb-smasher.html#adding-to-exploit-script)). I’m going to pass `padbuster` the following arguments:
...
![image-20221012112516484](https://0xdfimages.gitlab.io/img/image-20221012112516484.webp)

And I can log into the staging instances as admin:

![image-20221012112608210](https://0xdfimages.gitlab.io/img/image-20221012112608210.webp)
...
![image-20221010172518625](https://0xdfimages.gitlab.io/img/image-20221010172518625.webp)
...
![image-20221010172630577](https://0xdfimages.gitlab.io/img/image-20221010172630577.webp)

The request looks like this:

![image-20221010172710381](https://0xdfimages.gitlab.io/img/image-20221010172710381.webp)

I’ll try editing the `EmailHidden` field by changing “0xdf” to “admin”. The response that comes back is a 500 error.

![image-20221010172754986](https://0xdfimages.gitlab.io/img/image-20221010172754986.webp)

I’ll try again, but this time, I’ll leave the questions blank when I submit, and change the email:

![image-20221010172842591](https://0xdfimages.gitlab.io/img/image-20221010172842591.webp)

On forwarding, it seems to work, presenting a form for a new password:

![image-20221010172910647](https://0xdfimages.gitlab.io/img/image-20221010172910647.webp)

When I enter something, it says:

![image-20221010172930181](https://0xdfimages.gitlab.io/img/image-20221010172930181.webp)

And I’m able to log in as admin:

![image-20221010172956069](https://0xdfimages.gitlab.io/img/image-20221010172956069.webp)
