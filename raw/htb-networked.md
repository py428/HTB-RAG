[HTB: Networked](/2019/11/16/htb-networked.html)

![Networked](https://0xdfimages.gitlab.io/img/networked-cover.webp)
...
[![Networked](/icons/box-networked.webp)](https://hackthebox.com/machines/networked)

[Networked](https://hackthebox.com/machines/networked)
...
Rated Difficulty ![Rated difficulty for Networked](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/networked-diff.webp)

Radar Graph ![Radar chart for Networked](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/networked-radar.webp)

User

00:38:36 Root

01:15:30 Creator ## Recon
...
![1566683597684](https://0xdfimages.gitlab.io/img/1566683597684.webp)
...
![1566683774080](https://0xdfimages.gitlab.io/img/1566683774080.webp)
...
![1566725658313](https://0xdfimages.gitlab.io/img/1566725658313.webp)

I created a png real quick, and upload it. The page returns:

![1566725684851](https://0xdfimages.gitlab.io/img/1566725684851.webp)

I’ll jump over to the other page I have from the source, `photos.php`:

![1566725726691](https://0xdfimages.gitlab.io/img/1566725726691.webp)
...
![1566725870104](https://0xdfimages.gitlab.io/img/1566725870104.webp)
...
![1566725986450](https://0xdfimages.gitlab.io/img/1566725986450.webp)

When I view `/uploads/10_10_14_5.php.png`, I see the strings of the image and the php executing in the middle:

![1566726099763](https://0xdfimages.gitlab.io/img/1566726099763.webp)

I’ll add `?cmd=id` to the end:

![1566726130362](https://0xdfimages.gitlab.io/img/1566726130362.webp)

### What? Why?

I was very confused at this point. It turns out this is a configuration error in how the web server is deciding what to execute as code as opposed to return a static file or an image. Details are [on Remi’s Blog](https://blog.remirepo.net/post/2013/01/13/PHP-and-Apache-SetHandler-vs-AddHandler). The standard case is that php will only process files ending in `.php`. The configuration error here means that as long as `.php` is somewhere in the name it will process as php. I’ll look into the configuration a bit more in [Beyond Root](#beyond-root---php-misconfiguration).
