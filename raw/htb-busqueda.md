[HTB: Busqueda](/2023/08/12/htb-busqueda.html)

![Busqueda](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/busqueda-cover.webp)
...
[![Busqueda](/icons/box-busqueda.webp)](https://hackthebox.com/machines/busqueda)

[Busqueda](https://hackthebox.com/machines/busqueda)
...
Rated Difficulty ![Rated difficulty for Busqueda](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/busqueda-diff.webp)

Radar Graph ![Radar chart for Busqueda](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/busqueda-radar.webp)

User

00:09:42 Root

00:40:31 Creator ## Recon
...
![image-20230409171848479](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230409171848479.webp)

If I select GitHub and search for “0xdf”, it goes to `/search` which returns this URL:

![image-20230331115621596](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331115621596.webp)

If I do the same search with “Auto redirect” checked, it redirects to that page:

![image-20230331115704742](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331115704742.webp)
...
Werkzeug is most commonly seem in [Flask](https://flask.palletsprojects.com/en/2.3.x/) applications. The 404 page for this application is the [default Flask 404](about:/2023/03/04/htb-forgot.html#tech-stack):

![image-20230331120031900](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331120031900.webp)

It also says this is Flask at the bottom of the page:

![image-20230409171932334](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230409171932334.webp)
...
![image-20230331142317898](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331142317898.webp)
...
![image-20230331143118578](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331143118578.webp)
...
![image-20230331145602239](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331145602239.webp)
...
![image-20230331145706180](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331145706180.webp)

If I select the response and push Ctrl-Shift-u, the URL decoded text pops up:

![image-20230331145749192](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331145749192.webp)

#### Shell

Still in Repeater, I’ll replace `id` with a [bash reverse shell](https://www.youtube.com/watch?v=OjkVep2EIlw):

![image-20230331150452775](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331150452775.webp)

I’ll need to select the new stuff and Ctrl-u to URL encode it:

![image-20230331150513958](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331150513958.webp)
...
I’ll update my `/etc/hosts` file and check out `gitea.searcher.htb`:
 ...
 ![image-20230331151821858](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331151821858.webp)![expand](/icons/expand.png)

It is a Gitea instance, and cody’s creds work:

![image-20230331151914487](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230331151914487.webp)
...
![image-20230409172927468](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230409172927468.webp)

`system-checkup.py` is in that repo:

![image-20230409172949079](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230409172949079.webp)
