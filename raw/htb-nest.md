![Nest](https://0xdfimages.gitlab.io/img/nest-cover.webp)
...
[![Nest](/icons/box-nest.webp)](https://hackthebox.com/machines/nest)

[Nest](https://hackthebox.com/machines/nest)
...
Rated Difficulty ![Rated difficulty for Nest](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/nest-diff.webp)

Radar Graph ![Radar chart for Nest](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/nest-radar.webp)

User

00:12:39 Root

00:10:39 Creator ## Recon
...
![image-20200605153711984](https://0xdfimages.gitlab.io/img/image-20200605153711984.webp)
...
![image-20200605150337111](https://0xdfimages.gitlab.io/img/image-20200605150337111.webp)
...
![image-20200605150818789](https://0xdfimages.gitlab.io/img/image-20200605150818789.webp)
...
There’s an alternative data stream (ADS) there. I’ve run into these on HTB before. In both [Hackback](about:/2019/07/06/htb-hackback.html#roottxt) and [Dropzone](about:/2018/11/03/htb-dropzone.html#alternative-data-streams) the root flag was in an ADS. In [Bighead](about:/2019/05/04/htb-bighead.html#roottxt) it was the Keepass database. I can get it with `smbclient` just by specifying the entire stream name with a `get`:
...
![image-20200605171557819](https://0xdfimages.gitlab.io/img/image-20200605171557819.webp)
...
![image-20200605171635589](https://0xdfimages.gitlab.io/img/image-20200605171635589.webp)
...
![image-20200605201227701](https://0xdfimages.gitlab.io/img/image-20200605201227701.webp)

`telnet`:

![image-20200605201245413](https://0xdfimages.gitlab.io/img/image-20200605201245413.webp)

When I looked at them as Hex, the answer immediately became clear:

`nc`:

![image-20200605201357255](https://0xdfimages.gitlab.io/img/image-20200605201357255.webp)

`telnet`:

![image-20200605201412359](https://0xdfimages.gitlab.io/img/image-20200605201412359.webp)
...
![image-20200605202225518](https://0xdfimages.gitlab.io/img/image-20200605202225518.webp)
