[HTB: Fulcrum](/2022/05/11/htb-fulcrum.html)

![Fulcrum](https://0xdfimages.gitlab.io/img/fulcrum-cover.webp)
...
[![Fulcrum](/icons/box-fulcrum.webp)](https://hackthebox.com/machines/fulcrum)

[Fulcrum](https://hackthebox.com/machines/fulcrum)
...
Rated Difficulty ![Rated difficulty for Fulcrum](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/fulcrum-diff.webp)

Radar Graph ![Radar chart for Fulcrum](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/fulcrum-radar.webp)

User

2d 00:51:34 Root

2d 14:39:18 Creator ## Recon
...
![image-20220429062615591](https://0xdfimages.gitlab.io/img/image-20220429062615591.webp)
...
![image-20220428171808774](https://0xdfimages.gitlab.io/img/image-20220428171808774.webp)
...
![image-20220428172312011](https://0xdfimages.gitlab.io/img/image-20220428172312011.webp)
...
![image-20220428172813965](https://0xdfimages.gitlab.io/img/image-20220428172813965.webp)
...
![image-20220428173617368](https://0xdfimages.gitlab.io/img/image-20220428173617368.webp)
...
![image-20220428173728089](https://0xdfimages.gitlab.io/img/image-20220428173728089.webp)
...
![image-20220429062918833](https://0xdfimages.gitlab.io/img/image-20220429062918833.webp)
...
Getting the plaintext password from a `PSCredential` object is not hard at all (I did similar in [Reel](about:/2018/11/10/htb-reel.html#privesc-nico---tom) and [Omni](about:/2021/01/09/htb-omni.html#enumeration-1)):
...
Next I’ll create an `ADSISearcher` (short for `System.DirectoryServices.DirectorySearcher`, documented [in the Microsoft docs](https://docs.microsoft.com/en-us/dotnet/api/system.directoryservices.directorysearcher?view=dotnet-plat-ext-5.0)), using this constructor:
