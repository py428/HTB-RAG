[HTB: Spider](/2021/10/23/htb-spider.html)

![Spider](https://0xdfimages.gitlab.io/img/spider-cover.webp)
...
[![Spider](/icons/box-spider.webp)](https://hackthebox.com/machines/spider)

[Spider](https://hackthebox.com/machines/spider)
...
Rated Difficulty ![Rated difficulty for Spider](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/spider-diff.webp)

Radar Graph ![Radar chart for Spider](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/spider-radar.webp)

User

01:31:37 Root

02:04:11 Creators   ## Recon
...
![image-20210517102941708](https://0xdfimages.gitlab.io/img/image-20210517102941708.webp)
...
![image-20210511115521289](https://0xdfimages.gitlab.io/img/image-20210511115521289.webp)

There’s also a Register link which leads to `/register`:

![image-20210517103038495](https://0xdfimages.gitlab.io/img/image-20210517103038495.webp)
...
![image-20210517104158440](https://0xdfimages.gitlab.io/img/image-20210517104158440.webp)
...
![image-20210517105324336](https://0xdfimages.gitlab.io/img/image-20210517105324336.webp)
...
![image-20210517105502322](https://0xdfimages.gitlab.io/img/image-20210517105502322.webp)

Trying to visit the Admin link just redirects back to `/`. User Information will show my username and UUID:

![image-20210517105538885](https://0xdfimages.gitlab.io/img/image-20210517105538885.webp)
...
![SSTI cheatsheet workflow](https://0xdfimages.gitlab.io/img/serverside.webp)

I created the username `0xdf${7*7}`, and logged in. No sign of injection:

 ![image-20210517105750082](https://0xdfimages.gitlab.io/img/image-20210517105750082.webp)![image-20210517105801413](https://0xdfimages.gitlab.io/img/image-20210517105801413.webp)

I tried to register `0xdf{{7*7}}`, but it won’t let me:

![image-20210517105904466](https://0xdfimages.gitlab.io/img/image-20210517105904466.webp)

Good to know. I’ll do `0x{{7*7}}`. Nothing at the logout link:

![image-20210517110010743](https://0xdfimages.gitlab.io/img/image-20210517110010743.webp)

But in the User Information page, there’s SSTI:

![image-20210517105958902](https://0xdfimages.gitlab.io/img/image-20210517105958902.webp)

Just to complete the chart, I’ll try `{{7*'7'}}`. This suggests Jinja2:

![image-20210517110143276](https://0xdfimages.gitlab.io/img/image-20210517110143276.webp)
...
![image-20210517110437141](https://0xdfimages.gitlab.io/img/image-20210517110437141.webp)
...
![image-20210517114023850](https://0xdfimages.gitlab.io/img/image-20210517114023850.webp)

#### SQLI POC

I’ll add a `'` to the end of my UUID, and the page crashes:

![image-20210517114220767](https://0xdfimages.gitlab.io/img/image-20210517114220767.webp)
...
![image-20210517120115302](https://0xdfimages.gitlab.io/img/image-20210517120115302.webp)
...
If I had some idea that the cookie values might be vulnable to SQL injection before I wrote the proxy, I could just use the `--eval` flag in `sqlmap` as shown [on HackTricks](https://book.hacktricks.xyz/pentesting/pentesting-web/flask#flask-unsign). The example they give is:
...
![image-20210517142221286](https://0xdfimages.gitlab.io/img/image-20210517142221286.webp)
...
![image-20211020122729937](https://0xdfimages.gitlab.io/img/image-20211020122729937.webp)

That URL is interesting. It leads to a page to put in a support ticket:

![image-20210517142350712](https://0xdfimages.gitlab.io/img/image-20210517142350712.webp)

Some initial testing doesn’t show any SQLi vulns. When I try a SSTI payload, it gives a very specific error message:

![image-20210517142540521](https://0xdfimages.gitlab.io/img/image-20210517142540521.webp)
...
![image-20210517142846984](https://0xdfimages.gitlab.io/img/image-20210517142846984.webp)
...
![image-20210517144030463](https://0xdfimages.gitlab.io/img/image-20210517144030463.webp)
...
![image-20210517151047393](https://0xdfimages.gitlab.io/img/image-20210517151047393.webp)

The forgot your password link isn’t a link (yet), but just entering 0xdf and clicking Sign In works:

![image-20210517151147209](https://0xdfimages.gitlab.io/img/image-20210517151147209.webp)
...
![image-20210517171106925](https://0xdfimages.gitlab.io/img/image-20210517171106925.webp)
