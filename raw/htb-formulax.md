[HTB: FormulaX](/2024/08/17/htb-formulax.html)

![FormulaX](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/formulax-cover.webp)
...
[![FormulaX](/icons/box-formulax.webp)](https://hackthebox.com/machines/formulax)

[FormulaX](https://hackthebox.com/machines/formulax)
...
Rated Difficulty ![Rated difficulty for FormulaX](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/formulax-diff.webp)

Radar Graph ![Radar chart for FormulaX](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/formulax-radar.webp)

User

01:20:01 Root

02:29:30 Creator ## Recon
...
![image-20240812161807872](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812161807872.webp)

There’s not much here without a login, but I can register an account and login:

![image-20240812162055700](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812162055700.webp)

#### Chat

Clicking “Chat Now” starts a chat:

![image-20240812162144777](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812162144777.webp)

Unfortunately, it doesn’t seem to work:

![image-20240812162218747](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812162218747.webp)

Entering “help” shows one command, “history”:

![image-20240812162243893](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812162243893.webp)

Using it shows my history:

![image-20240812162307169](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812162307169.webp)
...
![image-20240812162554796](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812162554796.webp)

On submitting the form, it shows success:

![image-20240812162654907](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812162654907.webp)

“Contact Us” (`/restricted/contact_us.html`) shows another form that says it goes to the admin:

![image-20240812162732419](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812162732419.webp)

When I send, it shows success:

![image-20240815083738702](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240815083738702.webp)
...
![image-20240812163250482](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812163250482.webp)

This is similar to what I [showed in Corportate](about:/2024/07/13/htb-corporate.html#tech-stack-1), but rather than sending comms via websockets so that they show up in the “WebSockets history” tab in Burp, the FormulaX SocketIO is configured to just send requests over HTTP and polls the socket on a periodic basis. For example, when I send “help” it sends a POST:

![image-20240812163813606](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812163813606.webp)

And then polls the server with a GET to get the response:

![image-20240812163837325](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812163837325.webp)
...
![image-20240812175609141](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812175609141.webp)
...
![image-20240812180331884](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812180331884.webp)
...
![image-20240812201544600](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812201544600.webp)
...
![image-20240812201442494](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812201442494.webp)
...
![image-20240812201837004](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240812201837004.webp)
...
![image-20240813111343747](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813111343747.webp)
...
![image-20240813111534270](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813111534270.webp)

It’s not necessary for solving FormulaX, but I can spin up a self hosted Git server following the same steps I [show in detail for Visual](about:/2024/02/24/htb-visual.html#host-gitea). Once I have a local Gitea instance, I’ll create a repo, and create a file in it:

![image-20240813113140529](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813113140529.webp)

Now when I give that URL to the page, it gets the repo and returns a link to a report:

![image-20240813113500501](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813113500501.webp)
...
![image-20240813120013542](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813120013542.webp)
...
![image-20240813145909247](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813145909247.webp)
...
![image-20240813150042300](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813150042300.webp)
...
![image-20240813150108162](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813150108162.webp)

However, digging in on some other menus finds Overview –> Maps –> Device Dependency:

![image-20240813163743997](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813163743997.webp)

This page shows a single entry, 10.10.11.240:

![image-20240813163815177](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813163815177.webp)

Clicking on it leads to `http://librenms.com:3000/device/device=14/`, which shows more info:

![image-20240813164031363](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813164031363.webp)

Under the Gear there’s an About LibreNMS page:

![image-20240813150153387](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813150153387.webp)
...
![image-20240813150934873](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813150934873.webp)
...
![img](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/librenms-graphic.webp)
...
![image-20240813164401139](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813164401139.webp)
...
![image-20240813211853760](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813211853760.webp)
...
The page offers remote LibreOffice document management:
 ...
 ![image-20240813212045115](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240813212045115.webp)![expand](/icons/expand.png)

Clicking “Start Instance” doesn’t do anything, but clicking again shows:

![image-20240814152436123](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240814152436123.webp)

Clicking “Create File” shows a file:

![image-20240814152449441](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240814152449441.webp)
...
![image-20240814153859436](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240814153859436.webp)
...
![image-20240817173058931](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240817173058931.webp)
...
![image-20240815094941051](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240815094941051.webp)
...
![image-20240815100232181](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240815100232181.webp)

#### Create Template

Under Alerts –> Alert Templates:

![image-20240815100307449](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240815100307449.webp)

I’ll find the templates, including the ones I created with the SNMP trap XSS:

![image-20240815100342236](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240815100342236.webp)

I’ll “Create new alert template”:

![image-20240815100713557](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240815100713557.webp)
...
![image-20240815064914761](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240815064914761.webp)
