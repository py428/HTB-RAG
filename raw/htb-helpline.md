...
Rated Difficulty ![Rated difficulty for Helpline](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/helpline-diff.webp)

Radar Graph ![Radar chart for Helpline](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/helpline-radar.webp)

User

1d 01:44:24 Root

23:38:22 Creator ## Recon
...
There is an XML External Entity vulnerability that lets me get files from the host. This vulnerability is described [in this advisory](https://labs.integrity.pt/advisories/cve-2017-9362/index.html). I wrote a quick script that allows me to request a file:
...
I did try to run `responder` and give it an path to a share on my host. I think you can run `responder` from Windows, but I failed to pull it off. When I posted my [lessons learned on Commando](about:/2019/04/15/commando-vm-lessons.html#responder), @mcohmi suggested `Inveigh`:
