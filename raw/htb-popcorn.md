[HTB: Popcorn](/2020/06/23/htb-popcorn.html)

![Popcorn](https://0xdfimages.gitlab.io/img/popcorn-cover.webp)
...
[![Popcorn](/icons/box-popcorn.webp)](https://hackthebox.com/machines/popcorn)

[Popcorn](https://hackthebox.com/machines/popcorn)
...
Rated Difficulty ![Rated difficulty for Popcorn](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/popcorn-diff.webp)

Radar Graph ![Radar chart for Popcorn](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/popcorn-radar.webp)

User

21d 10:31:24 Root

21d 12:18:45 Creator ## Recon
...
![image-20200621114758759](https://0xdfimages.gitlab.io/img/image-20200621114758759.webp)
...
![image-20200621115424749](https://0xdfimages.gitlab.io/img/image-20200621115424749.webp)
...
![image-20200621115845409](https://0xdfimages.gitlab.io/img/image-20200621115845409.webp)
...
![image-20200621125729030](https://0xdfimages.gitlab.io/img/image-20200621125729030.webp)
...
![image-20200621120228848](https://0xdfimages.gitlab.io/img/image-20200621120228848.webp)

There’s an upload page, but it just redirects to the login form. There’s a Browse page, and it shows one torrent currently:

![image-20200621122823616](https://0xdfimages.gitlab.io/img/image-20200621122823616.webp)

I tried some guesses at login, but then clicked the Sign up link:

![image-20200621120342052](https://0xdfimages.gitlab.io/img/image-20200621120342052.webp)

It seems to work:

![image-20200621120358454](https://0xdfimages.gitlab.io/img/image-20200621120358454.webp)

And I can log in:

![image-20200621120440900](https://0xdfimages.gitlab.io/img/image-20200621120440900.webp)

Once logged in, I can get to the upload form:

![image-20200621120547278](https://0xdfimages.gitlab.io/img/image-20200621120547278.webp)

I tried uploading a PHP webshell, but it errors:

![image-20200621120644079](https://0xdfimages.gitlab.io/img/image-20200621120644079.webp)
...
![image-20200621123058432](https://0xdfimages.gitlab.io/img/image-20200621123058432.webp)

When I allow the redirect, I’m at the page for this torrent:

![image-20200621123221644](https://0xdfimages.gitlab.io/img/image-20200621123221644.webp)

If I click “Edit this torren”, a new form pops up:

![image-20200621123353559](https://0xdfimages.gitlab.io/img/image-20200621123353559.webp)

I can use this to upload the image associated with the torrent. If I provide it an image, It shows:

![image-20200621123501616](https://0xdfimages.gitlab.io/img/image-20200621123501616.webp)
...
![image-20200621123746462](https://0xdfimages.gitlab.io/img/image-20200621123746462.webp)
...
![image-20200621125015779](https://0xdfimages.gitlab.io/img/image-20200621125015779.webp)
