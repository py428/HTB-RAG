[HTB: SneakyMailer](/2020/11/28/htb-sneakymailer.html)

![SneakyMailer](https://0xdfimages.gitlab.io/img/sneakymailer-cover.webp)
...
[![SneakyMailer](/icons/box-sneakymailer.webp)](https://hackthebox.com/machines/sneakymailer)

[SneakyMailer](https://hackthebox.com/machines/sneakymailer)
...
Rated Difficulty ![Rated difficulty for SneakyMailer](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sneakymailer-diff.webp)

Radar Graph ![Radar chart for SneakyMailer](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sneakymailer-radar.webp)

User

00:45:53 Root

00:48:41 Creator ## Recon
...
![image-20200712110823736](https://0xdfimages.gitlab.io/img/image-20200712110823736.webp)
...
![image-20200712112129070](https://0xdfimages.gitlab.io/img/image-20200712112129070.webp)

### website - TCP 8080

Visiting TCP 8080 returns the default NGINX page:

![image-20200713064046492](https://0xdfimages.gitlab.io/img/image-20200713064046492.webp)
...
Given the theme of this box, it makes sense to use the list of emails to send a phish. I used `swaks` just like in [Endgame: Xen](about:/2020/06/17/endgame-xen.html#phishing-for-creds). I can include a list of recipients with the `--to` options, comma separated:
...
With creds for Paul, I can check his email. I can interact with IMAP manually with `nc` on port 143 (or if I want to use the TLS version on port 993, I can use `ncat` (which is `nc` is aliased to on my machine) with the `--ssl` option). I showed this similar process in [Chaos](about:/2019/05/25/htb-chaos.html#imap).
...
![image-20200712120008187](https://0xdfimages.gitlab.io/img/image-20200712120008187.webp)
...
![image-20200712120206798](https://0xdfimages.gitlab.io/img/image-20200712120206798.webp)
...
![image-20200712120328014](https://0xdfimages.gitlab.io/img/image-20200712120328014.webp)

In Sent Items, I see the emails about the password:

![image-20200712120405595](https://0xdfimages.gitlab.io/img/image-20200712120405595.webp)
...
![image-20200713064300814](https://0xdfimages.gitlab.io/img/image-20200713064300814.webp)
...
![image-20200713071533459](https://0xdfimages.gitlab.io/img/image-20200713071533459.webp)
...
This is the same privesc as [Canape](about:/2018/09/15/htb-canape.html#sudo-pip), and really, the same as the previous step, just way simpler. I’ll use Python’s webserver to host my `setup.py` file from the package, and use `wget` on SneakyMailer to save a copy in `/dev/shm`.
