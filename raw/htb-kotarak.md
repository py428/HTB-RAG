[HTB: Kotarak](/2021/05/19/htb-kotarak.html)

![Kotarak](https://0xdfimages.gitlab.io/img/kotarak-cover.webp)
...
[![Kotarak](/icons/box-kotarak.webp)](https://hackthebox.com/machines/kotarak)

[Kotarak](https://hackthebox.com/machines/kotarak)
...
Rated Difficulty ![Rated difficulty for Kotarak](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/kotarak-diff.webp)

Radar Graph ![Radar chart for Kotarak](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/kotarak-radar.webp)

User

07:36:13 Root

22:38:59 Creator ## Recon
...
![image-20210513172136703](https://0xdfimages.gitlab.io/img/image-20210513172136703.webp)

I can check the Tomcat manager page at `/manager/html`, but it wants username and password:

![image-20210513172356495](https://0xdfimages.gitlab.io/img/image-20210513172356495.webp)
...
![image-20210513173429593](https://0xdfimages.gitlab.io/img/image-20210513173429593.webp)
...
![image-20210513174032104](https://0xdfimages.gitlab.io/img/image-20210513174032104.webp)

`file_uploads` is on:

![image-20210513174221955](https://0xdfimages.gitlab.io/img/image-20210513174221955.webp)

This means if I can find an LFI, I can get RCE through the PHPInfo page like I showed in [Nineveh](about:/2020/04/22/htb-nineveh.html#shell-as-www-data-via-phpinfophp). I’ll keep an eye out for that.
...
![image-20210513174417628](https://0xdfimages.gitlab.io/img/image-20210513174417628.webp)
...
![image-20210514073306376](https://0xdfimages.gitlab.io/img/image-20210514073306376.webp)
...
![image-20210514073528155](https://0xdfimages.gitlab.io/img/image-20210514073528155.webp)
...
![image-20210514074103740](https://0xdfimages.gitlab.io/img/image-20210514074103740.webp)
...
![image-20210514090529954](https://0xdfimages.gitlab.io/img/image-20210514090529954.webp)

#### Generate WAR

To get a shell from here is relatively simple, just like in [Jerry](about:/2018/11/17/htb-jerry.html#exploiting-tomcat) and [Tabby](about:/2020/11/07/htb-tabby.html#text-based-manager) (though in Tabby I had to use the text-based manager instead of the html one because the user I leaked had only `manager-script`).
...
![image-20210514091040405](https://0xdfimages.gitlab.io/img/image-20210514091040405.webp)

On hitting Deploy, `/rev` now shows up as an application:

![image-20210514091140439](https://0xdfimages.gitlab.io/img/image-20210514091140439.webp)
...
![image-20210515061224000](https://0xdfimages.gitlab.io/img/image-20210515061224000.webp)
