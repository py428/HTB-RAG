[HTB: Magic](/2020/08/22/htb-magic.html)

![Magic](https://0xdfimages.gitlab.io/img/magic-cover.webp)
...
[![Magic](/icons/box-magic.webp)](https://hackthebox.com/machines/magic)

[Magic](https://hackthebox.com/machines/magic)
...
Rated Difficulty ![Rated difficulty for Magic](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/magic-diff.webp)

Radar Graph ![Radar chart for Magic](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/magic-radar.webp)

User

00:18:31 Root

00:32:48 Creator ## Recon
...
![image-20200419134553262](https://0xdfimages.gitlab.io/img/image-20200419134553262.webp)
...
![image-20200419134641200](https://0xdfimages.gitlab.io/img/image-20200419134641200.webp)
...
![image-20200419103136668](https://0xdfimages.gitlab.io/img/image-20200419103136668.webp)

If I try to upload `shell.php`, it returns:

![image-20200419103214741](https://0xdfimages.gitlab.io/img/image-20200419103214741.webp)

If I try to upload a PHP webshell named `shell.jpg`, it responds:

![image-20200419103320448](https://0xdfimages.gitlab.io/img/image-20200419103320448.webp)

If I upload a legitimate image file, at the top left, it reports it’s been uploaded:

![image-20200419134848846](https://0xdfimages.gitlab.io/img/image-20200419134848846.webp)

Back on `/index.php`, my image is there:

![image-20200419134922377](https://0xdfimages.gitlab.io/img/image-20200419134922377.webp)
...
![image-20200419140056407](https://0xdfimages.gitlab.io/img/image-20200419140056407.webp)
...
![image-20200419140552707](https://0xdfimages.gitlab.io/img/image-20200419140552707.webp)
...
![image-20200419140725925](https://0xdfimages.gitlab.io/img/image-20200419140725925.webp)
...
One of the things to verify was why `test.php.png` was handled by the webserver as PHP code and not as an image. [Networked](about:/2019/11/16/htb-networked.html#beyond-root---php-misconfiguration) had a similar issue.
