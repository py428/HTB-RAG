[HTB: Proper](/2021/08/21/htb-proper.html)

![Proper](https://0xdfimages.gitlab.io/img/proper-cover.webp)
...
[![Proper](/icons/box-proper.webp)](https://hackthebox.com/machines/proper)

[Proper](https://hackthebox.com/machines/proper)
...
Rated Difficulty ![Rated difficulty for Proper](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/proper-diff.webp)

Radar Graph ![Radar chart for Proper](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/proper-radar.webp)

User

02:30:43 Root

05:21:18 Creators   ## Recon
...
![image-20210226132522093](https://0xdfimages.gitlab.io/img/image-20210226132522093.webp)
...
![image-20210226155251961](https://0xdfimages.gitlab.io/img/image-20210226155251961.webp)
...
![image-20210316125420900](https://0xdfimages.gitlab.io/img/image-20210316125420900.webp)

But not only are the colors gone, but there’s an error dump in the HTML source:

![image-20210226155612962](https://0xdfimages.gitlab.io/img/image-20210226155612962.webp)
...
![image-20210226163536790](https://0xdfimages.gitlab.io/img/image-20210226163536790.webp)
...
[inotify-tools](https://github.com/inotify-tools/inotify-tools) is an awesome set of tools to monitoring for file access (`apt install inotify-tools`). I used `incron` (similar package) to automate some stuff on [ScriptKiddie](about:/2021/06/05/htb-scriptkiddie.html#incron). `inotify-wait` will hang until a file is accessed, and then return. So my first attempt to trick this page was to echo an ok string into `header.inc`, then `inotify-wait` for the file to be read the first time, and then replace the contents with a PHP payload. On refreshing the page, it runs:
...
![image-20210226164303521](https://0xdfimages.gitlab.io/img/image-20210226164303521.webp)
...
![image-20210226165626776](https://0xdfimages.gitlab.io/img/image-20210226165626776.webp)
...
![image-20210301164917343](https://0xdfimages.gitlab.io/img/image-20210301164917343.webp)

In `client.exe`, I went looking for the `Cleaning %s` string. It directed me here (Ida):

![image-20210301164426380](https://0xdfimages.gitlab.io/img/image-20210301164426380.webp)
...
![image-20210301201221954](https://0xdfimages.gitlab.io/img/image-20210301201221954.webp)
...
![image-20210301201307388](https://0xdfimages.gitlab.io/img/image-20210301201307388.webp)
...
![image-20210301203006885](https://0xdfimages.gitlab.io/img/image-20210301203006885.webp)
...
![image-20210316152720464](https://0xdfimages.gitlab.io/img/image-20210316152720464.webp)
...
![image-20210316151243797](https://0xdfimages.gitlab.io/img/image-20210316151243797.webp)
...
![image-20210316155405896](https://0xdfimages.gitlab.io/img/image-20210316155405896.webp)
