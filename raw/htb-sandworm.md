[HTB: Sandworm](/2023/11/18/htb-sandworm.html)

![Sandworm](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sandworm-cover.webp)
...
[![Sandworm](/icons/box-sandworm.webp)](https://hackthebox.com/machines/sandworm)

[Sandworm](https://hackthebox.com/machines/sandworm)
...
Rated Difficulty ![Rated difficulty for Sandworm](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sandworm-diff.webp)

Radar Graph ![Radar chart for Sandworm](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/sandworm-radar.webp)

User

00:48:19 Root

02:06:12 Creator ## Recon
...
Before looking at the site, I’ll take a more detailed look at the certificate.
 ...
 ![image-20231116095407801](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231116095407801.webp)![expand](/icons/expand.png)
...
Visiting the HTTPS site either by IP or by `ssa.htb` returns the same page. It’s the website of a spy agency:
 ...
 ![image-20231113204728949](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231113204728949.webp)![expand](/icons/expand.png)
...
![image-20231113205001800](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231113205001800.webp)

The link at the bottom goes to `/guide`:

 ![image-20231113205114643](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231113205114643.webp)![expand](/icons/expand.png)
...
3. Enter a public key and a signed message and it will tell you if it’s valid or not. There’s an example signed message. If I give it that message as well as the SSA’s key, it reports success:
	![image-20231113205509023](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231113205509023.webp)
...
![image-20231113205734824](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231113205734824.webp)

That’s the default Flask 404 page:

![image-20231113205837410](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231113205837410.webp)
...
![image-20231113211346784](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231113211346784.webp)
...
![image-20231114120139143](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114120139143.webp)
...
![image-20231114120329480](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114120329480.webp)

#### Decrypt

For the next example, I need to give them my public key, and they will return an encrypted message:

![image-20231114120505209](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114120505209.webp)
...
![image-20231114121205880](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114121205880.webp)

I’ll copy that block into the “Signed Test” block, and the SSA public key into the “Public Key” section:

![image-20231114121345016](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114121345016.webp)

Clicking verify signature pops a message showing it is valid:

![image-20231114121414157](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114121414157.webp)

If I change on letter in the signature (for example, the last “e” to “f”):

![image-20231114121453579](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114121453579.webp)

And resubmit, the popup shows failure:

![image-20231114121509829](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114121509829.webp)
...
![image-20231114122210912](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114122210912.webp)
...
![image-20231114124700702](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114124700702.webp)
...
![image-20231114125629361](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114125629361.webp)
...
![image-20231114130333970](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114130333970.webp)
...
![image-20231114155756147](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231114155756147.webp)
...
To understand what to hijack, I need to understand how `logger` is used in `tipnet`. For those unfamiliar with Rust, I did 27 videos solving the 2015 [Advent of Code](https://adventofcode.com/) challenges in Rust, available in a playlist [on YouTube](https://www.youtube.com/playlist?list=PLJt6nPUdQbiSLYLKKRfydWeMOBwOjzM2y). In [the introduction video](https://www.youtube.com/watch?v=lYyGDeinyrg&list=PLJt6nPUdQbiSLYLKKRfydWeMOBwOjzM2y&index=1&t=4s) for that series, I got over the basics of Rust, comparing it to Python, which might be nice background here.
...
![image-20231115072844509](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231115072844509.webp)
...
The [releases page](https://github.com/netblue30/firejail/releases) on GitHub shows that’s from Feb 6, 2022:
 ...
 ![image-20231115080407843](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20231115080407843.webp)![expand](/icons/expand.png)
...
> The following report describes a local root exploit vulnerability in Firejail \[1\] version 0.9.68 (and likely various older versions). Any source code references in this report are based on the 0.9.68 version tag in the upstream Git repository.

That seems to match. There’s also the first item in the changelog for the following release, 0.9.70:

> security: [CVE-2022-31214](https://github.com/advisories/GHSA-m2xv-wgqg-4gxh) - root escalation in –join logic Reported by Matthias Gerstner, working exploit code was provided to our development team. In the same time frame, the problem was independently reported by Birk Blechschmidt. Full working exploit code was also provided.

“Full working exploit code was also provided” is great to hear. I used this same exploit and script before on [Cerberus](about:/2023/07/29/htb-cerberus.html#escape).
...
![](https://www.youtube.com/watch?v=zfp7udPF8fs)
