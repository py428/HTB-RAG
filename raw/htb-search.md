[HTB: Search](/2022/04/30/htb-search.html)

![Search](https://0xdfimages.gitlab.io/img/search-cover.webp)
...
[![Search](/icons/box-search.webp)](https://hackthebox.com/machines/search)

[Search](https://hackthebox.com/machines/search)
...
Rated Difficulty ![Rated difficulty for Search](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/search-diff.webp)

Radar Graph ![Radar chart for Search](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/search-radar.webp)

User

00:25:39 Root

01:24:47 Creator ## Recon
...
![image-20211117114347963](https://0xdfimages.gitlab.io/img/image-20211117114347963.webp)
...
![image-20211116180041099](https://0xdfimages.gitlab.io/img/image-20211116180041099.webp)

Zooming in a bit:

![image-20211116180117960](https://0xdfimages.gitlab.io/img/image-20211116180117960.webp)
...
![image-20211116221652379](https://0xdfimages.gitlab.io/img/image-20211116221652379.webp)
...
![](https://www.youtube.com/watch?v=cChCGrBNqFg)
...
![image-20211117071207392](https://0xdfimages.gitlab.io/img/image-20211117071207392.webp)
...
![image-20211117094800899](https://0xdfimages.gitlab.io/img/image-20211117094800899.webp)

The Captured tab has some data in it:

![image-20211117094822813](https://0xdfimages.gitlab.io/img/image-20211117094822813.webp)

The Passwords 01082020 tab has 14 rows of first, last, and username:

![image-20211117094859908](https://0xdfimages.gitlab.io/img/image-20211117094859908.webp)

Column C is hidden, and trying to unhide it popus up:

![image-20211117094932577](https://0xdfimages.gitlab.io/img/image-20211117094932577.webp)
...
![image-20211117102101918](https://0xdfimages.gitlab.io/img/image-20211117102101918.webp)
...
![image-20211117102204031](https://0xdfimages.gitlab.io/img/image-20211117102204031.webp)
...
![image-20211117102315767](https://0xdfimages.gitlab.io/img/image-20211117102315767.webp)

And I can highlight columns B:D and right click:

![image-20211117102340746](https://0xdfimages.gitlab.io/img/image-20211117102340746.webp)

On selecting “Show Columns”, the passwords are there:

![image-20211117102411772](https://0xdfimages.gitlab.io/img/image-20211117102411772.webp)
...
![image-20211117114928990](https://0xdfimages.gitlab.io/img/image-20211117114928990.webp)

For either of these, it asks for a password that I don’t have:

![image-20211117110052205](https://0xdfimages.gitlab.io/img/image-20211117110052205.webp)
...
![image-20211117114907010](https://0xdfimages.gitlab.io/img/image-20211117114907010.webp)

Now if on visiting or refreshing `https://search.htb/staff` (must be HTTPS), it asks for a certificate to send:

![image-20211117115137616](https://0xdfimages.gitlab.io/img/image-20211117115137616.webp)

On clicking OK, Firefox presents a PowerShell Web Access page:

![image-20211117115225346](https://0xdfimages.gitlab.io/img/image-20211117115225346.webp)

### PowerShell

I’ll enter sierra.frye’s creds into the form. For computer name, I tried a handful of things. The IP doesn’t work:

![image-20211117115648378](https://0xdfimages.gitlab.io/img/image-20211117115648378.webp)

Trying different things, “research” works:

![image-20211117115727725](https://0xdfimages.gitlab.io/img/image-20211117115727725.webp)
...
![image-20211117122421371](https://0xdfimages.gitlab.io/img/image-20211117122421371.webp)
