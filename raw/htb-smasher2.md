[HTB: Smasher2](/2019/12/14/htb-smasher2.html)

![Smasher2](https://0xdfimages.gitlab.io/img/smasher2-cover.webp)
...
[![Smasher2](/icons/box-smasher2.webp)](https://hackthebox.com/machines/smasher2)

[Smasher2](https://hackthebox.com/machines/smasher2)
...
Rated Difficulty ![Rated difficulty for Smasher2](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/smasher2-diff.webp)

Radar Graph ![Radar chart for Smasher2](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/smasher2-radar.webp)

User

07:13:55 Root

20:29:49 Creators   ## Recon
...
![1559453182593](https://0xdfimages.gitlab.io/img/1559453182593.webp)
...
![1561813020162](https://0xdfimages.gitlab.io/img/1561813020162.webp)
...
![1561813183522](https://0xdfimages.gitlab.io/img/1561813183522.webp)
...
![](https://0xdfimages.gitlab.io/img/smasher-wsm-root.webp)

#### Login Page

At the top there’s a “Try Login” button. It goes to a login page:

![1561815425579](https://0xdfimages.gitlab.io/img/1561815425579.webp)
...
![1570903084609](https://0xdfimages.gitlab.io/img/1570903084609.webp)
...
Knowing that `PyVarObject_HEAD_INIT` [expands to](https://docs.python.org/2/c-api/structures.html) `1, type, size,`, and assuming that each word is 8 bytes, 0x30 bytes in is `(destructor)dictiter_dealloc`.
...
![1570906220495](https://0xdfimages.gitlab.io/img/1570906220495.webp)

If it matches, it continues here, where it calls `get_internal_pwd` and compares the user input password to the result:

![1570906095855](https://0xdfimages.gitlab.io/img/1570906095855.webp)
...
![1561816019417](https://0xdfimages.gitlab.io/img/1561816019417.webp)
...
[This paper](https://labs.mwrinfosecurity.com/assets/BlogFiles/mwri-mmap-exploitation-whitepaper-2017-09-18.pdf) from F-Secure does a really great job of breaking down what an mmap handler is, and how to find issues in it. In section 4 (on page 15), it goes into how to exploit them. It gives an example, which I’ll try to apply here and see how far I can get. The idea is that I will use the mmap handler to look through memory to find a credential structure (`struct cred`), which is defined [on Bootlin](https://elixir.bootlin.com/linux/latest/source/include/linux/cred.h):
