[HTB: Querier](/2019/06/22/htb-querier.html)

![Querier-cover](https://0xdfimages.gitlab.io/img/querier-cover.webp)
...
[![Querier](/icons/box-querier.webp)](https://hackthebox.com/machines/querier)

[Querier](https://hackthebox.com/machines/querier)
...
Rated Difficulty ![Rated difficulty for Querier](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/querier-diff.webp)

Radar Graph ![Radar chart for Querier](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/querier-radar.webp)

User

00:45:30 Root

01:29:02 Creators   ## Recon
...
In the box that Querier replaced, [Giddy](about:/2019/02/16/htb-giddy.html#get-net-ntlm), there was an SQL injection in a SQL Server instance where I used the `xp_dirtree` command to get it to connect to me over SMB where I was listening with `responder` to capture the Net-NTLMv2. (note posts on ntlmv2 and giddy). I’ll do the same thing here, just with direct access instead of SQLi.
...
Over to `hashcat` where I’ll try to brute force the password. I can find the hash type [on the Hashcat wiki](https://hashcat.net/wiki/doku.php?id=example_hashes) or with a simple `grep` on the help page:
...
![Querier Shell image](https://0xdfimages.gitlab.io/img/querier-shell.gif)
