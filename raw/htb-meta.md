[HTB: Meta](/2022/06/11/htb-meta.html)

![Meta](https://0xdfimages.gitlab.io/img/meta-cover.webp)
...
[![Meta](/icons/box-meta.webp)](https://hackthebox.com/machines/meta)

[Meta](https://hackthebox.com/machines/meta)
...
Rated Difficulty ![Rated difficulty for Meta](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/meta-diff.webp)

Radar Graph ![Radar chart for Meta](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/meta-radar.webp)

User

00:37:25 Root

00:44:21 Creator ## Recon
...
![image-20220603150929302](https://0xdfimages.gitlab.io/img/image-20220603150929302.webp)

The link goes to `/metaview/`, which is an app that returns metadata about an image:

![image-20220603151010340](https://0xdfimages.gitlab.io/img/image-20220603151010340.webp)

If I give it a file, it returns some metadata about the file:

![image-20220603151157669](https://0xdfimages.gitlab.io/img/image-20220603151157669.webp)
...
![image-20220603160441568](https://0xdfimages.gitlab.io/img/image-20220603160441568.webp)
...
![image-20220603162451231](https://0xdfimages.gitlab.io/img/image-20220603162451231.webp)
...
![image-20220603173927759](https://0xdfimages.gitlab.io/img/image-20220603173927759.webp)

Running it with `sudo` shows root as the user:

![image-20220603173959851](https://0xdfimages.gitlab.io/img/image-20220603173959851.webp)
