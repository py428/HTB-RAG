[HTB: PlayerTwo](/2020/06/27/htb-playertwo.html)

![PlayerTwo](https://0xdfimages.gitlab.io/img/playertwo-cover.webp)
...
[![PlayerTwo](/icons/box-playertwo.webp)](https://hackthebox.com/machines/playertwo)

[PlayerTwo](https://hackthebox.com/machines/playertwo)
...
Rated Difficulty ![Rated difficulty for PlayerTwo](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/playertwo-diff.webp)

Radar Graph ![Radar chart for PlayerTwo](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/playertwo-radar.webp)

User

04:01:09 Root

03:58:27 Creators   ## Recon
...
![image-20200122212950773](https://0xdfimages.gitlab.io/img/image-20200122212950773.webp)
...
![image-20200122213135627](https://0xdfimages.gitlab.io/img/image-20200122213135627.webp)

When I put in incorrect info, it just returns a pop-up and redirects back to the form:

![image-20200122213202865](https://0xdfimages.gitlab.io/img/image-20200122213202865.webp)
...
[Twirp](https://github.com/twitchtv/twirp) is an API framework from Twitchtv, written in Go. The idea is that you can define your service in a Protobuf file, as defined [in the Google docs](https://developers.google.com/protocol-buffers/docs/proto3), and then it stands up the API based on that. The [example.proto file](https://github.com/twitchtv/twirp/blob/master/example/service.proto) is:
...
![image-20200120143539175](https://0xdfimages.gitlab.io/img/image-20200120143539175.webp)

When I submit `123456`, I get the same `alert` box:

![image-20200120143808771](https://0xdfimages.gitlab.io/img/image-20200120143808771.webp)
...
> 
> A device designed to provide a real visual experience for most of the games on market. We are improvising more features which has never been provided by other devices till date.
...
![image-20200122065751511](https://0xdfimages.gitlab.io/img/image-20200122065751511.webp)
...
![image-20200122065821275](https://0xdfimages.gitlab.io/img/image-20200122065821275.webp)
...
![image-20200122070522190](https://0xdfimages.gitlab.io/img/image-20200122070522190.webp)
...
![image-20200122070725172](https://0xdfimages.gitlab.io/img/image-20200122070725172.webp)
...
![image-20200122174643921](https://0xdfimages.gitlab.io/img/image-20200122174643921.webp)

This should invalidate the signature. I rebuilt the archive, and uploaded:

![image-20200122174723557](https://0xdfimages.gitlab.io/img/image-20200122174723557.webp)
...
![image-20200122174920358](https://0xdfimages.gitlab.io/img/image-20200122174920358.webp)

Much to my surprise, it passed the test entirely.

![image-20200122204854450](https://0xdfimages.gitlab.io/img/image-20200122204854450.webp)
...
![image-20200122205815988](https://0xdfimages.gitlab.io/img/image-20200122205815988.webp)
...
![image-20200122210251592](https://0xdfimages.gitlab.io/img/image-20200122210251592.webp)
...
Luckily for me, I had just recently completed a [challenge involving MQTT](about:/hackvent2019/hard#day-15) in Hackvent 2019. I grabbed the code I used for that challenge, and chopped out the password and transport, basically resetting it to the default connect. After updating the port/ip, I had the following:
...
On a normal elf (for example, the `garbage` binary from [Ellingson](about:/2019/10/19/htb-ellingson.html#priv-margo--root)), that looks like this:
...
![image-20200130103723604](https://0xdfimages.gitlab.io/img/image-20200130103723604.webp)
...
![image-20200204214532760](https://0xdfimages.gitlab.io/img/image-20200204214532760.webp)
...
![image-20200204214921990](https://0xdfimages.gitlab.io/img/image-20200204214921990.webp)
...
![image-20200627100643712](https://0xdfimages.gitlab.io/img/image-20200627100643712.webp)
...
![image-20200624081713734](https://0xdfimages.gitlab.io/img/image-20200624081713734.webp)
...
![image-20200624081839473](https://0xdfimages.gitlab.io/img/image-20200624081839473.webp)
...
![image-20200210204453311](https://0xdfimages.gitlab.io/img/image-20200210204453311.webp)
