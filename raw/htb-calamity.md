[HTB: Calamity](/2020/08/27/htb-calamity.html)

![Calamity](https://0xdfimages.gitlab.io/img/calamity-cover.webp)
...
[![Calamity](/icons/box-calamity.webp)](https://hackthebox.com/machines/calamity)

[Calamity](https://hackthebox.com/machines/calamity)
...
Rated Difficulty ![Rated difficulty for Calamity](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/calamity-diff.webp)

Radar Graph ![Radar chart for Calamity](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/calamity-radar.webp)

User

00:26:43 Root

4d 01:55:12 Creator ## Recon
...
![image-20200824065629081](https://0xdfimages.gitlab.io/img/image-20200824065629081.webp)
...
![image-20200824070032156](https://0xdfimages.gitlab.io/img/image-20200824070032156.webp)

Entering wrong creds (like admin / admin) just prints a message:

![image-20200824070101082](https://0xdfimages.gitlab.io/img/image-20200824070101082.webp)
...
![image-20200824071443934](https://0xdfimages.gitlab.io/img/image-20200824071443934.webp)
...
![image-20200824071645798](https://0xdfimages.gitlab.io/img/image-20200824071645798.webp)

Entering PHP seems to evaluate, such as `<?php echo "test"; ?>` just prints “test”:

![image-20200824071739021](https://0xdfimages.gitlab.io/img/image-20200824071739021.webp)
...
![image-20200824102426481](https://0xdfimages.gitlab.io/img/image-20200824102426481.webp)
...
![image-20200824140653892](https://0xdfimages.gitlab.io/img/image-20200824140653892.webp)
...
![image-20200824143338964](https://0xdfimages.gitlab.io/img/image-20200824143338964.webp)
...
![image-20200824143858647](https://0xdfimages.gitlab.io/img/image-20200824143858647.webp)
...
I’ve shown this privesc a [couple times](about:/tags.html#lxd) (see [Obscurity](about:/2020/05/09/htb-obscurity.html#patched-path-4-lxd) and [Mischief](about:/2019/01/05/htb-mischief.html#option-3---lxc-patched)). It works here too, but I won’t show it. I’ll focus on the intended way.
...
These are calls to `mprotect`, which is defined [in the man pages](https://www.man7.org/linux/man-pages/man2/mprotect.2.html). This function will the permissions on sections of memory. I’ll dig into this more in [Beyond Root](#beyond-root), but for now, I’ll just note the address of `mprotect`, as I’ll need it later.

#### Small Overflow

I spent a minute looking at the disassembly for `createusername`. The stack frame for this function looks like:

![image-20200825172142313](https://0xdfimages.gitlab.io/img/image-20200825172142313.webp)
...
![image-20200826060301644](https://0xdfimages.gitlab.io/img/image-20200826060301644.webp)
...
![image-20200826060321674](https://0xdfimages.gitlab.io/img/image-20200826060321674.webp)
...
![](https://www.youtube.com/watch?v=79mUGY3-dJQ)
...
While I’ve already shown I can get a shell by making the stack executable and then jumping to my shellcode, my initial instinct was to use a return to libc attack. I walked through a lot of detail as to how this works in [Frolic](about:/2019/03/23/htb-frolic.html#background). Because I don’t have ASLR to contend with, the addresses in libc are static. I can find them in `gdb`:
