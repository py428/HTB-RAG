![Noter](https://0xdfimages.gitlab.io/img/noter-cover.webp)
...
[![Noter](/icons/box-noter.webp)](https://hackthebox.com/machines/noter)

[Noter](https://hackthebox.com/machines/noter)
...
Rated Difficulty ![Rated difficulty for Noter](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/noter-diff.webp)

Radar Graph ![Radar chart for Noter](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/noter-radar.webp)

User

00:26:44 Root

00:26:38 Creator ## Recon
...
![image-20220901144626269](https://0xdfimages.gitlab.io/img/image-20220901144626269.webp)

The “Home” and “Notes” links just redirect to `/login`, which presents a form:

![image-20220329201716395](https://0xdfimages.gitlab.io/img/image-20220329201716395.webp)

No matter what I put in, it returns “Invalid Credentials” over the form:

![image-20220329201802455](https://0xdfimages.gitlab.io/img/image-20220329201802455.webp)

Basic SQL injections don’t show any promise.

I’ll register an account on the site at `/register`:

![image-20220329202220792](https://0xdfimages.gitlab.io/img/image-20220329202220792.webp)

It redirects to `/login` with a banner:

![image-20220329202248355](https://0xdfimages.gitlab.io/img/image-20220329202248355.webp)
...
![image-20220330063505433](https://0xdfimages.gitlab.io/img/image-20220330063505433.webp)

When I change that to 0xdf with the wrong password:

![image-20220330063613983](https://0xdfimages.gitlab.io/img/image-20220330063613983.webp)
...
![image-20220901145032786](https://0xdfimages.gitlab.io/img/image-20220901145032786.webp)
...
![image-20220329202458665](https://0xdfimages.gitlab.io/img/image-20220329202458665.webp)

It shows up on my dashboard:

![image-20220329202519942](https://0xdfimages.gitlab.io/img/image-20220329202519942.webp)

I’ll try various XSS payloads, but everything seems to render correctly escaped.

“Notes” (`/notes`) shows my note now:

![image-20220329202613763](https://0xdfimages.gitlab.io/img/image-20220329202613763.webp)

Clicking on it leads to `/note/3` and shows the note:

![image-20220329202634899](https://0xdfimages.gitlab.io/img/image-20220329202634899.webp)
...
![image-20220330091900394](https://0xdfimages.gitlab.io/img/image-20220330091900394.webp)
...
![image-20220329212628103](https://0xdfimages.gitlab.io/img/image-20220329212628103.webp)
...
![image-20220330063228612](https://0xdfimages.gitlab.io/img/image-20220330063228612.webp)
...
I can dig into the `flask-unsign` source a bit and trace what’s happening when I call it with `--sign`. It ends up [on GitHub](https://github.com/Paradoxis/Flask-Unsign/blob/e934573b2bcc3cfd58769e93e6761d0a9d3f21ab/flask_unsign/session.py#L121-L142):
...
![image-20220330124752022](https://0xdfimages.gitlab.io/img/image-20220330124752022.webp)
...
![image-20220330124908270](https://0xdfimages.gitlab.io/img/image-20220330124908270.webp)
...
![image-20220330124939388](https://0xdfimages.gitlab.io/img/image-20220330124939388.webp)

I’ve already looked at “Before the weekend”. The other one is from the Noter team:

![image-20220330125011092](https://0xdfimages.gitlab.io/img/image-20220330125011092.webp)
...
![image-20220330152743772](https://0xdfimages.gitlab.io/img/image-20220330152743772.webp)
