[HTB: Shibboleth](/2022/04/02/htb-shibboleth.html)

![Shibboleth](https://0xdfimages.gitlab.io/img/shibboleth-cover.webp)
...
[![Shibboleth](/icons/box-shibboleth.webp)](https://hackthebox.com/machines/shibboleth)

[Shibboleth](https://hackthebox.com/machines/shibboleth)
...
Rated Difficulty ![Rated difficulty for Shibboleth](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/shibboleth-diff.webp)

Radar Graph ![Radar chart for Shibboleth](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/shibboleth-radar.webp)

User

00:46:03 Root

01:15:19 Creators   ## Recon
...
![image-20220330211542781](https://0xdfimages.gitlab.io/img/image-20220330211542781.webp)

At the very bottom of the page is a clue:

![image-20220330211059288](https://0xdfimages.gitlab.io/img/image-20220330211059288.webp)
...
![image-20220330211820391](https://0xdfimages.gitlab.io/img/image-20220330211820391.webp)
...
![image-20220331100028573](https://0xdfimages.gitlab.io/img/image-20220331100028573.webp)
...
![image-20220331063445469](https://0xdfimages.gitlab.io/img/image-20220331063445469.webp)
...
![image-20220331064855568](https://0xdfimages.gitlab.io/img/image-20220331064855568.webp)
...
![image-20220331073528651](https://0xdfimages.gitlab.io/img/image-20220331073528651.webp)

After about 5 seconds, the website shows an error:

![image-20220331073551485](https://0xdfimages.gitlab.io/img/image-20220331073551485.webp)
...
I had this same issue on [Zipper](about:/2019/02/23/htb-zipper.html#stable-shell). There, I solved it by having my listener set up to issue commands back that generated a new shell in a new Perl process. I did test that, and it works here, but it’s unnecessary.
...
![image-20220331083231127](https://0xdfimages.gitlab.io/img/image-20220331083231127.webp)
...
> Exploit Title: MariaDB 10.2 /MySQL - ‘wsrep\_provider’ OS Command Execution Date: 03/18/2021 Exploit Author: Central InfoSec Version:
> 
...
> - 10.5 before 10.5.9
> 
> Percona Server through 2021-03-03; and the wsrep patch through 2021-03-03 for MySQL Tested on: Linux CVE: CVE-2021-27928
...
![](https://www.youtube.com/watch?v=zk1xmUj9rZA)
