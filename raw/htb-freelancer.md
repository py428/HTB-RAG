[HTB: Freelancer](/2024/10/05/htb-freelancer.html)

![Freelancer](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/freelancer-cover.webp)
...
[![Freelancer](/icons/box-freelancer.webp)](https://hackthebox.com/machines/freelancer)

[Freelancer](https://hackthebox.com/machines/freelancer)
...
Rated Difficulty ![Rated difficulty for Freelancer](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/freelancer-diff.webp)

Radar Graph ![Radar chart for Freelancer](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/freelancer-radar.webp)

User

01:50:42 Root

02:50:03 Creator ## Recon
...
The site is for a jobs platform:
 ...
 ![image-20240607121244635](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607121244635.webp)![expand](/icons/expand.png)
...
![image-20240607133521310](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607133521310.webp)

In addition to name, email, username, the form also asks for security questions:

![image-20240607133636865](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607133636865.webp)

I’ll create an account, and when I try to log in, it fails:

![image-20240607133757801](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607133757801.webp)
...
I’ll register a freelancer account. I can’t use the same username or email I used with my employer account, as it’s already taken. I also need to provide security questions. On succeeding, I’m redirected to the login page, and on logging in, to `/job/search`:
 ...
 ![image-20240607134117210](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607134117210.webp)![expand](/icons/expand.png)

I’m able to view jobs, and clicking “Apply for job” just returns:

![image-20240607134225892](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607134225892.webp)
...
![image-20240607134346409](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607134346409.webp)
...
The 404 page is custom to the site as well:
 ...
 ![image-20240607135341666](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607135341666.webp)![expand](/icons/expand.png)

Wappalyzer does identify the site as running the Python Django framework:

![image-20240607140516491](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607140516491.webp)
...
![image-20240607135101323](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607135101323.webp)
...
![image-20240607140715595](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607140715595.webp)

The “Forgot your password” link leads to a form asking the security questions:

![image-20240607140817623](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607140817623.webp)
...
![image-20240607141140315](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607141140315.webp)

After resetting the password, I’m able to log in as the employer:

![image-20240607141219855](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607141219855.webp)
...
![image-20240607141330084](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607141330084.webp)
...
![image-20240607141728973](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607141728973.webp)
...
![image-20240607141545250](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607141545250.webp)

The source for the qr-code is actually to a dynamic endpoint to generate qr-codes:

![image-20240607142256110](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607142256110.webp)
...
![image-20240607143445689](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607143445689.webp)
...
![image-20240607145012104](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607145012104.webp)

While logged in as admin, visiting `/admin` returns the admin dashboard:

![image-20240607145055171](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607145055171.webp)

#### Admin Enumeration

Looking around the admin panel, there’s a list of email addresses under “Custom users”:

![image-20240607150914148](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607150914148.webp)
...
![image-20240607151106841](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607151106841.webp)

I can try a query, and the results show up below:

![image-20240607151134505](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607151134505.webp)
...
![image-20240607151546786](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607151546786.webp)

I’ll run `select name from sys.tables;` to list the tables:

![image-20240607151742285](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607151742285.webp)
...
![image-20240607152325525](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607152325525.webp)

It’s disabled. I can try to enable it:

![image-20240607152430923](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607152430923.webp)
...
![image-20240607152518684](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607152518684.webp)
...
![image-20240607152956355](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607152956355.webp)
...
![image-20240607153323703](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607153323703.webp)
...
![image-20240607153920813](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607153920813.webp)

#### xp\_cmdshell Success

With access to `EXECUTE AS` for the sa (administrator) user, I’ll enable `xp_cmdshell`:

![image-20240607154041021](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607154041021.webp)

No results is a significant improvement over the errors last time. I still can’t run commands as the original user:

![image-20240607155023436](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607155023436.webp)

But with impersonation I can:

![image-20240607154213539](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607154213539.webp)
...
![image-20240607154349843](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607154349843.webp)
...
![image-20240607155311494](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607155311494.webp)
...
![image-20240607155539209](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607155539209.webp)
...
![image-20240607155626632](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607155626632.webp)

I’ll trigger it to get a shell:

![image-20240607155708985](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240607155708985.webp)
...
![image-20240608070117775](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240608070117775.webp)

The most interesting as an attacker is:

![image-20240608070711091](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240608070711091.webp)

As a member of the AD Recycle Bin group, Lorra199 has `GenericWrite` over the DC. This is the same path I showed on [Support](about:/2022/12/17/htb-support.html#shell-as-domainadmin).
...
![image-20240608071229267](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240608071229267.webp)
...
I’ve exploited this a couple times before, most recently on [BlackField](about:/2020/10/03/htb-blackfield.html#). On Blackfield, I showed the exploit using compiled DLLs. Here I’ll exploit it by getting a backup copy of `ntds.dit` using `diskshadow`.
...
![image-20240930182029620](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240930182029620.webp)
...
![image-20240930182201667](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240930182201667.webp)
...
![image-20240930182313473](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240930182313473.webp)
...
![image-20240930182534435](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240930182534435.webp)

A ways down, there’s a plaintext password, “v3ryS0l!dP@sswd#29”:

![image-20240930182628393](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240930182628393.webp)
...
![image-20240930190001295](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240930190001295.webp)
