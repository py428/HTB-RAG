[HTB: Omni](/2021/01/09/htb-omni.html)

![Omni](https://0xdfimages.gitlab.io/img/omni-cover.webp)
...
[![Omni](/icons/box-omni.webp)](https://hackthebox.com/machines/omni)

[Omni](https://hackthebox.com/machines/omni)
...
Rated Difficulty ![Rated difficulty for Omni](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/omni-diff.webp)

Radar Graph ![Radar chart for Omni](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/omni-radar.webp)
...
The ports and versions do seem to indicate it’s Windows, but it doesn’t look like normal Windows. Some Googling based on the above results on this suggests this box is running [Windows IOT Core](https://developer.microsoft.com/en-us/windows/iot/) (like [in this Black Hat paper](https://www.blackhat.com/docs/us-16/materials/us-16-Sabanal-Into-The-Core-In-Depth-Exploration-Of-Windows-10-IoT-Core-wp.pdf) and [on the MSDN forums](https://social.msdn.microsoft.com/Forums/vstudio/en-US/75314423-de13-4eff-bd15-0fec8b9c1da4/ports-open?forum=WindowsIoT)).

### Website - TCP 8080

Visiting pops a prompt for “Windows Device Portal”:

![image-20200823181108888](https://0xdfimages.gitlab.io/img/image-20200823181108888.webp)
...
![image-20200823224520133](https://0xdfimages.gitlab.io/img/image-20200823224520133.webp)
...
![image-20200823223044284](https://0xdfimages.gitlab.io/img/image-20200823223044284.webp)

I could work out of here, but I’ll pivot to a `nc.exe` shell for convenience:

![image-20200823223139648](https://0xdfimages.gitlab.io/img/image-20200823223139648.webp)
...
![image-20200823224139097](https://0xdfimages.gitlab.io/img/image-20200823224139097.webp)
