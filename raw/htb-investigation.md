[HTB: Investigation](/2023/04/22/htb-investigation.html)

![Investigation](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/investigation-cover.webp)
...
[![Investigation](/icons/box-investigation.webp)](https://hackthebox.com/machines/investigation)

[Investigation](https://hackthebox.com/machines/investigation)
...
Rated Difficulty ![Rated difficulty for Investigation](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/investigation-diff.webp)

Radar Graph ![Radar chart for Investigation](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/investigation-radar.webp)

User

00:17:46 Root

00:23:49 Creator ## Recon
...
[![image-20230418073051838](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418073051838.png)](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418073051838.png)

[*Click for full image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418073051838.png)
...
![image-20230418083703426](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418083703426.webp)

On giving it a JPG, it offers a link to a “report”:

![image-20230418083736570](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418083736570.webp)
...
![image-20230418091540922](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418091540922.webp)

The issue, as described in [this gist](https://gist.github.com/ert-plus/1414276e4cb5d56dd431c2f0429e4429), is in how Perl handles filenames ending in `|` with the `open` command. In [Pikaboo](about:/2021/12/04/htb-pikaboo.html#exploit-cvsupdate) I walked through abusing this on a script that was using Perl’s `<>` operator, which is a shorthand that includes a call to `open`. Exiftool is written in Perl, and before version 12.38, was missing that the filename (user controlled) could be used to get command execution.

There’s a different CVE in Exiftool that I exploited in [Meta](about:/2022/06/11/htb-meta.html#exiftool-exploit), CVE-2021-22204. That one involved poisoning the metadata, not the filename.
...
![](https://www.youtube.com/watch?v=UiRx1Zkeqzg)
...
![image-20230418125028031](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418125028031.webp)
...
![image-20230418125705292](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418125705292.webp)
...
![image-20230418132654341](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418132654341.webp)

I’ll hit enter to go into the email:

![image-20230418132729865](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418132729865.webp)

There’s a message from Tom and an attachment. I’ll hit `v` to view the attachments:

![image-20230418132808989](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230418132808989.webp)
