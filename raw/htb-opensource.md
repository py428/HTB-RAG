[HTB: OpenSource](/2022/10/08/htb-opensource.html)

![OpenSource](https://0xdfimages.gitlab.io/img/opensource-cover.webp)
...
[![OpenSource](/icons/box-opensource.webp)](https://hackthebox.com/machines/opensource)

[OpenSource](https://hackthebox.com/machines/opensource)
...
Rated Difficulty ![Rated difficulty for OpenSource](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/opensource-diff.webp)

Radar Graph ![Radar chart for OpenSource](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/opensource-radar.webp)

User

00:57:03 Root

01:39:17 Creator ## Recon
...
![image-20220929152248265](https://0xdfimages.gitlab.io/img/image-20220929152248265.webp)
...
![image-20220929153730986](https://0xdfimages.gitlab.io/img/image-20220929153730986.webp)
...
![image-20220929161138316](https://0xdfimages.gitlab.io/img/image-20220929161138316.webp)
...
![image-20220929171317866](https://0xdfimages.gitlab.io/img/image-20220929171317866.webp)
...
![image-20220929174122288](https://0xdfimages.gitlab.io/img/image-20220929174122288.webp)

Clicking on the terminal pops a prompt for a pin to access it:

![image-20220929174204672](https://0xdfimages.gitlab.io/img/image-20220929174204672.webp)
...
![image-20220930063345466](https://0xdfimages.gitlab.io/img/image-20220930063345466.webp)
...
![](https://www.youtube.com/watch?v=Cife4ejJGlo)
...
The change is made [on GitHub](https://github.com/pallets/werkzeug/commit/11ba286a1b907110a2d36f5c05740f239bc7deed#diff-83867b1c4c9b75c728654ed284dc98f7c8d4e8bd682fc31b977d122dd045178a).
...
![image-20220930074512302](https://0xdfimages.gitlab.io/img/image-20220930074512302.webp)

#### Reverse Shell

With that shell, I can run OS commands with the `subprocess` module:

![image-20220930074749921](https://0xdfimages.gitlab.io/img/image-20220930074749921.webp)
...
![image-20220930075036345](https://0xdfimages.gitlab.io/img/image-20220930075036345.webp)
...
![image-20220930085329050](https://0xdfimages.gitlab.io/img/image-20220930085329050.webp)
...
![image-20220930085456633](https://0xdfimages.gitlab.io/img/image-20220930085456633.webp)

There’s a repo called home-backup, and it looks to be a backup of the account’s home directory:

![image-20220930085531653](https://0xdfimages.gitlab.io/img/image-20220930085531653.webp)
...
[Git hooks](https://git-scm.com/book/en/v2/Customizing-Git-Git-Hooks) are scripts that are run on various events in a git repository. I’ve looked at Git hooks before as an unintended path on [Bitlab](about:/2020/01/11/htb-bitlab.html#unintended-path-from-www-data-to-root).
