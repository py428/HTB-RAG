[HTB: Mentor](/2023/03/11/htb-mentor.html)

![Mentor](https://0xdfimages.gitlab.io/img/mentor-cover.webp)
...
[![Mentor](/icons/box-mentor.webp)](https://hackthebox.com/machines/mentor)

[Mentor](https://hackthebox.com/machines/mentor)
...
Rated Difficulty ![Rated difficulty for Mentor](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/mentor-diff.webp)

Radar Graph ![Radar chart for Mentor](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/mentor-radar.webp)

User

01:05:06 Root

02:01:10 Creator ## Recon
...
![](https://www.youtube.com/watch?v=fzl9g0ZgON8)
...
Visiting a page I expect to 404, it shows the [default Flask 404](about:/2023/03/04/htb-forgot.html#tech-stack):

![image-20230228113011580](https://0xdfimages.gitlab.io/img/image-20230228113011580.webp)
...
![image-20230228162308308](https://0xdfimages.gitlab.io/img/image-20230228162308308.webp)

If I add it in Burp Repeater with a dummy value, it crashes the server:

![image-20230228153614477](https://0xdfimages.gitlab.io/img/image-20230228153614477.webp)
...
![image-20230228162845007](https://0xdfimages.gitlab.io/img/image-20230228162845007.webp)

Both return 422 Unprocessable Entity, which isn’t in the match list for `feroxbuster` (worth being aware of). \[Update: `feroxbuster` updates makes this more reliable - check out [this video](https://www.youtube.com/watch?v=d4tYWJzZ8QE).\]
...
![image-20230228170044189](https://0xdfimages.gitlab.io/img/image-20230228170044189.webp)
...
![image-20230228170259014](https://0xdfimages.gitlab.io/img/image-20230228170259014.webp)
...
![image-20230228170400947](https://0xdfimages.gitlab.io/img/image-20230228170400947.webp)

If I take that username, password, and email combination back to the `/auth/login` endpoint, it works and returns a token:

![image-20230228170506895](https://0xdfimages.gitlab.io/img/image-20230228170506895.webp)
...
![image-20230228163549424](https://0xdfimages.gitlab.io/img/image-20230228163549424.webp)
...
![image-20230228171140852](https://0xdfimages.gitlab.io/img/image-20230228171140852.webp)
...
![image-20230228164156513](https://0xdfimages.gitlab.io/img/image-20230228164156513.webp)

I can read quotes over this endpoint:

![image-20230228171310349](https://0xdfimages.gitlab.io/img/image-20230228171310349.webp)

There’s nothing useful here.

### snmp - UDP 161

My [sneaky post](about:/2021/03/02/htb-sneaky.html#snmp---udp-161) has all the details for getting `snmpwalk` installed and configured. I’ll try the standard community string, “public”, and it does return data, though only about 47 lines, and nothing interesting:
...
This password with james’ name and email from [above](#admin) returns an auth token as james:
 ...
 ![image-20230301114849067](https://0xdfimages.gitlab.io/img/image-20230301114849067.webp)![image-20230301114857362](https://0xdfimages.gitlab.io/img/image-20230301114857362.webp)

The token itself doesn’t say anything about being an admin or not (shown here in [jwt.io](https://jwt.io/)):

![image-20230301115149882](https://0xdfimages.gitlab.io/img/image-20230301115149882.webp)
...
![image-20230301115228487](https://0xdfimages.gitlab.io/img/image-20230301115228487.webp)
...
![image-20230301135227026](https://0xdfimages.gitlab.io/img/image-20230301135227026.webp)
...
![image-20230301135428600](https://0xdfimages.gitlab.io/img/image-20230301135428600.webp)
...
![image-20230301135631156](https://0xdfimages.gitlab.io/img/image-20230301135631156.webp)

Sending a POST to `/admin/backup` returns a 422 error:

![image-20230301135712997](https://0xdfimages.gitlab.io/img/image-20230301135712997.webp)
...
![image-20230301135829383](https://0xdfimages.gitlab.io/img/image-20230301135829383.webp)

No matter what I put into a `path` field, it returns “Done!”:

![image-20230301135922522](https://0xdfimages.gitlab.io/img/image-20230301135922522.webp)
...
![image-20230301141328847](https://0xdfimages.gitlab.io/img/image-20230301141328847.webp)
...
![image-20230301154814543](https://0xdfimages.gitlab.io/img/image-20230301154814543.webp)
...
![image-20230301154956271](https://0xdfimages.gitlab.io/img/image-20230301154956271.webp)
