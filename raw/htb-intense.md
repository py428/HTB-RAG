[HTB: Intense](/2020/11/14/htb-intense.html)

![Intense](https://0xdfimages.gitlab.io/img/intense-cover.webp)
...
[![Intense](/icons/box-intense.webp)](https://hackthebox.com/machines/intense)

[Intense](https://hackthebox.com/machines/intense)
...
Rated Difficulty ![Rated difficulty for Intense](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/intense-diff.webp)

Radar Graph ![Radar chart for Intense](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/intense-radar.webp)

User

01:52:39 Root

08:20:28 Creator ## Recon
...
![image-20200705150338442](https://0xdfimages.gitlab.io/img/image-20200705150338442.webp)
...
![image-20200705152303963](https://0xdfimages.gitlab.io/img/image-20200705152303963.webp)
...
![image-20200705152507112](https://0xdfimages.gitlab.io/img/image-20200705152507112.webp)

On submitting a valid message, it pops a success message, and then redirects after two seconds to the main page:

![image-20200707082441290](https://0xdfimages.gitlab.io/img/image-20200707082441290.webp)
...
![image-20200705152738881](https://0xdfimages.gitlab.io/img/image-20200705152738881.webp)
...
![image-20200707084809039](https://0xdfimages.gitlab.io/img/image-20200707084809039.webp)

Googling for “unrecognied token” returns a bunch of SQLite discussions:

![image-20200707084936646](https://0xdfimages.gitlab.io/img/image-20200707084936646.webp)
...
![image-20200707125620716](https://0xdfimages.gitlab.io/img/image-20200707125620716.webp)
...
![image-20200708143258151](https://0xdfimages.gitlab.io/img/image-20200708143258151.webp)
...
![image-20201111143313743](https://0xdfimages.gitlab.io/img/image-20201111143313743.webp)
...
![image-20200711170555271](https://0xdfimages.gitlab.io/img/image-20200711170555271.webp)
...
Now I’ll do the same thing as above, but this time, I’ll get a shell using LIBC functions. I’ll use the standard `dup2` to copy stdin, stdout, and stderr into the socket, and then start `/bin/sh`. I’ll call `/bin/sh` with [execv](https://linux.die.net/man/3/execv). In [rope](about:/2020/05/23/htb-rope.html#stage-2-shell), I used `execve`, but it requires a third parameter, and I don’t have an RDX gadget, so it crashed. I did play with using `system(/bin/sh)`, and it worked locally, but initially failed on remote. I’ll dig on that (and fix it) in [Beyond Root](#beyond-root---execv-vs-system).
...
It worked locally, but then didn’t work remotely. I remember having this same problem in [rope](about:/2020/05/23/htb-rope.html#stage-2-shell), and then switching to `execve`.
