[HTB: UnderPass](/2025/05/10/htb-underpass.html)

![UnderPass](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/underpass-cover.webp)
...
[![UnderPass](/icons/box-underpass.webp)](https://hackthebox.com/machines/underpass)

[UnderPass](https://hackthebox.com/machines/underpass)
...
Rated Difficulty ![Rated difficulty for UnderPass](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/underpass-diff.webp)

Radar Graph ![Radar chart for UnderPass](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/underpass-radar.webp)

User

00:30:02 Root

00:41:15 Creator ## Recon
...
Based on the [OpenSSH and Apache versions](about:/cheatsheets/os#ubuntu) versions, the host is likely running Ubuntu 22.04 jammy (or perhaps 22.10 kinetic).
...
The website is still just the default Apache page:
 ...
 ![image-20250504071918284](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504071918284.webp)![expand](/icons/expand.png)
...
![image-20250504072013438](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504072013438.webp)
...
> No more mysql database console. No more editing freeradius configuration files.
> 
...
![image-20250504083938684](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504083938684.webp)
...
![image-20250504085348096](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504085348096.webp)

#### Identify Login Pages

I’ll search the Git repo for “login”, and the second result is in the file `app/users/login.php`:

![image-20250504085517305](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504085517305.webp)

Visiting `/daloradius/app/users/login.php` does return a login page:

![image-20250504085539041](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504085539041.webp)

There’s another one at `/daloradius/app/operators/login.php`:

![image-20250504085928532](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504085928532.webp)
...
![image-20250504090447553](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504090447553.webp)

These don’t work on the user login, but do on the operator login:

![image-20250504090533188](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504090533188.webp)

#### Users

There’s a dashboard for users that shows one user:

![image-20250504090642670](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504090642670.webp)
...
![image-20250504090757973](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20250504090757973.webp)
