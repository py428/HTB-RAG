[HTB: Socket](/2023/07/15/htb-socket.html)

![Socket](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/socket-cover.webp)
...
[![Socket](/icons/box-socket.webp)](https://hackthebox.com/machines/socket)

[Socket](https://hackthebox.com/machines/socket)
...
Rated Difficulty ![Rated difficulty for Socket](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/socket-diff.webp)

Radar Graph ![Radar chart for Socket](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/socket-radar.webp)

User

00:50:03 Root

01:17:00 Creator ## Recon
...
The site hosts a QR-code reading / generation service:
 ...
 ![image-20230327150211781](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327150211781.webp)![expand](/icons/expand.png)

I can give it text and it will generate a QR Code:

![image-20230327150336023](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327150336023.webp)

I can pass the QR code back to the site and get the text:

![image-20230327150430940](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327150430940.webp)

Passing the same QR to a site like [zxing.org](https://zxing.org/w/decode) shows the same results, so it’s a standard QR code:

![image-20230327150529520](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327150529520.webp)
...
![image-20230327160255452](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327160255452.webp)

`/report` shows a form, and on submitting it, there’s a message added at the top:

![image-20230327160556170](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327160556170.webp)
...
That fits with a “Made with Flask” message in the footer of the page. The 404 page is also the [default flask 404](about:/2023/03/04/htb-forgot.html#tech-stack):

![image-20230327160338327](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327160338327.webp)
...
![image-20230327161403005](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327161403005.webp)

### Websockets - TCP 5789

TCP 5789 isn’t a pre-defined port, but visiting it in a browser gives a pretty solid clue as to what it’s for:

 [![image-20230327161941431](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327161941431.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327161941431.png)
...
![](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/htb-socket-test.webp)
...
![image-20230327180818686](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327180818686.webp)

I can put text in the field on the right, and it will generate a QR code when I click “Embed”:

![image-20230327180856262](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327180856262.webp)
...
![image-20230327181050356](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327181050356.webp)

Given the implication of network activity, I’ll run it again with Wireshark open. There are DNS queries for `ws.qreader.htb`:

![image-20230327182433823](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327182433823.webp)

I’ll add that to my `/etc/hosts` file pointing at Socket, and the “Version” command works:

![image-20230327182721495](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327182721495.webp)
...
I want to proxy the requests, so I’ll configure Burp to listen on 5789, sending any traffic to Socket on 5789:
 ...
 [![image-20230327182926364](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327182926364.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327182926364.png)
...
![image-20230327183441207](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327183441207.webp)
...
![image-20230327184144821](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327184144821.webp)

If I add a `'` it still returns the same message. However, if I add `"`, it doesn’t return anything:

![image-20230327184237281](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327184237281.webp)

This could be the server crashing with an SQL error. I’ll try with a comment to see if it works again, and it does:

![image-20230327184550385](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327184550385.webp)
...
![image-20230327184752242](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327184752242.webp)
...
![image-20230327205206159](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327205206159.webp)
...
![image-20230327205650091](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327205650091.webp)
...
![image-20230327210346366](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327210346366.webp)

[Crackstation](https://crackstation.net/) breaks the hash easily:

![image-20230327210410465](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327210410465.webp)
...
![image-20230327210751198](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327210751198.webp)

`reports` gives another couple possible usernames of jason and mike (though these are presumably from customers):

![image-20230327210941568](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327210941568.webp)

`answers` have admin for both usernames:

![image-20230327211109266](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230327211109266.webp)
...
With a user’s name and a password, I’ll try to come up with different variations of usernames that could come from that first and last name. Initially I just made a list by hand, but it’s probably easier to just use [username-anarchy](https://github.com/urbanadventurer/username-anarchy) like I did on [Absolute](about:/2023/05/27/htb-absolute.html#generate-users-list):
...
![image-20230328104112983](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20230328104112983.webp)
