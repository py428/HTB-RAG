[HTB: Jab](/2024/06/29/htb-jab.html)

![Jab](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/jab-cover.webp)
...
[![Jab](/icons/box-jab.webp)](https://hackthebox.com/machines/jab)

[Jab](https://hackthebox.com/machines/jab)
...
Rated Difficulty ![Rated difficulty for Jab](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/jab-diff.webp)

Radar Graph ![Radar chart for Jab](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/jab-radar.webp)

User

01:14:14 Root

01:58:17 Creator ## Recon
...
![image-20240623155901316](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240623155901316.webp)

I’ll click “Add…” and select XMPP from the “Protocol” drop-down, and fill out the rest:

![image-20240623160021449](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240623160021449.webp)

When I submit, after accepting the TLS certificate, a registration window opens, which I’ll fill out:

![image-20240623160117300](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240623160117300.webp)

On submitting, it says it was successful:

![image-20240623160144622](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240623160144622.webp)

I’ll select this from the accounts window,and the “Buddy List” window shows my account is online and available:

![image-20240623160326919](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240623160326919.webp)

#### Rooms

From the menu, “Tools” –> “Room List” will give a series of dialogs that leads to a list of the rooms on this server:

![image-20240624085526074](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624085526074.webp)

`conference.jab.htb` is automatically filled in. Clicking “Find Rooms” returns two:

![image-20240624085606607](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624085606607.webp)

I don’t have access to “test”:

![image-20240624085650656](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624085650656.webp)

“test2” has a message from bdavis:

![image-20240624100342938](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624100342938.webp)
...
![image-20240623160438261](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240623160438261.webp)

It asks for a “directory” to search, and has pre-populated the field with “search.jab.htb”:

![image-20240623160517954](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240623160517954.webp)

I’ll click ok, and in the next window enter “\*”:

![image-20240623160551687](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240623160551687.webp)

The resulting window has a *ton* of users with email addresses:

![image-20240623160634049](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240623160634049.webp)

#### Plugins / User Export

Under “Tools” –> “Plugins” I’ll take a look at the enabled plugins:

![image-20240624103358032](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624103358032.webp)

I don’t see anything interesting enabled, but I’ll enable “XMPP Console”, and now that shows up in the “Tools” menu:

![image-20240624103449529](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624103449529.webp)
...
![image-20240624105212561](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624105212561.webp)
...
![image-20240624113832796](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624113832796.webp)
...
![image-20240624113520306](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624113520306.webp)

This room has a discussion about an ongoing pentest:

 [![image-20240624113650296](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624113650296.png) *Click for full size image*](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624113650296.png)
...
![image-20240624113730632](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624113730632.webp)
...
![image-20240624130206997](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624130206997.webp)

Clicking it shows up as:

![image-20240624130225109](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624130225109.webp)
...
![image-20240624141153568](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624141153568.webp)

Checking for password reuse, the svc\_openfire account with the same password works to get access to the admin panel:

 ![image-20240624142644277](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624142644277.webp)![expand](/icons/expand.png)
...
![image-20240624143553807](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624143553807.webp)

I’ll browse to the malicious plugin and upload it:

![image-20240624144006480](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624144006480.webp)

#### RCE

Under “Server” –> “Server Settings” there’s now a “Management Tool” option:

![image-20240624144104555](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624144104555.webp)

Clicking on it asks for a password:

![image-20240624144130361](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624144130361.webp)

I’ll enter “123” as instructed on GitHub. The plugin has a dropdown of options:

![image-20240624144242536](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624144242536.webp)

The “system command” option has a field to provide a command. On giving `whoami`, it shows the server is running as System:

![image-20240624144408331](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624144408331.webp)

I can read the flag:

![image-20240624144514122](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624144514122.webp)
...
![image-20240624145539797](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/image-20240624145539797.webp)
