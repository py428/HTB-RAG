...
Rated Difficulty ![Rated difficulty for TartarSauce](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/tartarsauce-diff.webp)

Radar Graph ![Radar chart for TartarSauce](https://pub-4caceed5c57c4466b559b0834d2806c9.r2.dev/img/tartarsauce-radar.webp)

User

01:11:38 Root

04:16:42 Creators   ## nmap
...
The script simply has php system commands take the steps shown in [privesc](#shell-as-onuma) above, writing a shell script, putting it into a tar archive, and then using `sudo tar` to run it.
